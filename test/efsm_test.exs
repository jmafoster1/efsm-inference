defmodule EFSMTest do
  ...
  test "to JSON style map" do
    {efsm, transitionTable} = EFSM.read("test/support_files/unmerged.json")
    assert EFSM.to_json_map(efsm, transitionTable) == %{
      "q0" => %{"select:1[i1='coke']/o1:='coke'" => "q1"},
