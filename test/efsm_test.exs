defmodule EFSMTest do
  ...
  test "to JSON string" do
    {efsm, transitionTable} = EFSM.read("test/support_files/unmerged.json")
    assert EFSM.toJSON(efsm, transitionTable) == "{\"q6\":{},\"q5\":{\"vend:0/o1:='coke'\":\"q6\"},\"q4\":{},\"q3\":{\"vend:0/o1:='coke'\":\"q4\"},\"q2\":{\"coin:1[i1='50']\":\"q3\"},\"q1\":{\"coin:1[i1='50']\":\"q2\",\"coin:1[i1='100']\":\"q5\"},\"q0\":{\"select:1[i1='coke']/o1:='coke'[r1:='coke']\":\"q1\"}}"
  end
