...
public class GuardSRPlayground {
	...
	public static void main(String[] args) {
		...
		boolTerms.add(new BooleanVariableAssignmentTerminal(new BooleanVariableAssignment("t", true), true));
		boolTerms.add(new BooleanVariableAssignmentTerminal(new BooleanVariableAssignment("f", false), true));
