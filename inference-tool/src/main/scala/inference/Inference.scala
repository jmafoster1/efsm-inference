...
object GExp {
  ...
  def satisfiable_list(l: List[gexp]): Boolean =
    Dirties.satisfiable(Lista.fold[gexp, gexp](((v: gexp) => (va: gexp) =>
  ...
  def gexp_same_structure(x0: gexp, x1: gexp): Boolean = (x0, x1) match {
    ...
    case (In(va, la), In(v, l)) =>
      (VName.equal_vname(va, v)) && (Lista.equal_lista[Value.value](la, l))
...
object Symbolic_Regression {
  ...
  def everything_walk(uu: AExp.aexp, uv: Nat.nat, uw: Map[VName.vname, String],
    ...
    va: String, vb: Nat.nat): List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))] =
  ...
  def everything_walk_log(f: AExp.aexp, fi: Nat.nat,
    ...
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: String, a: Nat.nat): List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]] =
        ...
        (Dirties.randomMember[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](poss_steps) match {
          ...
          case Some((tid, (sa, ta))) =>
            (if ((l == label) && ((Nat.equal_nata(Nat.Nata(i.length),
              ...
              val necessaryRegs: Map[Nat.nat, Option[Value.value]] = Dirties.getRegs(types, i, f, p(Code_Numeral.integer_of_nat(fi).toInt))
              println("  necessaryRegs: "+necessaryRegs)
  ...
  def put_output_function(uu: Nat.nat, uv: AExp.aexp,
    ...
    (uu, uv, uw, x3, ux, e) match {
      ...
      case (fi, f, types, h :: t, t1, e) =>
        (put_output_function_aux(fi, f, types, h._2, Transition.Label[Unit](t1), Transition.Arity[Unit](t1), Nat.Nata((Transition.Outputs[Unit](t1)).length), None, e, Nat.zero_nata, Map().withDefaultValue(None)) match {
            case None => {
              println("Could not put_output_function")
              PrettyPrinter.iEFSM2dot(e, "fail")
              System.exit(1)
              None
            }
  ...
  def historical_infer_output_update_functions(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val relevant_events: List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))] = flatten(Lista.map[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))]), (Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])](((a: (Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])) =>
        ...
        i_log),
        Nil)
      val output_functions: List[Option[(AExp.aexp, Map[VName.vname, String])]] = get_functions(max_reg, values, Nat.Nata((Transition.Outputs[Unit](t1)).length), relevant_events)
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log, FSet.bot_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]);
      (put_output_functions(Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nata, output_functions), i_log, t1, pta) match {
          case None => {
          ...
          case Some(lit) =>
            (output_functions.head match {
              case None => None
              case Some((op, types)) =>
                {
                  val walked: List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]] = everything_walk_log(op, Nat.zero_nata, types, log, lit,
                  ...
                  val targeted: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] = Lista.map[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))], List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]](((w: List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]) =>
                    (target(Map().withDefaultValue(None), w.reverse)).reverse),
                    walked)
                  ...
                  val lifted: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = lift_output_functions(lit, newa, Transition.Label[Unit](t1),
                    Transition.Arity[Unit](t1))
                  val a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_distinct(add_groupwise_updates(group_updates,
                    lifted));
                  Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](a)
                }
            })
