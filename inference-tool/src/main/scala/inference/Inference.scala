...
(Transition.transition_ext[Unit], List[Nat.nat]))))]
              ...
              ((Nat.nat, Nat.nat),
               ...
               Nat.times_nat(FSet.size_fset[(List[Nat.nat],
...
def k_score_aux(m: Nat.nat,
 ...
 List[Nat.nat])](aa, b)
        ...
        FSet_Utils.fprod[(Nat.nat,
                          ...
                          (Nat.nat,
                            (Transition.transition_ext[Unit],
                              List[Nat.nat]))](outgoing_1, outgoing_2))
...
val (aa, b):
  ...
  = a;
({
   val (d1, (_, x)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))
     = aa;
   ((ab: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
     {
       ...
       (d1, (d2, ((strat(x))(y))(e)))
                                     ...
                                     pairs);
      Lista.fold[(Nat.nat, (Nat.nat, Nat.nat)),
             ...
             = FSet.ffilter[((Nat.nat,
               ...
               =>
              {
                val (aa, b):
                  ...
                  = a;
                Product_Lexorder.less_prod[Nat.nat,
    (Transition.transition_ext[Unit], List[Nat.nat])](aa, b)
              }),
             FSet_Utils.fprod[(Nat.nat,
                                (Transition.transition_ext[Unit],
                                  List[Nat.nat])),
...
def add_transition(e: FSet.fset[(List[Nat.nat],
  ...
  FSet.finsert[(List[Nat.nat],
                 ((Nat.nat, Nat.nat),
                   Transition.transition_ext[Unit]))]((List(Nat.plus_nat(max_uid_total(e),
                                  Nat.Nata((1)))),
...
Transition.transition_ext[Unit])](((a: Transition.transition_ext[Unit]) =>
  ...
  Transition.transition_ext[Unit]))
    ...
    val (g, (u1, ra)):
          (List[GExp.gexp],
            (List[(Nat.nat, AExp.aexp)], Map[String, Option[Nat.nat]]))
      = make_guard_abstract(inputs, Nat.zero_nat, maxR, r, Nil, Nil)
...
def guardMatch_code(uu: List[GExp.gexp], uv: List[GExp.gexp]): Boolean =
  ...
  case (List(GExp.Eq(AExp.V(VName.I(ia)), AExp.L(Value.Numa(na)))),
    ...
    => (Nat.equal_nata(ia, Nat.zero_nat)) && (Nat.equal_nata(i, Nat.zero_nat))
  case (Nil, uv) => false
...
FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
      ...
      Boolean
  =
  (if ((Nat.equal_nata(s, Nat.zero_nat)) && (FSet.fBall[((Nat.nat, Nat.nat),
                  Transition.transition_ext[Unit])](e,
  ...
  (Transition.Label[A](t1) ==
    Transition.Label[Unit](t2)) && ((Nat.equal_nata(Transition.Arity[A](t1),
             Transition.Arity[Unit](t2))) && ((Lista.list_all[GExp.gexp](((a:
               ...
               Transition.Outputs[Unit](t2))) && ((! ((Transition.Updates[A](t1)).isEmpty)) && ((Lista.equal_lista[(Nat.nat,
                                     AExp.aexp)](Lista.tl[(Nat.nat,
                    AExp.aexp)](Transition.Updates[A](t1)),
          Transition.Updates[Unit](t2))) && (Lista.list_ex[Nat.nat](((r:
                                Nat.nat)
                               =>
...
Nat.nat](((a: (Nat.nat, AExp.aexp)) => a._1), Transition.Updates[A](t1)))))))))
...
def io_index(eventNo: Nat.nat, inputs: List[Value.value],
  ...
  FSet.sup_fset[(Nat.nat,
                  (ioTag,
                    Nat.nat))](index(inputs, eventNo, In(), Nat.zero_nat),
...
def indices(e: List[(String, (List[Value.value], List[Value.value]))]):
 ...
 io_index(eventNo, ac, b)
      ...
      Lista.enumerate[(String,
                        (List[Value.value],
                          List[Value.value]))](Nat.zero_nat, e))
...
def groupwise_updates(values: List[Value.value],
 ...
 (Map[Nat.nat, Option[Value.value]],
  ...
  case (values, Nil) => Nil
  case (values, g :: gs) =>
    (if (Lista.list_all[(Map[Nat.nat, Option[Value.value]],
                          (Nat.nat,
                            (Map[Nat.nat, Option[Value.value]],
                              (Map[Nat.nat, Option[Value.value]],
                                (List[Value.value],
...
((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]):
  ...
  case (op, ox, us, h :: t, label, arity, pta, target) =>
    (put_update_function_aux(op, ox, us, h._2, label, arity, pta, target,
                              Nat.zero_nat, Map().withDefaultValue(None))
       match {
       case None => None
       case Some(e) =>
...
def infer_output_functions(log: List[List[(String,
 ...
 List[Value.value])))]](((a: List[(String,
                           ...
                           =>
                          Lista.enumerate[(String,
    (List[Value.value], List[Value.value]))](Nat.zero_nat, a)),
                         log))
 ...
 (String, (List[Value.value], List[Value.value]))))
   ...
   (Nat.nat, (String, (List[Value.value], List[Value.value])))
    ...
    put_output_functions(Lista.enumerate[Option[(AExp.aexp,
          Map[VName.vname, String])]](Nat.zero_nat, output_functions),
                          i_log, t1, newa)
  }
...
targeted, Nil)
      val group_updates: List[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])] =
        Lista.maps[Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])],
                    (List[Nat.nat],
                      List[(Nat.nat,
                             AExp.aexp)])](((a:
       Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])])
    ...
    Symbolic_Regression.groupwise_updates(values, List(group)))
      val a: FSet.fset[(List[Nat.nat],
                         ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]
        = Inference.make_distinct(add_groupwise_updates(log, group_updates, e));
  ...
  case (log, values, label, ia, oa, (o_inx, Some((op, types))) :: ops, e) =>
    {
      ...
      val a: FSet.fset[(List[Nat.nat],
                         ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]
        = groupwise_put_updates(groups, log, values, label, ia, oa,
                                 (o_inx, (op, types)), e);
...
(List[Nat.nat], Transition.transition_ext[Unit])
   ...
   Map[VName.vname, String])]](Nat.zero_nat, outputs),
                  generalised_model)
       match {
       case None => None
       case Some(ea) =>
    ...
    val standardised_groups:
      ...
      = Lista.map[List[(List[Nat.nat], Transition.transition_ext[Unit])],
                   List[(List[Nat.nat],
                       ...
                       standardise_group(a)),
                      groups);
    Inference.replace_transitions(e, Lista.fold[List[(List[Nat.nat],
               Transition.transition_ext[Unit])],
         List[(List[Nat.nat],
                Transition.transition_ext[Unit])]](((a:
               List[(List[Nat.nat], Transition.transition_ext[Unit])])
...
def update_groups(uu: List[List[(String,
                                  (List[Value.value], List[Value.value]))]],
                   uv: List[Value.value],
                   x2: List[(Transition.transition_ext[Unit],
                              List[(Nat.nat,
                                     Option[(AExp.aexp,
      Map[VName.vname, String])])])],
                   e: FSet.fset[(List[Nat.nat],
  ...
  case (log, values, (tran, types) :: lst, e) =>
    (put_updates(log, values, Transition.Label[Unit](tran),
                  Transition.Arity[Unit](tran),
                  Nat.Nata((Transition.Outputs[Unit](tran)).length), types, e)
       match {
 ...
 List[Option[(AExp.aexp, Map[VName.vname, String])]]
      ...
      (List[Nat.nat],
        (Transition.transition_ext[Unit],
          ...
          List[(Map[Nat.nat, Option[Value.value]],
                 (List[Value.value],
                   List[Value.value]))])](Nat.zero_nat, groups))
  ...
  Map[VName.vname, String])])]))]])
   ...
   Map[VName.vname, String])])]))],
                   (Transition.transition_ext[Unit],
                     List[(Nat.nat,
                            Option[(AExp.aexp,
                                     Map[VName.vname, String])])])](Fun.comp[(List[Nat.nat],
                                       (Transition.transition_ext[Unit],
 List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])),
                                      (Transition.transition_ext[Unit],
List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]),
  ...
  case (h :: t, uPTA, t1, t2, g1, g2) =>
    {
      val (g1a, g2a):
            (List[(List[Value.value], Map[Nat.nat, Option[Value.value]])],
              List[(List[Value.value], Map[Nat.nat, Option[Value.value]])])
        = trace_collect_training_sets(h, uPTA, Nat.zero_nat,
