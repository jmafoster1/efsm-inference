...
def fis_singleton[A : HOL.equal](s: FSet.fset[A]): Boolean =
  Nat.equal_nata(FSet.size_fseta[A].apply(s), Nat.one_nat)
   ...
   u_2, m, np))
       ...
       ((Nat.nat, Nat.nat),
         ...
         FSet.size_fseta[(Nat.nat,
                           ((Nat.nat, Nat.nat),
                             Transition.transition_ext[Unit]))].apply(newa)),
                                   Nat.plus_nata(Nat.plus_nata(Nat.Nata(ss.length),
                        Nat.one_nat),
          FSet.size_fseta[(Nat.nat,
                            ((Nat.nat, Nat.nat),
                              Transition.transition_ext[Unit]))].apply(newEFSM))))
...
def choice(ta: Transition.transition_ext[Unit],
  ...
  (Transition.Label[Unit](ta) ==
    Transition.Label[Unit](t)) && ((Nat.equal_nata(Transition.Arity[Unit](ta),
            Transition.Arity[Unit](t))) && (Dirties.satisfiable(Lista.foldr[GExp.gexp,
  ...
  (if (Nat.equal_nata(s_1, s_2)) None
           ...
           (resolve_nondeterminism(FSet.sorted_list_of_fset[(Nat.nat,
                      ((Nat.nat, Nat.nat),
                        ((Transition.transition_ext[Unit], Nat.nat),
                          (Transition.transition_ext[Unit],
                            Nat.nat))))](nondeterministic_pairs(ea)),
                                    e, ea, m, check,
                                    ((a:
FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))])
                                       =>
                                      nondeterministic_pairs(a)))
              match {
              case None => None
              case Some(merged) =>
                (resolve_nondeterminism(FSet.sorted_list_of_fset[(Nat.nat,
 ...
 e, ea, m, check, np)
                   ...
                   case None =>
                     Some[FSet.fset[(Nat.nat,
                                      ((Nat.nat, Nat.nat),
Transition.transition_ext[Unit]))]](merged)
                   case Some(a) =>
                     Some[FSet.fset[(Nat.nat,
                                      ((Nat.nat, Nat.nat),
Transition.transition_ext[Unit]))]](a)
...
((Transition.transition_ext[Unit], Nat.nat),
  ...
  (inference_step(e, (FSet.sorted_list_of_fset[(Nat.nat,
     ...
     case None => e
     case Some(newa) =>
       (if (Nat.less_nat(Nat.plus_nata(FSet.size_fseta[Nat.nat].apply(S(newa)),
FSet.size_fseta[(Nat.nat,
                  ((Nat.nat, Nat.nat),
                    Transition.transition_ext[Unit]))].apply(newa)),
                          Nat.plus_nata(FSet.size_fseta[Nat.nat].apply(S(e)),
 FSet.size_fseta[(Nat.nat,
                   ((Nat.nat, Nat.nat),
                     Transition.transition_ext[Unit]))].apply(e))))
         infer(newa, r, m, check, np) else e)
   })
  ...
  =
  {
    ...
    (resolve_nondeterminism(FSet.sorted_list_of_fset[(Nat.nat,
               ((Nat.nat, Nat.nat),
                 ((Transition.transition_ext[Unit], Nat.nat),
                   (Transition.transition_ext[Unit],
                     Nat.nat))))](nondeterministic_pairs(iPTA)),
                             iPTA, iPTA, m, check,
                             ((a: FSet.fset[(Nat.nat,
      ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))])
                                =>
       ...
       case None => None
       case Some(ptaa) =>
         Some[FSet.fset[((Nat.nat, Nat.nat),
                          Transition.transition_ext[Unit])]](tm(infer(ptaa, r,
                               m, check, np)))
     })
  }
      ...
      =>
     {
       val (tb, ta):
             ((Transition.transition_ext[Unit], Nat.nat),
               (Transition.transition_ext[Unit], Nat.nat))
         = ac;
       (Transition.Label[Unit](Product_Type.fst[Transition.transition_ext[Unit],
         Nat.nat](tb)) ==
         Transition.Label[Unit](Product_Type.fst[Transition.transition_ext[Unit],
          Nat.nat](ta))) && (Nat.equal_nata(Transition.Arity[Unit](Product_Type.fst[Transition.transition_ext[Unit],
     Nat.nat](tb)),
     Transition.Arity[Unit](Product_Type.fst[Transition.transition_ext[Unit],
      Nat.nat](ta))))
     })
 })(b)
                                      }),
...
def naive_score_one_final_state(t1: FSet.fset[Transition.transition_ext[Unit]],
 ...
 FSet.bot_fset[Transition.transition_ext[Unit]])))
    Nat.one_nat
    else FSet.size_fseta[(Transition.transition_ext[Unit],
                           Transition.transition_ext[Unit])].apply(FSet.ffilter[(Transition.transition_ext[Unit],
  Transition.transition_ext[Unit])](((a:
(Transition.transition_ext[Unit], Transition.transition_ext[Unit]))
                                       =>
                                      {
