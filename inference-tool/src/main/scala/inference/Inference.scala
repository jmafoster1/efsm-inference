...
def fBall[A : HOL.equal](xa: fset[A]): (A => Boolean) => Boolean =
...
def stored_reused_aux(ta: Transition.transition_ext[Unit],
  ...
  (if (Nat.equal_nata(p, Nat.zero_nata))
    stored_reused_aux_per_reg(ta, t, r, Nat.zero_nata)
                                     ...
                                     Nat.Suc(Nat.minus_nat(p, Nat.one_nat)))
            match {
            case None =>
...
def i_step(e: FSet.fset[(Nat.nat,
      ...
      Option[(Transition.transition_ext[Unit],
               (Nat.nat, (Nat.nat, Nat.nat => Option[Value.value])))]
  =
  {
    val possibilities:
          FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))]
...
def total_max_input(e: FSet.fset[(Nat.nat,
                                   ((Nat.nat, Nat.nat),
                                     Transition.transition_ext[Unit]))]):
      Nat.nat
  =
...
Nat.nat))))]) =>
 ...
 ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]) =>
  ...
  ((a: FSet.fset[(Nat.nat,
                   ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))])
     =>
    (b: (FSet.fset[Transition.transition_ext[Unit]]) =>
          (FSet.fset[Transition.transition_ext[Unit]]) => Nat.nat)
      =>
    (c: Nat.nat =>
          Nat.nat =>
 ...
 Transition.transition_ext[Unit]))]])
      =>
    (d: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) =>
          Boolean)
      =>
    (e: (FSet.fset[(Nat.nat,
                     ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
...
def make_branch(e: FSet.fset[((Nat.nat, Nat.nat),
  ...
  case (e, s, r, (label, (inputs, outputs))::t) =>
   ...
   Transition.transition_ext[Unit])](((s, Nat.plus_nata(maxS(e), Nat.one_nat)),
                                       Transition.transition_exta[Unit](label,
                                 Nat.Nata(inputs.length),
                                 make_guard(inputs, Nat.zero_nata),
                                 make_outputs(outputs), Nil, ())),
      ...
      = ((a: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])])
          ...
          satisfies(Set.seta[List[(String,
                                    (List[Value.value],
                                      List[Value.value]))]](l),
                     a));
    tm(infer.apply(toiEFSM(pta)).apply(r).apply(m).apply(check).apply(np))
  }
...
def max_output(e: FSet.fset[(Nat.nat,
                              ((Nat.nat, Nat.nat),
                                Transition.transition_ext[Unit]))]):
      Nat.nat
  =
...
def step(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
      ...
      Option[(Transition.transition_ext[Unit],
               (Nat.nat,
                 (List[Option[Value.value]], Nat.nat => Option[Value.value])))]
  =
  {
...
def infer_with_log(stepNo: Nat.nat,
                    e: FSet.fset[(Nat.nat,
                                   ((Nat.nat, Nat.nat),
                                     Transition.transition_ext[Unit]))],
                    r: (FSet.fset[Transition.transition_ext[Unit]]) =>
...
((Transition.transition_ext[Unit], Nat.nat),
  ...
  (Inference.inference_step(e, (FSet.sorted_list_of_fset[(Nat.nat,
                   (Nat.nat, Nat.nat))](Inference.score(e, r))).reverse,
                             m, check, np)
     match {
     case None => e
     case Some(newa) =>
       {
         ...
         PrettyPrinter.logStates((FSet.size_fset[Nat.nat](Inference.S(newa))), (FSet.size_fset[Nat.nat](Inference.S(e))));
         (if (FSet.less_fset[Nat.nat](Inference.S(newa), Inference.S(e)))
           infer_with_log(Nat.plus_nata(stepNo, Nat.one_nat), newa, r, m, check,
                           np)
           else e)
       }
   })
...
def satisfies_trace_i_i_i_i(x: List[(String,
     ...
     Transition.transition_ext[Unit])],
                             xb: Nat.nat, xc: Nat.nat => Option[Value.value]):
      Predicate.pred[Unit]
  =
  Predicate.sup_pred[Unit](Predicate.bind[(List[(String,
          (List[Value.value], List[Value.value]))],
    (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
      (Nat.nat, Nat.nat => Option[Value.value]))),
 ...
 Transition.transition_ext[Unit])],
  ...
  (Nat.nat, (List[Option[Value.value]], Nat.nat => Option[Value.value])))],
                               ...
                               ((ab: Unit) =>
                                 {
                                   val (): Unit = ab;
                                   Predicate.bind[Unit,
           Unit](eq_i_i[List[Option[Value.value]]](pa,
            Lista.map[Value.value,
                       Option[Value.value]](((ac: Value.value) =>
      Some[Value.value](ac)),
     p)),
                  ((ac: Unit) => {
                                   val (): Unit = ac;
...
def apply_updates(x0: List[(Nat.nat, AExp.aexp)],
                   ...
                   newa: Nat.nat => Option[Value.value]):
      Nat.nat => Option[Value.value]
  =
  (x0, uu, newa) match {
...
def updates2dot_aux(x0: List[(Nat.nat, AExp.aexp)]): List[String] = x0 match {
  case Nil => Nil
  case h::t =>
    (vname2dot(VName.R(h._1)) + " := " + aexp2dot(h._2))::(updates2dot_aux(t))
}
...
def type_check_var(v: VName.vname, l: List[(VName.vname, typea)]): Boolean =
  Nat.less_eq_nat(Nat.one_nat,
                   Finite_Set.card[typea](Set.seta[typea](Lista.map[(VName.vname,
                              typea),
                             typea](((a: (VName.vname, typea)) =>
                                      {
val (_, t): (VName.vname, typea) = a;
t
                                      }),
                                     Lista.filter[(VName.vname,
            typea)](((a: (VName.vname, typea)) =>
                      {
...
def aexp_type_check(a1: AExp.aexp, a2: AExp.aexp,
                     t: FinFun.finfun[VName.vname, typea]):
      Boolean
  =
...
def naive_score(t1: FSet.fset[Transition.transition_ext[Unit]],
      ...
      Nat.nat
  =
  FSet.size_fset[(Transition.transition_ext[Unit],
...
def naive_score_rank(t1: FSet.fset[Transition.transition_ext[Unit]],
                      t2: FSet.fset[Transition.transition_ext[Unit]]):
      Nat.nat
  =
  Groups_Big.sum[Nat.nat,
                  Nat.nat](((x: Nat.nat) => x),
                            FSet.fset[Nat.nat](FSet.fimage[(Transition.transition_ext[Unit],
                     Transition.transition_ext[Unit]),
                    Nat.nat](((a: (Transition.transition_ext[Unit],
                                    Transition.transition_ext[Unit]))
                                =>
 ...
 Transition.transition_ext[Unit])
       ...
       Transition.Arity[Unit](y)))),
        bool2nat(Transition.Outputs[Unit](x) == Transition.Outputs[Unit](y)))
                               }),
                              FSet_Utils.fprod[Transition.transition_ext[Unit],
        Transition.transition_ext[Unit]](t1, t2))))

def score_one_final_state(s: (FSet.fset[Transition.transition_ext[Unit]]) =>
                               (FSet.fset[Transition.transition_ext[Unit]]) =>
                                 Nat.nat,
                           t1: FSet.fset[Transition.transition_ext[Unit]],
                           t2: FSet.fset[Transition.transition_ext[Unit]]):
      Nat.nat
  =
 ...
 FSet.bot_fset[Transition.transition_ext[Unit]])))
    Nat.one_nat else (s(t1))(t2))

def naive_score_comprehensive(t1: FSet.fset[Transition.transition_ext[Unit]],
                               t2: FSet.fset[Transition.transition_ext[Unit]]):
      Nat.nat
  =
  Groups_Big.sum[Nat.nat,
...
Transition.Label[Unit](y)) && (Nat.equal_nata(Transition.Arity[Unit](x),
       Transition.Arity[Unit](y))))
            ...
            Nat.Nata((Lista.filter[(AExp.aexp,
                                     AExp.aexp)](((aa: (AExp.aexp, AExp.aexp))
            =>
           {
             val (ab, b): (AExp.aexp, AExp.aexp) = aa;
             AExp.equal_aexpa(ab, b)
           }),
...
def naive_score_comprehensive_eq_high(t1:
FSet.fset[Transition.transition_ext[Unit]],
                                       t2:
 FSet.fset[Transition.transition_ext[Unit]]):
      Nat.nat
 ...
 Transition.transition_ext[Unit])
                                   = a;
                                 (if (Transition.equal_transition_exta[Unit](x,
                                      y))
