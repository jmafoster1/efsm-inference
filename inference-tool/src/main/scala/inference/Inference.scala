...
object PTA_Generalisation {
  ...
  def standardise_groups_aux(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    x2: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (e, uu, x2) match {
      case (e, uu, Nil) => e
      case (e, l, h :: t) =>
        {
  ...
  def derestrict(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      ...
      val delayed: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Lista.fold[Nat.nat, FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((r: Nat.nat) =>
        ...
        normalised)
        PrettyPrinter.iEFSM2dot(delayed, "delayed")
