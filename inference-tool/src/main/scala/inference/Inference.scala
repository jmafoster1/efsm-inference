  ...
  =
  {
    val necessary_updates: List[(Nat.nat, AExp.aexp[VName.vname])] =
      Lista.filter[(Nat.nat,
        ...
        {
          val (r, ua): (Nat.nat, AExp.aexp[VName.vname]) = a;
          (! (AExp.equal_aexpa[VName.vname](ua,
     AExp.V[VName.vname](VName.R(r))))) && (! ((Transition.Updates[Unit](t)).contains((r,
        ua))))
        }),
       u);
    Transition.Updates_update[Unit](((_:
...
def same_event_structure(x0: (String, (List[Value.value], List[Value.value])),
                          x1: (String, (List[Value.value], List[Value.value]))):
      Boolean
  =
  (x0, x1) match {
  case ((l1, (i1, o1)), (l2, (i2, o2))) =>
    (l1 ==
      l2) && ((Nat.equal_nata(Nat.Nata(i1.par.length),
                               Nat.Nata(i2.par.length))) && ((Lista.list_all[(Value.value,
                                       Value.value)](((a:
                 (Value.value, Value.value))
                =>
               same_types(a)),
              i1.par.zip(i2).toList)) && ((Nat.equal_nata(Nat.Nata(o1.par.length),
                   Nat.Nata(o2.par.length))) && (Lista.list_all[(Value.value,
                          Value.value)](((a: (Value.value, Value.value)) =>
  same_types(a)),
...
t.par.zip(Lista.enumerate[(List[Nat.nat],
  ...
  case (log, e, (gp::t), to_derestrict, closed) =>
    {
      ...
      val structural_groups:
        ...
        = Lista.filter[List[(List[Nat.nat],
                              Transition.transition_ext[Unit])]](((gpa:
                             List[(List[Nat.nat],
                                    Transition.transition_ext[Unit])])
                            =>
      ...
      val ea: FSet.fset[(List[Nat.nat],
                          ((Nat.nat, Nat.nat),
                            Transition.transition_ext[Unit]))]
        = generalise_and_update(log, e, gp, structural_groups)
        ...
        = Lista.fold[Nat.nat,
            ...
            ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))])
                   ...
                   find_first_uses_of(r, log, acc))),
                                 ...
                                 ea)
      val (standardised, more_to_derestrict):
            (FSet.fset[(List[Nat.nat],
                         ((Nat.nat, Nat.nat),
                           Transition.transition_ext[Unit]))],
              List[List[Nat.nat]])
...
List[Nat.nat]))))]):
  ...
  =
  {
    ...
    val (normalised, (to_derestrict, _)):
          (FSet.fset[(List[Nat.nat],
                       ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
            (List[List[Nat.nat]],
              List[(Transition.transition_ext[Unit],
                     List[Option[(AExp.aexp[VName.vname],
                                   Map[VName.vname, String])]])]))
      = groupwise_generalise_and_update(log, pta, groups, Nil, Nil)
    val tidied:
          FSet.fset[(List[Nat.nat],
                      ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]
      = FSet.fimage[(List[Nat.nat],
