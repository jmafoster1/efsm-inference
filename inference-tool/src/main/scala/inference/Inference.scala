...
object Orderings {
  ...
  object ord {
    implicit def `Transition_Ordering.ord_transition_ext`[A: HOL.equal: linorder]: ord[Transition.transition_ext[A]] = new ord[Transition.transition_ext[A]] {
  ...
  object preorder {
    implicit def `Transition_Ordering.preorder_transition_ext`[A: HOL.equal: linorder]: preorder[Transition.transition_ext[A]] = new preorder[Transition.transition_ext[A]] {
      val `Orderings.less_eq` =
        (a: Transition.transition_ext[A], b: Transition.transition_ext[A]) =>
          Transition_Ordering.less_eq_transition_ext[A](a, b)
      val `Orderings.less` =
    ...
    implicit def `Value.preorder_value`: preorder[Value.value] = new preorder[Value.value] {
      val `Orderings.less_eq` = (a: Value.value, b: Value.value) =>
        Value.less_eq_value(a, b)
      val `Orderings.less` = (a: Value.value, b: Value.value) =>
        Value.less_value(a, b)
    ...
    implicit def `GExp_Orderings.preorder_gexp`: preorder[GExp.gexp] = new preorder[GExp.gexp] {
      val `Orderings.less_eq` = (a: GExp.gexp, b: GExp.gexp) =>
        GExp_Orderings.less_eq_gexp(a, b)
      val `Orderings.less` = (a: GExp.gexp, b: GExp.gexp) =>
        GExp_Orderings.less_gexp(a, b)
    }
    implicit def `GExp_Orderings.preorder_aexp`: preorder[AExp.aexp] = new preorder[AExp.aexp] {
      val `Orderings.less_eq` = (a: AExp.aexp, b: AExp.aexp) =>
        GExp_Orderings.less_eq_aexp(a, b)
      val `Orderings.less` = (a: AExp.aexp, b: AExp.aexp) =>
        GExp_Orderings.less_aexp(a, b)
  ...
  object order {
    implicit def `Transition_Ordering.order_transition_ext`[A: HOL.equal: linorder]: order[Transition.transition_ext[A]] = new order[Transition.transition_ext[A]] {
      val `Orderings.less_eq` =
        (a: Transition.transition_ext[A], b: Transition.transition_ext[A]) =>
          Transition_Ordering.less_eq_transition_ext[A](a, b)
      val `Orderings.less` =
    ...
    implicit def `GExp_Orderings.order_gexp`: order[GExp.gexp] = new order[GExp.gexp] {
      val `Orderings.less_eq` = (a: GExp.gexp, b: GExp.gexp) =>
        GExp_Orderings.less_eq_gexp(a, b)
      val `Orderings.less` = (a: GExp.gexp, b: GExp.gexp) =>
        GExp_Orderings.less_gexp(a, b)
    }
    implicit def `GExp_Orderings.order_aexp`: order[AExp.aexp] = new order[AExp.aexp] {
      val `Orderings.less_eq` = (a: AExp.aexp, b: AExp.aexp) =>
        GExp_Orderings.less_eq_aexp(a, b)
      val `Orderings.less` = (a: AExp.aexp, b: AExp.aexp) =>
        GExp_Orderings.less_aexp(a, b)
  ...
  object linorder {
    implicit def `Transition_Ordering.linorder_transition_ext`[A: HOL.equal: linorder]: linorder[Transition.transition_ext[A]] = new linorder[Transition.transition_ext[A]] {
      val `Orderings.less_eq` =
        (a: Transition.transition_ext[A], b: Transition.transition_ext[A]) =>
          Transition_Ordering.less_eq_transition_ext[A](a, b)
      val `Orderings.less` =
...
object Rings {
  ...
  object zero_neq_one {
    implicit def `Code_Numeral.zero_neq_one_integer`: zero_neq_one[BigInt] = new zero_neq_one[BigInt] {
      val `Groups.zero` = BigInt(0)
      val `Groups.one` = Code_Numeral.one_integera
    }
  }
...
object Nat {
  ...
  def Suc(n: nat): nat = plus_nat(n, Nat.Nata((1)))
...
object Code_Target_List {
  ...
  def upt_tailrec(i: Nat.nat, j: Nat.nat, l: List[Nat.nat]): List[Nat.nat] =
    (if (Nat.equal_nata(j, Nat.zero_nat)) l
...
object Lista {
  ...
  def equal_lista[A: HOL.equal](xs: List[A], ys: List[A]): Boolean =
    (Nat.equal_nata(Nat.Nata(xs.length),
      Nat.Nata(ys.length))) && (list_all[(A, A)](((a: (A, A)) => {
        val (aa, b): (A, A) = a;
        HOL.eq[A](aa, b)
      }),
        (xs zip ys)))
  ...
  def enumerate[A](n: Nat.nat, xs: List[A]): List[(Nat.nat, A)] =
    ((upt(n, Nat.plus_nat(n, Nat.Nata(xs.length)))) zip xs)
  ...
  def transpose[A](x0: List[List[A]]): List[List[A]] = x0 match {
    ...
    case (x :: xs) :: xss =>
      (x :: maps[List[A], A](((a: List[A]) => (a match {
        ...
        xss)) ::
        transpose[A](xs :: maps[List[A], List[A]](((a: List[A]) =>
          (a match {
            case Nil => Nil
            case _ :: t => List(t)
          })),
  ...
  def list_update[A](x0: List[A], i: Nat.nat, y: A): List[A] = (x0, i, y) match {
    case (Nil, i, y) => Nil
    case (x :: xs, i, y) =>
      (if (Nat.equal_nata(i, Nat.zero_nat)) y :: xs
...
object AExp {
  ...
  def MaybeArithInt(f: Int.int => Int.int => Int.int, uv: Option[Value.value],
    uw: Option[Value.value]): Option[Value.value] =
    (f, uv, uw) match {
  ...
  def value_times: Option[Value.value] => Option[Value.value] => Option[Value.value] =
    ((a: Option[Value.value]) => (b: Option[Value.value]) =>
      MaybeArithInt(((aa: Int.int) => (ba: Int.int) => Int.times_int(aa, ba)), a,
        b))

  def value_minus: Option[Value.value] => Option[Value.value] => Option[Value.value] =
    ((a: Option[Value.value]) => (b: Option[Value.value]) =>
      MaybeArithInt(((aa: Int.int) => (ba: Int.int) => Int.minus_int(aa, ba)), a,
        b))

  def value_plus: Option[Value.value] => Option[Value.value] => Option[Value.value] =
    ((a: Option[Value.value]) => (b: Option[Value.value]) =>
  ...
  def input2state(n: List[Value.value]): Map[Nat.nat, Option[Value.value]] =
    Lista.fold[(Nat.nat, Value.value), Map[Nat.nat, Option[Value.value]]](((a: (Nat.nat, Value.value)) =>
      ...
      Lista.enumerate[Value.value](Nat.zero_nat, n),
...
object GExp {
  ...
  def gval(x0: gexp, uu: VName.vname => Option[Value.value]): Trilean.trilean =
    (x0, uu) match {
      ...
      case (In(v, l), s) =>
        (if ((Lista.map[Value.value, Option[Value.value]](((a: Value.value) =>
          Some[Value.value](a)),
          l)) contains (s(v)))
  ...
  def fold_In(uu: VName.vname, x1: List[Value.value]): gexp = (uu, x1) match {
    ...
    case (v, l :: va :: vb) =>
      Lista.fold[Value.value, gexp](Fun.comp[gexp, gexp => gexp, Value.value](((a: gexp) => (b: gexp) =>
        gOr(a, b)),
  ...
  def apply_guards(g: List[gexp], s: VName.vname => Option[Value.value]): Boolean =
    Lista.list_all[Trilean.trilean](((ga: Trilean.trilean) =>
      ...
      Lista.map[gexp, Trilean.trilean](((ga: gexp) => gval(ga, s)), g))

  def max_reg_list(g: List[gexp]): Option[Nat.nat] =
    Lista.fold[gexp, Option[Nat.nat]](Fun.comp[Option[Nat.nat], Option[Nat.nat] => Option[Nat.nat], gexp](((a: Option[Nat.nat]) => (b: Option[Nat.nat]) =>
  ...
  def satisfiable_list(l: List[gexp]): Boolean =
    Dirties.satisfiable(Lista.fold[gexp, gexp](((a: gexp) => (b: gexp) => gAnd(a, b)),
      l, Bc(true)))
  ...
  def enumerate_gexp_ints(x0: gexp): Set.set[Int.int] = x0 match {
    ...
    case In(v, l) =>
      Set.sup_set[Int.int](AExp.enumerate_aexp_ints(AExp.V(v)),
        Lista.fold[Value.value, Set.set[Int.int]](Fun.comp[Set.set[Int.int], (Set.set[Int.int]) => Set.set[Int.int], Value.value](((a: Set.set[Int.int]) =>
...
object Transition {
  ...
  final case class transition_exta[A](a: String, b: Nat.nat, c: List[GExp.gexp],
  ...
  def equal_transition_exta[A: HOL.equal](x0: transition_ext[A],
    ...
    (x0, x1) match {
      case (transition_exta(labela, aritya, guarda, outputsa, updatesa, morea),
        transition_exta(label, arity, guard, outputs, updates, more)) => (labela ==
        label) && ((Nat.equal_nata(aritya,
          arity)) && ((Lista.equal_lista[GExp.gexp](guarda,
            guard)) && ((Lista.equal_lista[AExp.aexp](outputsa,
              outputs)) && ((Lista.equal_lista[(Nat.nat, AExp.aexp)](updatesa,
  ...
  def enumerate_registers(t: transition_ext[Unit]): Set.set[Nat.nat] =
    Set.sup_set[Nat.nat](Set.sup_set[Nat.nat](Set.sup_set[Nat.nat](Complete_Lattices.Sup_set[Nat.nat](Set.seta[Set.set[Nat.nat]](Lista.map[GExp.gexp, Set.set[Nat.nat]](((a: GExp.gexp) =>
      GExp.enumerate_gexp_regs(a)),
      Guard[Unit](t)))),
      Complete_Lattices.Sup_set[Nat.nat](Set.seta[Set.set[Nat.nat]](Lista.map[AExp.aexp, Set.set[Nat.nat]](((a: AExp.aexp) =>
        AExp.enumerate_aexp_regs(a)),
        Outputs[Unit](t))))),
      Complete_Lattices.Sup_set[Nat.nat](Set.seta[Set.set[Nat.nat]](Lista.map[(Nat.nat, AExp.aexp), Set.set[Nat.nat]](((a: (Nat.nat, AExp.aexp)) =>
        {
  ...
  def enumerate_ints(t: transition_ext[Unit]): Set.set[Int.int] =
    Set.sup_set[Int.int](Set.sup_set[Int.int](Set.sup_set[Int.int](Complete_Lattices.Sup_set[Int.int](Set.seta[Set.set[Int.int]](Lista.map[GExp.gexp, Set.set[Int.int]](((a: GExp.gexp) =>
      GExp.enumerate_gexp_ints(a)),
      Guard[Unit](t)))),
      Complete_Lattices.Sup_set[Int.int](Set.seta[Set.set[Int.int]](Lista.map[AExp.aexp, Set.set[Int.int]](((a: AExp.aexp) =>
        AExp.enumerate_aexp_ints(a)),
        Outputs[Unit](t))))),
      Complete_Lattices.Sup_set[Int.int](Set.seta[Set.set[Int.int]](Lista.map[(Nat.nat, AExp.aexp), Set.set[Int.int]](((a: (Nat.nat, AExp.aexp)) =>
        {
          val (_, aa): (Nat.nat, AExp.aexp) = a;
  ...
  def enumerate_inputs(t: transition_ext[Unit]): Set.set[Nat.nat] =
    Set.sup_set[Nat.nat](Set.sup_set[Nat.nat](Complete_Lattices.Sup_set[Nat.nat](Set.seta[Set.set[Nat.nat]](Lista.map[GExp.gexp, Set.set[Nat.nat]](((a: GExp.gexp) =>
  ...
  def Outputs_update[A](outputsa: (List[AExp.aexp]) => List[AExp.aexp],
    x1: transition_ext[A]): transition_ext[A] =
    (outputsa, x1) match {
      case (outputsa, transition_exta(label, arity, guard, outputs, updates, more)) => transition_exta[A](label, arity, guard, outputsa(outputs), updates, more)
    }

  def Updates_update[A](updatesa: (List[(Nat.nat, AExp.aexp)]) => List[(Nat.nat, AExp.aexp)],
    x1: transition_ext[A]): transition_ext[A] =
    (updatesa, x1) match {
      case (updatesa, transition_exta(label, arity, guard, outputs, updates, more)) => transition_exta[A](label, arity, guard, outputs, updatesa(updates), more)
    }
    ...
    (Transition.Label[Unit](t1) ==
      Transition.Label[Unit](t2)) && ((Nat.equal_nata(Transition.Arity[Unit](t1),
        Transition.Arity[Unit](t2))) && ((Lista.equal_lista[AExp.aexp](Transition.Outputs[Unit](t1),
          Transition.Outputs[Unit](t2))) && ((Lista.equal_lista[(Nat.nat, AExp.aexp)](Transition.Updates[Unit](t1),
            Transition.Updates[Unit](t2))) && (Dirties.gexpImplies(Lista.fold[GExp.gexp, GExp.gexp](((a: GExp.gexp) => (b: GExp.gexp) => GExp.gAnd(a, b)),
              Transition.Guard[Unit](t1), GExp.Bc(true)),
              Lista.fold[GExp.gexp, GExp.gexp](((a: GExp.gexp) => (b: GExp.gexp) => GExp.gAnd(a, b)),
...
object String {
  ...
  final case class Char(a: Boolean, b: Boolean, c: Boolean, d: Boolean, e: Boolean, f: Boolean,
    g: Boolean, h: Boolean)
    extends char
  ...
  def implode(cs: List[char]): String =
    "" ++ (Lista.map[char, BigInt](((a: char) => integer_of_char(a)),
...
object Transition_Ordering {
  ...
  def less_transition_ext[A: Orderings.linorder](t1: Transition.transition_ext[A],
    ...
    Product_Lexorder.less_prod[String, (Nat.nat, (List[GExp.gexp], (List[AExp.aexp], (List[(Nat.nat, AExp.aexp)], A))))]((Transition.Label[A](t1),
...
object FSet {
  ...
  def equal_fset[A: HOL.equal](x: fset[A], xa1: fset[A]): Boolean = (x, xa1) match {
...
object Least_Upper_Bound {
  ...
  def merge_in_in(v: VName.vname, l: List[Value.value], x2: List[GExp.gexp]): List[GExp.gexp] =
    (v, l, x2) match {
  ...
  def merge_in_eq(v: VName.vname, l: Value.value, x2: List[GExp.gexp]): List[GExp.gexp] =
    (v, l, x2) match {
  ...
  def gob_aux(t1: Transition.transition_ext[Unit],
    t2: Transition.transition_ext[Unit]): Option[Transition.transition_ext[Unit]] =
    (if ((Lista.equal_lista[AExp.aexp](Transition.Outputs[Unit](t1),
      ...
      (Lista.filter[GExp.gexp](Fun.comp[Boolean, Boolean, GExp.gexp](((a: Boolean) => !a),
        ((a: GExp.gexp) => is_In(a))),
  ...
  def gob(t1ID: List[Nat.nat], t2ID: List[Nat.nat], s: Nat.nat,
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (gob_aux(t1, t2) match {
        case None => None
        case Some(gob_t) =>
          Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](Inference.replace_transitions(newa,
  ...
  def these[A](as: List[Option[A]]): List[A] =
    Lista.map_filter[Option[A], A](((x: Option[A]) =>
  ...
  def has_corresponding(g: GExp.gexp, x1: List[GExp.gexp]): Boolean = (g, x1) match {
    case (g, Nil) => false
    ...
    case (GExp.In(va, la), GExp.In(v, l) :: t) =>
      (if ((VName.equal_vname(va, v)) && (Lista.list_all[Value.value](((a: Value.value) =>
        la contains a),
        l)))
    ...
    (Transition.Label[A](t1) ==
      Transition.Label[B](t2)) && ((Nat.equal_nata(Transition.Arity[A](t1),
        Transition.Arity[B](t2))) && ((Lista.equal_lista[AExp.aexp](Transition.Outputs[A](t1),
          Transition.Outputs[B](t2))) && ((Lista.equal_lista[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1),
            Transition.Updates[B](t2))) && (Lista.list_all[GExp.gexp](((g: GExp.gexp) =>
              has_corresponding(g,
                Transition.Guard[A](t1))),
              Transition.Guard[B](t2))))))

  def get_Ins(g: List[GExp.gexp]): List[(Nat.nat, List[Value.value])] =
    Lista.map_filter[GExp.gexp, (Nat.nat, List[Value.value])](((x: GExp.gexp) =>
      (if ((x match {
  ...
  def get_ins(g: List[GExp.gexp]): List[(Nat.nat, List[Value.value])] =
    Lista.map_filter[(VName.vname, List[Value.value]), (Nat.nat, List[Value.value])](((x: (VName.vname, List[Value.value])) =>
      (if ((x match {
        case (VName.I(_), _) => true
        case (VName.R(_), _) => false
      }))
        Some[(Nat.nat, List[Value.value])]({
        val (VName.I(i), s): (VName.vname, List[Value.value]) = x;
        (i, s)
      })
      else None)),
      these[(VName.vname, List[Value.value])](Lista.map[GExp.gexp, Option[(VName.vname, List[Value.value])]](((a: GExp.gexp) => get_in(a)), g)))
  ...
  def opposite_gob(t1: Transition.transition_ext[Unit],
    ...
    (Lista.list_all[GExp.gexp](((g: GExp.gexp) =>
      ...
      Transition.Guard[Unit](t1))) && ((Lista.list_all[GExp.gexp](((g: GExp.gexp) =>
        (is_lit_eq_general(g)) || (is_input_in(g))),
    ...
    (Transition.Label[A](t1) ==
      Transition.Label[B](t2)) && ((Nat.equal_nata(Transition.Arity[A](t1),
        Transition.Arity[B](t2))) && ((Optiona.is_none[Nat.nat](GExp.max_reg_list(Transition.Guard[B](t2)))) && ((Option_ord.less_option[Nat.nat](GExp.max_input_list(Transition.Guard[B](t2)),
          Some[Nat.nat](Transition.Arity[B](t2)))) && ((GExp.satisfiable_list(Inference.smart_not_null(Lista.upt(Nat.zero_nat,
            Transition.Arity[B](t2)),
            Transition.Guard[B](t2)))) && (Lista.list_ex[(Nat.nat, List[Value.value])](((a: (Nat.nat, List[Value.value])) =>
            {
              val (i, s1): (Nat.nat, List[Value.value]) = a;
              Lista.list_ex[(Nat.nat, List[Value.value])](((aa: (Nat.nat, List[Value.value])) =>
                {
  ...
  def lob_distinguished_2[A, B](t1: Transition.transition_ext[A],
    t2: Transition.transition_ext[B]): Boolean =
    Lista.list_ex[(Nat.nat, List[Value.value])](((a: (Nat.nat, List[Value.value])) =>
      {
    ...
    Lista.list_ex[(Nat.nat, List[Value.value])](((a: (Nat.nat, List[Value.value])) =>
      {
        ...
        (Lista.equal_lista[GExp.gexp](Lista.filter[GExp.gexp](((g: GExp.gexp) =>
          ...
          Transition.Guard[B](t2)),
          List(GExp.In(VName.I(i),
            l)))) && ((Lista.list_ex[(Nat.nat, List[Value.value])](((aa: (Nat.nat, List[Value.value])) =>
            {
...
object Ignore_Inputs {
  ...
  def drop_guards(t: Transition.transition_ext[Unit]): Transition.transition_ext[Unit] =
  ...
  def enumerate_outputs(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: String, a: Nat.nat): FSet.fset[List[AExp.aexp]] =
    FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), List[AExp.aexp]](((aa: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (_, ab): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = aa
        val (_, ac): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = ab;
        Transition.Outputs[Unit](ac)
      }),
      FSet.ffilter[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((b: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (_, (_, t)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = b;
  ...
  def drop_inputs(t1ID: List[Nat.nat], t2ID: List[Nat.nat], s: Nat.nat,
    ...
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (if (FSet_Utils.fis_singleton[List[AExp.aexp]](enumerate_outputs(newa,
        Transition.Label[Unit](t1),
        Transition.Arity[Unit](t1))))
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (id, (route, t)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
        ...
        FSet.ffilter[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
            val (id, _): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
...
object Inference {
  ...
  def S(m: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[Nat.nat] =
    FSet.sup_fset[Nat.nat](FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), Nat.nat](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (_, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
  ...
  def uids(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[Nat.nat] =
    FSet.ffUnion[Nat.nat](FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), FSet.fset[Nat.nat]](Fun.comp[List[Nat.nat], FSet.fset[Nat.nat], (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: List[Nat.nat]) =>
      FSet.fset_of_list[Nat.nat](a)),
      ((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        a._1)),
      e))

  def infer: Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((List[Nat.nat]) => (List[Nat.nat]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat) => ((List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]) => ((FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    ((a: Nat.nat) =>
      (b: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        (c: (List[Nat.nat]) => (List[Nat.nat]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat) =>
          (d: (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]) =>
            (e: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean) =>
              (f: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) =>
                Code_Generation.infer_with_log(Nat.zero_nat, a, b, c, d, e, f))

  def satisfies_trace_prim(uu: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
      ...
      case (e, s, d, (l, (i, p)) :: t) =>
        {
          ...
          (if (FSet_Utils.fis_singleton[(Nat.nat, Transition.transition_ext[Unit])](poss_steps)) {
            val (sa, ta): (Nat.nat, Transition.transition_ext[Unit]) =
              FSet.fthe_elem[(Nat.nat, Transition.transition_ext[Unit])](poss_steps);
  ...
  def satisfies_trace(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
  ...
  def satisfies(t: Set.set[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): Boolean =
    Set.Ball[List[(String, (List[Value.value], List[Value.value]))]](t,
      ((a: List[(String, (List[Value.value], List[Value.value]))]) =>
        satisfies_trace(e, Nat.zero_nat, Map().withDefaultValue(None), a)))
  ...
  def learn(n: Nat.nat,
    ...
    {
      val check: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean = ((a: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) =>
        satisfies(Set.seta[List[(String, (List[Value.value], List[Value.value]))]](l),
          a));
  ...
  def insert_transition(uid: List[Nat.nat], from: Nat.nat, to: Nat.nat,
    ...
    (if (FSet.fBall[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e,
      ...
      {
        val (uida, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
        ({
          val (froma, toa): (Nat.nat, Nat.nat) = ab;
          ((ta: Transition.transition_ext[Unit]) =>
  ...
  def make_distinct(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    Lista.fold[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
        ({
  ...
  def merge_transitions_aux(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    {
      val a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](FSet.ffilter[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (uids, _): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
          Lista.equal_lista[Nat.nat](oldID, uids)
        }),
        e))
      val (uids1, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
      val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
      ({
        val (_, _): (Nat.nat, Nat.nat) = ab;
        ((old: Transition.transition_ext[Unit]) =>
          {
            val ac: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](FSet.ffilter[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((ac: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
              {
                val (uids, _): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = ac;
                Lista.equal_lista[Nat.nat](newID, uids)
              }),
              e))
            val (uids2, ad): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = ac
  ...
  def directly_subsumes(m1: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    m2: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
  ...
  def merge_transitions(oldEFSM: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    modifier: (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (if (Lista.list_all[Nat.nat](((id: Nat.nat) =>
      ...
      destMerge)))(destMerge))(preDestMerge))(oldEFSM))(np) match {
      case None => None
      case Some(e) =>
  ...
  def deterministic(t: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    FSet.equal_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](np(t),
  ...
  def resolve_nondeterminism(uu: List[(Nat.nat, Nat.nat)],
    ...
    newa: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uw: (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    ...
    (uu, x1, uv, newa, uw, check, np) match {
      ...
      case (closed, (from, ((dest_1, dest_2), ((t_1, u_1), (t_2, u_2)))) :: ss,
        oldEFSM, newEFSM, m, check, np) => (if (closed contains (dest_1, dest_2)) None
      else {
        val destMerge: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = (if (Nat.equal_nata(dest_1, dest_2)) newEFSM
        ...
        (merge_transitions(oldEFSM, newEFSM, destMerge, t_1, u_1, t_2,
          u_2, m, np) match {
            ...
            case Some(newa) =>
              {
                val newScores: List[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))] = FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](np(newa));
                (if (Nat.less_nat(Nat.plus_nat(Nat.Nata(newScores.length),
                  Nat.times_nat(FSet.size_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](newa),
                    FSet.size_fset[Nat.nat](S(newa)))),
                  Nat.plus_nat(Nat.Nata(ss.length),
                    Nat.times_nat(FSet.size_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](newEFSM),
  ...
  def merge(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    (if (Nat.equal_nata(s_1, s_2)) None
      ...
      resolve_nondeterminism(Nil, FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](np(ea)),
        e, ea, m, check, np)
    })
  ...
  def k_score_aux(m: Nat.nat,
    ...
    (if (Nat.equal_nata(m, Nat.zero_nat)) {
      ...
      val pairs: FSet.fset[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))] = FSet_Utils.fprod[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](outgoing_1, outgoing_2);
      Lista.fold[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))), Nat.nat](((a: ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))) =>
        {
          val (aa, b): ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) = a;
          ({
            val (_, (_, id1)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = aa;
            ((ab: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
              {
                val (_, (_, id2)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = ab;
                ((acc: Nat.nat) =>
                  Nat.plus_nat(acc, ((strat(id1))(id2))(e)))
              })
          })(b)
        }),
        FSet.sorted_list_of_fset[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))](pairs),
        Nat.zero_nat)
    } else {
      val outgoing_1: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))] = outgoing_transitions(s1, e)
      val outgoing_2: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))] = outgoing_transitions(s2, e)
      val pairs: FSet.fset[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))] = FSet_Utils.fprod[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](outgoing_1, outgoing_2)
      val base_score: Nat.nat =
        Lista.fold[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))), Nat.nat](((a: ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))) =>
          {
            val (aa, b): ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) = a;
            ({
              ...
              ((ab: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
                {
                  val (_, (_, id2)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = ab;
                  ((acc: Nat.nat) => Nat.plus_nat(acc, ((strat(id1))(id2))(e)))
                })
            })(b)
          }),
          FSet.sorted_list_of_fset[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))](pairs),
          Nat.zero_nat)
          println(s1, s2, base_score)
      val dest_scores: FSet.fset[(Nat.nat, (Nat.nat, Nat.nat))] =
        FSet.fimage[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))), (Nat.nat, (Nat.nat, Nat.nat))](((a: ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))) =>
          {
            val (aa, b): ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) = a;
            ({
              val (d1, (_, _)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = aa;
              ((ab: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
                {
                  val (d2, (_, _)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = ab;
                  (d1, (d2, k_score_aux(Nat.minus_nat(m, Nat.Nata((1))), e, d1, d2,
                    strat)))
                })
            })(b)
          }),
          pairs)
      val nonzero_scores: FSet.fset[(Nat.nat, (Nat.nat, Nat.nat))] =
        FSet.ffilter[(Nat.nat, (Nat.nat, Nat.nat))](((a: (Nat.nat, (Nat.nat, Nat.nat))) =>
          {
            val (_, aa): (Nat.nat, (Nat.nat, Nat.nat)) = a
            val (_, ab): (Nat.nat, Nat.nat) = aa;
            Nat.less_nat(Nat.zero_nat, ab)
          }),
          dest_scores);
          println("  " + FSet.sorted_list_of_fset(nonzero_scores).map{case (d1, (d2, s)) => (PrettyPrinter.natToString(d1), PrettyPrinter.natToString(d2), PrettyPrinter.natToString(s))})
      Lista.fold[(Nat.nat, (Nat.nat, Nat.nat)), Nat.nat](((a: (Nat.nat, (Nat.nat, Nat.nat))) =>
        {
          val (_, (_, s)): (Nat.nat, (Nat.nat, Nat.nat)) = a;
          ((acc: Nat.nat) => Nat.plus_nat(acc, s))
        }),
        FSet.sorted_list_of_fset[(Nat.nat, (Nat.nat, Nat.nat))](nonzero_scores),
        base_score)
    })
        ...
        FSet.fimage[(Nat.nat, Nat.nat), score_ext[Unit]](((a: (Nat.nat, Nat.nat)) =>
          {
            ...
            score_exta[Unit](k_score_aux(k, e, s1, s2, strat), s1, s2, ())
          }),
          pairs_to_score);
      val scores = FSet.ffilter[score_ext[Unit]](((x: score_ext[Unit]) =>
        Nat.less_nat(Nat.zero_nat, Score[Unit](x))),
        a)
        for (score <- FSet.sorted_list_of_fset(scores))
          println(score)
        System.exit(0)
        scores
    }
  ...
  def max_uid(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[Nat.nat] =
    {
  ...
  def max_uid_total(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    (max_uid(e) match {
      case None => Nat.zero_nat
      case Some(u) => u
    })
  ...
  def make_guard(x0: List[Value.value], uu: Nat.nat): List[GExp.gexp] = (x0, uu) match {
    case (Nil, uu) => Nil
    case (h :: t, n) =>
      GExp.Eq(AExp.V(VName.I(n)), AExp.L(h)) ::
        make_guard(t, Nat.plus_nat(n, Nat.Nata((1))))
  }

  def add_transition(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s: Nat.nat, label: String, inputs: List[Value.value],
    outputs: List[Value.value]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.finsert[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]((List(Nat.plus_nat(max_uid_total(e),
      Nat.Nata((1)))),
      ((s, Nat.plus_nat(EFSM.maxS(tm(e)), Nat.Nata((1)))),
        Transition.transition_exta[Unit](label,
          Nat.Nata(inputs.length), make_guard(inputs, Nat.zero_nat),
          make_outputs(outputs), Nil, ()))),
      e)

  def make_branch(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: Nat.nat, uv: Map[Nat.nat, Option[Value.value]],
    x3: List[(String, (List[Value.value], List[Value.value]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (e, uu, uv, x3) match {
      case (e, uu, uv, Nil) => e
        ...
        (EFSM.step(tm(e), s, r, label, inputs) match {
          case None =>
            make_branch(add_transition(e, s, label, inputs, outputs),
              Nat.plus_nat(EFSM.maxS(tm(e)), Nat.Nata((1))), r, t)
          case Some((_, (sa, (outputsa, updated)))) =>
            (if (Lista.equal_lista[Option[Value.value]](outputsa,
              ...
              Nat.plus_nat(EFSM.maxS(tm(e)), Nat.Nata((1))), r,
              t))
        })
    }

  def make_pta_aux(l: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    Lista.fold[List[(String, (List[Value.value], List[Value.value]))], FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((h: List[(String, (List[Value.value], List[Value.value]))]) =>
      (ea: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        make_branch(ea, Nat.zero_nat,
  ...
  def make_pta(log: List[List[(String, (List[Value.value], List[Value.value]))]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    make_pta_aux(log, FSet.bot_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))])
  ...
  def get_by_id(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uid: Nat.nat): Transition.transition_ext[Unit] =
    (Fun.comp[((Nat.nat, Nat.nat), Transition.transition_ext[Unit]), Transition.transition_ext[Unit], (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) =>
      ...
      ((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        ...
        {
          val (tids, _): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
          tids contains uid
        }),
        e)))
  ...
  def smart_not_null(l: List[Nat.nat], g: List[GExp.gexp]): List[GExp.gexp] =
    Lista.foldr[Nat.nat, List[GExp.gexp]](((a: Nat.nat) => (b: List[GExp.gexp]) =>
      fold_into(a, b)),
      l, g)
    ...
    (Transition.Label[Unit](ta) ==
      Transition.Label[Unit](t)) && ((Nat.equal_nata(Transition.Arity[Unit](ta),
        Transition.Arity[Unit](t))) && ((Optiona.is_none[Nat.nat](GExp.max_reg_list(Transition.Guard[Unit](ta)))) && ((Option_ord.less_option[Nat.nat](GExp.max_input_list(Transition.Guard[Unit](ta)),
          Some[Nat.nat](Transition.Arity[Unit](ta)))) && ((GExp.satisfiable_list(smart_not_null(Lista.upt(Nat.zero_nat,
  ...
  def null_modifier(uu: List[Nat.nat], uv: List[Nat.nat], uw: Nat.nat,
    ...
    uz: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    va: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    None

  def inference_step(uu: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x1: List[score_ext[Unit]],
    uv: (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    uw: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean,
    ux: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
  ...
  def try_heuristics(x0: List[(List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]],
    uu: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (x0, uu) match {
      case (Nil, uu) =>
      ...
      case (h :: t, np) =>
        ((a: List[Nat.nat]) => (b: List[Nat.nat]) => (c: Nat.nat) =>
          (d: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
            (e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
              (f: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                (npa: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) =>
  ...
  def make_outputs_abstract(x0: List[Value.value], uu: Nat.nat,
    ...
    p: List[AExp.aexp]): List[AExp.aexp] =
    (x0, uu, uv, p) match {
  ...
  def make_guard_abstract(x0: List[Value.value], uu: Nat.nat, uv: Nat.nat,
    ...
    u: List[(Nat.nat, AExp.aexp)]): (List[GExp.gexp], (List[(Nat.nat, AExp.aexp)], Map[String, Option[Nat.nat]])) =
    (x0, uu, uv, r, g, u) match {
      case (Nil, uu, uv, r, g, u) => (g, (u, r))
      case (h :: t, i, maxR, r, g, u) =>
        (h match {
          case Value.Numa(_) =>
            make_guard_abstract(t, Nat.plus_nat(i, Nat.Nata((1))), maxR, r,
              GExp.Eq(AExp.V(VName.I(i)), AExp.L(h)) :: g, u)
          case Value.Str(s) =>
            (if (s == "_")
              make_guard_abstract(t, Nat.plus_nat(i, Nat.Nata((1))), maxR, r, g, u)
            else (if (s.startsWith("$"))
              (r(s) match {
              case None =>
                make_guard_abstract(t, Nat.plus_nat(i, Nat.Nata((1))),
                  Nat.plus_nat(maxR, Nat.Nata((1))), r + (s -> (Some[Nat.nat](maxR))), g,
              ...
              make_guard_abstract(t,
                Nat.plus_nat(i, Nat.Nata((1))), maxR, r,
  ...
  def add_transition_abstract(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    r: Map[String, Option[Nat.nat]], s: Nat.nat,
    label: String, inputs: List[Value.value],
    outputs: List[Value.value]): (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))], Map[String, Option[Nat.nat]]) =
    {
      val regs: FSet.fset[Nat.nat] =
        FSet.fimage[((Nat.nat, Nat.nat), Transition.transition_ext[Unit]), Nat.nat](Fun.comp[Transition.transition_ext[Unit], Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((a: Transition.transition_ext[Unit]) =>
      ...
      val (g, (u1, ra)): (List[GExp.gexp], (List[(Nat.nat, AExp.aexp)], Map[String, Option[Nat.nat]])) = make_guard_abstract(inputs, Nat.zero_nat, maxR, r, Nil, Nil)
      ...
      (if (label.endsWith("*"))
        ...
        e),
        ra)
      else (FSet.finsert[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]((List(Nat.plus_nat(max_uid_total(e),
        Nat.Nata((1)))),
        ((s, Nat.plus_nat(EFSM.maxS(tm(e)), Nat.Nata((1)))),
          Transition.transition_exta[Unit](label,
            Nat.Nata(inputs.length), g, p, u1, ()))),
  ...
  def make_branch_abstract(x0: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))], Map[String, Option[Nat.nat]]),
    uu: Nat.nat, uv: Map[Nat.nat, Option[Value.value]],
    x3: List[(String, (List[Value.value], List[Value.value]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, uu, uv, x3) match {
        ...
        (EFSM.step(tm(e), s, r, label, inputs) match {
          ...
          case Some((_, (sa, (outputsa, updated)))) =>
            (if (Lista.equal_lista[Option[Value.value]](outputsa,
              ...
              inputs, outputs),
              Nat.plus_nat(EFSM.maxS(tm(e)),
                Nat.Nata((1))),
              r, t))
        })
    }

  def make_pta_abstract(l: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    Lista.fold[List[(String, (List[Value.value], List[Value.value]))], FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((h: List[(String, (List[Value.value], List[Value.value]))]) =>
      (ea: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        make_branch_abstract((ea,
          Map().withDefaultValue(None)),
          Nat.zero_nat, Map().withDefaultValue(None), h)),
      l, e)
  ...
  def replace_transition(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uids, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
        ({
  ...
  def replace_transitions(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    Lista.fold[(List[Nat.nat], Transition.transition_ext[Unit]), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
      {
        val (uid, newa): (List[Nat.nat], Transition.transition_ext[Unit]) = a;
  ...
  def enumerate_exec_values(vs: List[(String, (List[Value.value], List[Value.value]))]): List[Value.value] =
    Lista.fold[(String, (List[Value.value], List[Value.value])), List[Value.value]](((a: (String, (List[Value.value], List[Value.value]))) =>
      {
        val (_, (i, p)): (String, (List[Value.value], List[Value.value])) = a;
  ...
  def state_nondeterminism(og: Nat.nat,
    ...
    (if (Nat.less_nat(FSet.size_fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](nt),
      ...
      {
        val (dest, t): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = x;
        FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](((y: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
          {
            val (desta, ta): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = y;
            (og, ((dest, desta), (t, ta)))
          }),
  ...
  def try_heuristics_check(uu: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean,
    x1: List[(List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]],
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, x1, uv) match {
      case (uu, Nil, uv) =>
        ((a: List[Nat.nat]) => (b: List[Nat.nat]) => (c: Nat.nat) =>
          (d: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
  ...
  def nondeterministic_pairs(t: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](((a: (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat])))) = a
        val (_, ab): ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))) = aa
        val (ac, b): ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat])) = ab;
        ({
  ...
  def nondeterministic_pairs_labar(t: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](((a: (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat])))) = a
        val (ab, b): ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))) = aa;
        ({
          val (_, _): (Nat.nat, Nat.nat) = ab;
          ((ac: ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))) =>
            {
              val (ad, ba): ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat])) = ac;
              ({
                val (ta, _): (Transition.transition_ext[Unit], List[Nat.nat]) =
                  ad;
                ((ae: (Transition.transition_ext[Unit], List[Nat.nat])) =>
                  {
                    val (taa, _): (Transition.transition_ext[Unit], List[Nat.nat]) = ae;
                    (Transition.Label[Unit](ta) ==
                      Transition.Label[Unit](taa)) && ((Nat.equal_nata(Transition.Arity[Unit](ta),
                        Transition.Arity[Unit](taa))) && ((EFSM.choice(ta,
...
object Code_Generation {
  ...
  def choice_cases(t1: Transition.transition_ext[Unit],
    t2: Transition.transition_ext[Unit]): Boolean =
    (if (Lista.list_ex[(GExp.gexp, GExp.gexp)](((a: (GExp.gexp, GExp.gexp)) =>
      {
        val (aa, b): (GExp.gexp, GExp.gexp) = a;
        mutex(aa, b)
      }),
      Lista.product[GExp.gexp, GExp.gexp](Transition.Guard[Unit](t1), Transition.Guard[Unit](t2))))
      false
    else (if (Lista.equal_lista[GExp.gexp](Transition.Guard[Unit](t1),
      Transition.Guard[Unit](t2)))
      Dirties.satisfiable(Lista.foldr[GExp.gexp, GExp.gexp](((a: GExp.gexp) => (b: GExp.gexp) => GExp.gAnd(a, b)),
      Transition.Guard[Unit](t1), GExp.Bc(true)))
    else Dirties.satisfiable(Lista.foldr[GExp.gexp, GExp.gexp](((a: GExp.gexp) => (b: GExp.gexp) => GExp.gAnd(a, b)),
        ...
        case Some(newa) =>
          {
            ...
            (if (FSet.less_fset[Nat.nat](Inference.S(newa), Inference.S(e)))
              infer_with_log(Nat.plus_nat(stepNo, Nat.Nata((1))), k, newa, r, m,
              check, np)
            else e)
          }
      })
  ...
  def guardMatch_code(uu: List[GExp.gexp], uv: List[GExp.gexp]): Boolean =
    (uu, uv) match {
      case (List(GExp.Eq(AExp.V(VName.I(ia)), AExp.L(Value.Numa(na)))),
        List(GExp.Eq(AExp.V(VName.I(i)), AExp.L(Value.Numa(n))))) => (Nat.equal_nata(ia, Nat.zero_nat)) && (Nat.equal_nata(i, Nat.zero_nat))
      case (Nil, uv) => false
  ...
  def is_generalisation_of(ta: Transition.transition_ext[Unit],
    ...
    (Transition.equal_transition_exta[Unit](ta,
      Store_Reuse.remove_guard_add_update(t, i,
        r))) && ((Nat.less_nat(i, Transition.Arity[Unit](t))) && ((!((Lista.map[(Nat.nat, AExp.aexp), Nat.nat](((a: (Nat.nat, AExp.aexp)) => a._1),
  ...
  def input_updates_register(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): (Nat.nat, String) =
    {
      val (_, t): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) =
        FSet.fthe_elem[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](FSet.ffilter[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((a: ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) =>
          {
            val (_, t): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = a;
  ...
  def always_different_outputs_direct_subsumption(m1: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    m2: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    sa: Nat.nat, s: Nat.nat, t: Transition.transition_ext[Unit]): Boolean =
  ...
  def guard_subset_eq_outputs_updates[A, B](t1: Transition.transition_ext[A],
    ...
    (Transition.Label[A](t1) ==
      Transition.Label[B](t2)) && ((Nat.equal_nata(Transition.Arity[A](t1),
        Transition.Arity[B](t2))) && ((Lista.equal_lista[AExp.aexp](Transition.Outputs[A](t1),
          Transition.Outputs[B](t2))) && ((Lista.equal_lista[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1),
            Transition.Updates[B](t2))) && (Lista.list_all[GExp.gexp](((a: GExp.gexp) =>
  ...
  def directly_subsumes_cases(e1: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e2: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s1: Nat.nat, s2: Nat.nat,
    t1: Transition.transition_ext[Unit],
    t2: Transition.transition_ext[Unit]): Boolean =
    (if (Transition.equal_transition_exta[Unit](t1, t2)) true
      ...
      t2)) && (Least_Upper_Bound.lob_distinguished_3[Unit, Unit](t1, t2)))
      false
  ...
  def no_illegal_updates_code(x0: List[(Nat.nat, AExp.aexp)], uu: Nat.nat): Boolean =
    (x0, uu) match {
      case (Nil, uu) => true
      case ((ra, u) :: t, r) =>
...
object Store_Reuse_Subsumption {
  ...
  def not_updated(r: Nat.nat, t: Transition.transition_ext[Unit]): Boolean =
    (Lista.filter[(Nat.nat, AExp.aexp)](((a: (Nat.nat, AExp.aexp)) =>
      {
        val (ra, _): (Nat.nat, AExp.aexp) = a;
        Nat.equal_nata(ra, r)
      }),
      Transition.Updates[Unit](t))).isEmpty

  def stored_reused_aux_per_reg(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit], r: Nat.nat,
    p: Nat.nat): Option[(Nat.nat, Nat.nat)] =
    (if (Nat.equal_nata(r, Nat.zero_nat))
      (if (Store_Reuse.is_generalised_output_of(ta, t, Nat.zero_nat, p))
      Some[(Nat.nat, Nat.nat)]((Nat.zero_nat, p)) else None)
    else (if (Store_Reuse.is_generalised_output_of(ta, t,
      Nat.Suc(Nat.minus_nat(r, Nat.Nata((1)))), p))
      Some[(Nat.nat, Nat.nat)]((Nat.Suc(Nat.minus_nat(r, Nat.Nata((1)))), p))
  ...
  def stored_reused_aux(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit], r: Nat.nat,
    p: Nat.nat): Option[(Nat.nat, Nat.nat)] =
    (if (Nat.equal_nata(p, Nat.zero_nat))
      stored_reused_aux_per_reg(ta, t, r, Nat.zero_nat)
    else (stored_reused_aux_per_reg(ta, t, r,
      Nat.Suc(Nat.minus_nat(p, Nat.Nata((1))))) match {
        case None =>
  ...
  def stored_reused(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit]): Option[(Nat.nat, Nat.nat)] =
  ...
  def input_i_stored_in_reg(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit], i: Nat.nat,
    r: Nat.nat): Option[(Nat.nat, Nat.nat)] =
    (if (Nat.equal_nata(r, Nat.zero_nat))
      (if (Store_Reuse.is_generalisation_of(ta, t, i, Nat.zero_nat))
      Some[(Nat.nat, Nat.nat)]((i, Nat.zero_nat)) else None)
    else (if (Store_Reuse.is_generalisation_of(ta, t, i,
      Nat.Suc(Nat.minus_nat(r, Nat.Nata((1))))))
      Some[(Nat.nat, Nat.nat)]((i, Nat.Suc(Nat.minus_nat(r, Nat.Nata((1))))))
  ...
  def input_stored_in_reg_aux(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit], i: Nat.nat,
    r: Nat.nat): Option[(Nat.nat, Nat.nat)] =
    (if (Nat.equal_nata(i, Nat.zero_nat))
      input_i_stored_in_reg(ta, t, Nat.zero_nat, r)
  ...
  def input_stored_in_reg(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[(Nat.nat, Nat.nat)] =
    (input_stored_in_reg_aux(ta, t, Store_Reuse.total_max_reg(e),
      Orderings.max[Nat.nat](Transition.Arity[Unit](t),
        Transition.Arity[Unit](ta))) match {
        case None => None
        case Some((i, r)) =>
          (if (Nat.equal_nata(Nat.Nata((Lista.filter[(Nat.nat, AExp.aexp)](((a: (Nat.nat, AExp.aexp)) =>
            {
              val (ra, _): (Nat.nat, AExp.aexp) = a;
              Nat.equal_nata(ra, r)
            }),
  ...
  def updates_subset(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Boolean =
      ...
      case Some((i, r)) =>
        (Nat.equal_nata(Transition.Arity[Unit](t),
          Transition.Arity[Unit](ta))) && ((Set.less_set[GExp.gexp](Set.seta[GExp.gexp](Transition.Guard[Unit](t)),
            Set.seta[GExp.gexp](Transition.Guard[Unit](ta)))) && ((!((Lista.map[(Nat.nat, AExp.aexp), Nat.nat](((a: (Nat.nat, AExp.aexp)) => a._1),
              Lista.removeAll[(Nat.nat, AExp.aexp)]((r, AExp.V(VName.I(i))),
                Transition.Updates[Unit](t)))) contains r)) && ((!((Lista.map[(Nat.nat, AExp.aexp), Nat.nat](((a: (Nat.nat, AExp.aexp)) => a._1),
              Transition.Updates[Unit](ta))) contains r)) && ((Option_ord.less_option[Nat.nat](GExp.max_input_list(Transition.Guard[Unit](ta)),
              Some[Nat.nat](Transition.Arity[Unit](ta)))) && ((GExp.satisfiable_list(Inference.smart_not_null(Lista.upt(Nat.zero_nat,
                Transition.Arity[Unit](ta)),
                Transition.Guard[Unit](ta)))) && ((Optiona.is_none[Nat.nat](GExp.max_reg_list(Transition.Guard[Unit](ta)))) && (Nat.less_nat(i,
                Transition.Arity[Unit](ta)))))))))
    })

  def initially_undefined_context_check(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    r: Nat.nat, s: Nat.nat): Boolean =
    (if ((Nat.equal_nata(s, Nat.zero_nat)) && (FSet.fBall[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](e,
      ((a: ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) =>
        {
          ...
          ({
            ...
            ((_: Transition.transition_ext[Unit]) =>
              !(Nat.equal_nata(to, Nat.zero_nat)))
          })(b)
        }))))
      true else Dirties.initiallyUndefinedContextCheck(e, r, s))

  def one_extra_update[A](t1: Transition.transition_ext[A],
    t2: Transition.transition_ext[Unit], s2: Nat.nat,
          ...
          Transition.Guard[A](t1))) && ((Lista.equal_lista[AExp.aexp](Transition.Outputs[A](t1),
            Transition.Outputs[Unit](t2))) && ((!((Transition.Updates[A](t1)).isEmpty)) && ((Lista.equal_lista[(Nat.nat, AExp.aexp)](Lista.tl[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1)),
              Transition.Updates[Unit](t2))) && (Lista.list_ex[Nat.nat](((r: Nat.nat) =>
                (Nat.equal_nata(((Transition.Updates[A](t1)).head)._1,
  ...
  def generalise_output_direct_subsumption(ta: Transition.transition_ext[Unit],
    ...
    ea: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    sa: Nat.nat, s: Nat.nat): Boolean =
    (stored_reused(ta, t) match {
      case None => false
      case Some((r, p)) =>
        ((Transition.Outputs[Unit](t))(Code_Numeral.integer_of_nat(p).toInt) match {
          case AExp.L(v) =>
  ...
  def drop_guard_add_update_direct_subsumption(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s: Nat.nat): Boolean =
  ...
  def drop_update_add_guard_direct_subsumption(a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    b: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
...
object Store_Reuse {
  ...
  def count[A: HOL.equal](uu: A, x1: List[A]): Nat.nat = (uu, x1) match {
    case (uu, Nil) => Nat.zero_nat
    case (a, h :: t) =>
      (if (HOL.eq[A](a, h)) Nat.plus_nat(Nat.Nata((1)), count[A](a, t))
      else count[A](a, t))
  }
  ...
  def index(x0: List[Value.value], uu: Nat.nat, uv: ioTag, uw: Nat.nat): FSet.fset[(Nat.nat, (ioTag, Nat.nat))] =
    (x0, uu, uv, uw) match {
      ...
      case (h :: t, eventNo, io, ind) =>
        FSet.finsert[(Nat.nat, (ioTag, Nat.nat))]((eventNo, (io, ind)),
          index(t, eventNo, io,
            Nat.plus_nat(ind, Nat.Nata((1)))))
    }
  ...
  def i_step(tr: List[(String, List[Value.value])],
    ...
    {
      val poss_steps: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = Inference.i_possible_steps(e, s, r, l, i)
      val possibilities: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
        {
          val (_, (sa, t)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = a;
  ...
  def generalise_transitions(x0: List[((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))))],
    ...
    (x0, e) match {
      ...
      case (h :: t, e) =>
        {
          val a: ((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) = h
          val (aa, b): ((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) = a;
          ({
            val (ab, ba): (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = aa;
            ({
              val (ac, bb): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ab;
              ({
                val (orig1, _): (Transition.transition_ext[Unit], List[Nat.nat]) = ac;
                ((_: (ioTag, Nat.nat)) =>
                  (ad: ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) =>
                    {
                      val (ae, bc): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ad;
                      ({
                        val (orig2, _): (Transition.transition_ext[Unit], List[Nat.nat]) = ae;
                        ((_: (ioTag, Nat.nat)) =>
                          (af: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) =>
                            {
                              val (ag, bd): (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = af;
                              ({
                                val (ah, be): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ag;
                                ({
                                  val (gen1, _): (Transition.transition_ext[Unit], List[Nat.nat]) = ah;
                                  ((_: (ioTag, Nat.nat)) =>
                                    (ai: ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) =>
                                      {
                                        val (aj, bf): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ai;
                                        ({
                                          val (gen2, _): (Transition.transition_ext[Unit], List[Nat.nat]) = aj;
                                          ((_: (ioTag, Nat.nat)) =>
  ...
  def strip_uids(x: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))): ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat))) =
    {
      val a: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = x
      val (aa, b): (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = a;
      ({
        val (ab, ba): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = aa;
        ({
          ...
          ((ac: (ioTag, Nat.nat)) =>
            {
              ...
              ((ad: ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) =>
                {
                  val (ae, bb): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ad;
                  ({
                    val (t2, _): (Transition.transition_ext[Unit], List[Nat.nat]) = ae;
                    ((af: (ioTag, Nat.nat)) =>
                      {
  ...
  def modify(matches: List[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))],
    ...
    {
      val relevant: List[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))] = Lista.filter[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) =>
        {
          val (aa, b): (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = a;
          ({
            val (ab, ba): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = aa;
                  ...
                  ((ad: ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) =>
                    {
                      val (ae, bb): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ad;
                      ({
                        val (_, u2a): (Transition.transition_ext[Unit], List[Nat.nat]) = ae;
                        ((af: (ioTag, Nat.nat)) =>
                          {
      ...
      val newReg: Nat.nat = (Inference.max_reg(old) match {
        ...
        case Some(r) => Nat.plus_nat(r, Nat.Nata((1)))
      })
      val replacements: List[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))] = Lista.map[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) =>
        {
          val (aa, b): (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = a;
          ({
            val (ab, ba): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = aa;
                  ...
                  ((ad: ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) =>
                    {
                      val (ae, bb): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ad;
                      ({
                        val (t2, u2a): (Transition.transition_ext[Unit], List[Nat.nat]) = ae;
                        ((af: (ioTag, Nat.nat)) =>
                          {
        ...
        relevant)
      val comparisons: List[((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))))] = (relevant zip replacements)
      val stripped_replacements: List[((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat)))] = Lista.map[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) =>
        strip_uids(a)),
        replacements)
      val to_replace: List[((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))))] = Lista.filter[((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))))](((a: ((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))))) =>
        {
          val (_, s): ((((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) = a;
          Nat.less_nat(Nat.Nata((1)),
            count[((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat)))](strip_uids(s),
  ...
  def io_index(eventNo: Nat.nat, inputs: List[Value.value],
    ...
    FSet.sup_fset[(Nat.nat, (ioTag, Nat.nat))](index(inputs, eventNo, In(), Nat.zero_nat),
      index(outputs, eventNo, Out(), Nat.zero_nat))
    ...
    Dirties.foldl[FSet.fset[(Nat.nat, (ioTag, Nat.nat))], (Nat.nat, (String, (List[Value.value], List[Value.value])))](((a: FSet.fset[(Nat.nat, (ioTag, Nat.nat))]) =>
      (x: (Nat.nat, (String, (List[Value.value], List[Value.value])))) =>
        FSet.sup_fset[(Nat.nat, (ioTag, Nat.nat))](a, {
          val (eventNo, aa): (Nat.nat, (String, (List[Value.value], List[Value.value]))) = x
      ...
      Lista.enumerate[(String, (List[Value.value], List[Value.value]))](Nat.zero_nat, e))
  ...
  def structural_count(uu: ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat))),
    ...
    (uu, x1) match {
      ...
      case (a, ((t1, (io1, i1)), (t2, (io2, i2))) :: t) =>
        {
          val b: ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat))) = a
          val (ba, c): ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat))) = b;
          ({
            val (t1a, (io1a, i1a)): (Transition.transition_ext[Unit], (ioTag, Nat.nat)) = ba;
            ((bb: (Transition.transition_ext[Unit], (ioTag, Nat.nat))) =>
              {
                val (t2a, (io2a, i2a)): (Transition.transition_ext[Unit], (ioTag, Nat.nat)) = bb;
                    ...
                    t2)) && ((equal_ioTaga(io1a,
                      io1)) && ((equal_ioTaga(io2a,
                        io2)) && ((Nat.equal_nata(i1a, i1)) && (Nat.equal_nata(i2a,
                          i2)))))))
                  Nat.plus_nat(Nat.Nata((1)), structural_count(a, t))
  ...
  def generalise_input(t: Transition.transition_ext[Unit], r: Nat.nat,
    ...
    Transition.transition_exta[Unit](Transition.Label[Unit](t),
      Transition.Arity[Unit](t),
      Lista.map[GExp.gexp, GExp.gexp](((g: GExp.gexp) =>
        (g match {
          case GExp.Bc(_) => g
  ...
  def walk_up_to(n: Nat.nat,
    ...
    (n, e, s, r, x4) match {
      case (n, e, s, r, h :: t) =>
        {
          val (Some((transition, (sa, (uid, updated))))): Option[(Transition.transition_ext[Unit], (Nat.nat, (List[Nat.nat], Map[Nat.nat, Option[Value.value]])))] = i_step(exec2trace[String, List[Value.value], List[Value.value]](t), e,
            s, r, h._1, (h._2)._1);
          (if (Nat.equal_nata(n, Nat.zero_nat)) (transition, uid)
  ...
  def get_by_id_intratrace_matches(e: List[(String, (List[Value.value], List[Value.value]))]): FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))] =
    FSet.ffilter[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))](((a: ((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))) =>
      {
        val (aa, b): ((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat))) = a;
          ...
          ((ab: (Nat.nat, (ioTag, Nat.nat))) =>
            {
              ...
              ((walk_up_to(e1, e, Nat.zero_nat, Map().withDefaultValue(None), t),
                (io1, inx1)),
                (walk_up_to(e2, e, Nat.zero_nat, Map().withDefaultValue(None), t),
                  (io2, inx2)))
            })
        })(b)
      }),
    ...
    Lista.filter[(((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))) =>
      {
        val (aa, b): (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) = a;
        ({
          val (e1, (_, _)): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = aa;
          ((ab: ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat))) =>
            {
              val (e2, (_, _)): ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)) = ab;
      ...
      Lista.maps[(List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))]), (((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], List[Nat.nat]), (ioTag, Nat.nat)))](((a: (List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))])) =>
        {
          val (t, m): (List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))]) = a;
        ...
        (l zip (Lista.map[List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))]](((a: List[(String, (List[Value.value], List[Value.value]))]) =>
          get_by_id_intratrace_matches(a)),
          l)))))

  def heuristic_1(l: List[List[(String, (List[Value.value], List[Value.value]))]]): (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    ((t1: List[Nat.nat]) => (t2: List[Nat.nat]) => (_: Nat.nat) =>
      (newa: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        (_: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
          (old: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
            (np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) =>
              (modify(find_intertrace_matches(l, old), t1, t2, newa) match {
                case None => None
                case Some(newEFSM) =>
                  Inference.resolve_nondeterminism(Nil,
                    FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](np(newEFSM)),
                    old, newEFSM,
                    ((a: List[Nat.nat]) => (b: List[Nat.nat]) => (c: Nat.nat) =>
                      (d: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                        (e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
  ...
  def heuristic_2(l: List[List[(String, (List[Value.value], List[Value.value]))]]): (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    ((t1: List[Nat.nat]) => (t2: List[Nat.nat]) => (_: Nat.nat) =>
      (newa: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        (_: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
          (old: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
            (np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) =>
              (modify_2(find_intertrace_matches(l, old), t1, t2, newa) match {
                ...
                case Some(newEFSM) =>
                  Inference.resolve_nondeterminism(Nil,
                    FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](Inference.nondeterministic_pairs(newEFSM)),
                    old, newEFSM,
                    ((a: List[Nat.nat]) => (b: List[Nat.nat]) => (c: Nat.nat) =>
                      (d: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                        (e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
  ...
  def total_max_reg(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
...
object EFSM {
  ...
  def maxS(t: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): Nat.nat =
    (if (FSet.equal_fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](t,
      FSet.bot_fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]))
      Nat.zero_nat
    else FSet.fMax[Nat.nat](FSet.sup_fset[Nat.nat](FSet.fimage[((Nat.nat, Nat.nat), Transition.transition_ext[Unit]), Nat.nat](((a: ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) =>
      {
        val (aa, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = a;
        ({
  ...
  def apply_updates(x0: List[(Nat.nat, AExp.aexp)],
    ...
    newa: Map[Nat.nat, Option[Value.value]]): Map[Nat.nat, Option[Value.value]] =
    (x0, uu, newa) match {
  ...
  def apply_outputs(p: List[AExp.aexp], s: VName.vname => Option[Value.value]): List[Option[Value.value]] =
    Lista.map[AExp.aexp, Option[Value.value]](((pa: AExp.aexp) => AExp.aval(pa, s)), p)

  def step(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    s: Nat.nat, r: Map[Nat.nat, Option[Value.value]], l: String,
    i: List[Value.value]): Option[(Transition.transition_ext[Unit], (Nat.nat, (List[Option[Value.value]], Map[Nat.nat, Option[Value.value]])))] =
    (Dirties.randomMember[(Nat.nat, Transition.transition_ext[Unit])](possible_steps(e, s,
      r, l, i)) match {
      case None => None
      case Some((sa, t)) =>
        Some[(Transition.transition_ext[Unit], (Nat.nat, (List[Option[Value.value]], Map[Nat.nat, Option[Value.value]])))]((t,
  ...
  def accepts_prim(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    s: Nat.nat, d: Map[Nat.nat, Option[Value.value]],
...
object Equals {
  ...
  def is_equals(t: Transition.transition_ext[Unit]): Boolean =
    {
      ...
      (Transition.Label[Unit](t) ==
        "equals") && ((Nat.equal_nata(Transition.Arity[Unit](t),
          Code_Numeral.nat_of_integer(BigInt(2)))) && ((Value.equal_valuea((ep(Code_Numeral.integer_of_nat(Nat.zero_nat).toInt))._2,
            (ep(Code_Numeral.integer_of_nat(Nat.Nata((1))).toInt))._2)) && ((Lista.equal_lista[Nat.nat](Lista.map[(Nat.nat, Value.value), Nat.nat](((a: (Nat.nat, Value.value)) => a._1), ep),
              List(Nat.zero_nat,
  ...
  def gen_eq: Transition.transition_ext[Unit] =
    Transition.transition_exta[Unit]("equals",
      Code_Numeral.nat_of_integer(BigInt(2)),
      List(GExp.Eq(AExp.V(VName.I(Nat.zero_nat)),
  ...
  def equals(t1ID: List[Nat.nat], t2ID: List[Nat.nat], s: Nat.nat,
    ...
    uu: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (if ((is_equals(t1)) && (is_equals(t2)))
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](Inference.replace_transitions(destMerge,
...
object EFSM_Dot {
  ...
  def updates2dot_aux(l: List[(Nat.nat, AExp.aexp)]): List[String] =
    Lista.map[(Nat.nat, AExp.aexp), String](((a: (Nat.nat, AExp.aexp)) =>
      {
  ...
  def outputs2dot(x0: List[AExp.aexp], uu: Nat.nat): List[String] = (x0, uu) match {
    ...
    case (h :: t, n) =>
      "o<sub>" + Code_Numeral.integer_of_nat(n).toString() + "</sub> := " +
        aexp2dot(h) ::
        outputs2dot(t, Nat.plus_nat(n, Nat.Nata((1))))
  }
  ...
  def gexp2dot(x0: GExp.gexp): String = x0 match {
    ...
    case GExp.In(v, l) =>
      vname2dot(v) + "&isin;{" +
        (Lista.map[Value.value, String](((a: Value.value) => value2dot(a)),
          l)).mkString(", ") +
          "}"
    ...
    "digraph EFSM{" + "\u000A" + "  graph [rankdir=" + "\"" + "LR" + "\"" +
      ...
      (Lista.map[Nat.nat, String](((s: Nat.nat) =>
        "  s" + Code_Numeral.integer_of_nat(s).toString() +
          ...
          "</sub>>];"),
        FSet.sorted_list_of_fset[Nat.nat](FSet_Utils.fremove[Nat.nat](Nat.zero_nat,
          EFSM.S(e))))).mkString("\u000A") +
        "\u000A" +
        "\u000A" +
...
object efsm2sal {
  ...
  def escape(s: String, replacements: List[(String, String)]): String =
    Lista.fold[(String, String), String](((a: (String, String)) =>
      {
  ...
  def gexp2sal(x0: GExp.gexp): String = x0 match {
    ...
    case GExp.In(v, l) =>
      (Lista.map[Value.value, String](((la: Value.value) =>
  ...
  def guards2sal(x0: List[GExp.gexp]): String = x0 match {
    case Nil => "TRUE"
    case v :: va =>
      (Lista.map[GExp.gexp, String](((a: GExp.gexp) => gexp2sal(a)),
        v :: va)).mkString(" AND ")
  }
  ...
  def guards2sal_num(x0: List[GExp.gexp], uu: Nat.nat): String = (x0, uu) match {
    case (Nil, uu) => "TRUE"
    case (v :: va, m) =>
      (Lista.map[GExp.gexp, String](((g: GExp.gexp) => gexp2sal_num(g, m)),
        v :: va)).mkString(" AND ")
  }
...
object Same_Register {
  ...
  def u_replace_with(x0: (Nat.nat, AExp.aexp), r1: Nat.nat, r2: Nat.nat): (Nat.nat, AExp.aexp) =
    (x0, r1, r2) match {
      case ((r, a), r1, r2) =>
  ...
  def t_replace_with(t: Transition.transition_ext[Unit], r1: Nat.nat,
    r2: Nat.nat): Transition.transition_ext[Unit] =
    Transition.transition_exta[Unit](Transition.Label[Unit](t),
      Transition.Arity[Unit](t),
      Lista.map[GExp.gexp, GExp.gexp](((g: GExp.gexp) => g_replace_with(g, r1, r2)),
        Transition.Guard[Unit](t)),
      Lista.map[AExp.aexp, AExp.aexp](((p: AExp.aexp) => a_replace_with(p, r1, r2)),
        Transition.Outputs[Unit](t)),
      Lista.map[(Nat.nat, AExp.aexp), (Nat.nat, AExp.aexp)](((u: (Nat.nat, AExp.aexp)) => u_replace_with(u, r1, r2)),
        Transition.Updates[Unit](t)),
      ())
  ...
  def replace_with(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (u, (tf, t)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (if (Transition.same_structure(t1, t2))
        ...
        case (Some(VName.R(r1)), Some(VName.R(r2))) =>
          Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](replace_with(newa,
            r1, r2))
      })
      else None)
    }
...
object Increment_Reset {
  ...
  def struct_replace_all(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    newa: Transition.transition_ext[Unit]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      val to_replace: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (_, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
          val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
          ({
        ...
        e)
      val replacements: FSet.fset[(List[Nat.nat], Transition.transition_ext[Unit])] = FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (uid, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
          val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
          ({
      ...
      (if ((guardMatch[Unit, Unit](t1, t2)) && (outputMatch[Unit, Unit](t1, t2))) {
        ...
        val newT1: Transition.transition_ext[Unit] =
          Transition.transition_exta[Unit](Transition.Label[Unit](t1),
            Transition.Arity[Unit](t1), Nil,
            List(AExp.Plus(AExp.V(newReg), AExp.V(VName.I(Nat.zero_nat)))),
            (r, AExp.Plus(AExp.V(newReg), AExp.V(VName.I(Nat.zero_nat)))) ::
              Transition.Updates[Unit](t1),
            ())
        val newT2: Transition.transition_ext[Unit] =
          Transition.transition_exta[Unit](Transition.Label[Unit](t2),
            ...
            ())
        val to_initialise: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
            val (_, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
            val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
            ({
          ...
          newa)
        val initialisedTrans: FSet.fset[(List[Nat.nat], Transition.transition_ext[Unit])] = FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
            val (uid, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
            val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
            ({
          ...
          to_initialise)
        val initialised: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.replace_transitions(newa,
          FSet.sorted_list_of_fset[(List[Nat.nat], Transition.transition_ext[Unit])](initialisedTrans))
        val newEFSM: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = struct_replace_all(struct_replace_all(initialised, t2, newT2), t1,
          newT1);
        Inference.resolve_nondeterminism(Nil,
          FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](np(newEFSM)),
          old, newEFSM,
...
object Use_Small_Numbers {
  ...
  def map_of[A: HOL.equal, B](l: List[(A, B)]): A => Option[B] =
    Lista.foldr[(A, B), A => Option[B]](((a: (A, B)) =>
      {
        val (aa, b): (A, B) = a;
        ((m: A => Option[B]) =>
          Fun.fun_upd[A, Option[B]](m, aa, Some[B](b)))
      }),
      l, ((_: A) => None))
  ...
  def make_small(f: Int.int => Option[Int.int], l: List[Value.value]): List[Value.value] =
    Lista.map[Value.value, Value.value](((x: Value.value) =>
      (x match {
        case Value.Numa(n) =>
          {
  ...
  def trace_enumerate_ints(t: List[(String, (List[Value.value], List[Value.value]))]): List[Int.int] =
    Lista.map[Value.value, Int.int](((a: Value.value) =>
      {
        val (Value.Numa(n)): Value.value = a;
        n
      }),
      Lista.fold[(String, (List[Value.value], List[Value.value])), List[Value.value]](Fun.comp[List[Value.value], (List[Value.value]) => List[Value.value], (String, (List[Value.value], List[Value.value]))](Lista.union[Value.value],
        ((a: (String, (List[Value.value], List[Value.value]))) =>
          {
            val (_, (inputs, outputs)): (String, (List[Value.value], List[Value.value])) = a;
            Lista.filter[Value.value](((aa: Value.value) => is_Num(aa)),
              inputs ++ outputs)
          })),
        t, Nil))

  def log_enumerate_ints(l: List[List[(String, (List[Value.value], List[Value.value]))]]): List[Int.int] =
    Lista.fold[List[(String, (List[Value.value], List[Value.value]))], List[Int.int]](Fun.comp[List[Int.int], (List[Int.int]) => List[Int.int], List[(String, (List[Value.value], List[Value.value]))]](Lista.union[Int.int],
      ((a: List[(String, (List[Value.value], List[Value.value]))]) =>
        trace_enumerate_ints(a))),
      l, Nil)

  def use_smallest_ints(l: List[List[(String, (List[Value.value], List[Value.value]))]]): List[List[(String, (List[Value.value], List[Value.value]))]] =
    {
      val ints: List[Int.int] = log_enumerate_ints(l)
      val f: Int.int => Option[Int.int] =
        map_of[Int.int, Int.int](enumerate[Int.int](ints));
      Lista.map[List[(String, (List[Value.value], List[Value.value]))], List[(String, (List[Value.value], List[Value.value]))]](((a: List[(String, (List[Value.value], List[Value.value]))]) =>
        Lista.map[(String, (List[Value.value], List[Value.value])), (String, (List[Value.value], List[Value.value]))](((aa: (String, (List[Value.value], List[Value.value]))) =>
          {
            val (la, (inputs, outputs)): (String, (List[Value.value], List[Value.value])) = aa;
...
object Symbolic_Regression {
  ...
  def target(uu: Map[Nat.nat, Option[Value.value]],
    x1: List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]): List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))] =
    (uu, x1) match {
      case (uu, Nil) => Nil
  ...
  def flatten(x0: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    l: List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))]): List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))] =
    (x0, l) match {
      case (Nil, l) => l
      case ((k, e) :: t, l) =>
        flatten(t, l ++ Lista.map[(Nat.nat, (String, (List[Value.value], List[Value.value]))), (Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))](((a: (Nat.nat, (String, (List[Value.value], List[Value.value])))) =>
          (k, a)),
          e))
    }

  def drop_guard(t: Transition.transition_ext[Unit]): Transition.transition_ext[Unit] =
    Transition.transition_exta[Unit](Transition.Label[Unit](t),
      Transition.Arity[Unit](t), Nil,
      Transition.Outputs[Unit](t),
      Transition.Updates[Unit](t), ())

  def finfun_add[A: HOL.equal: Orderings.linorder, B: HOL.equal](a: Map[A, B], b: Map[A, B]): Map[A, B] =
    Lista.fold[A, Map[A, B]](((k: A) => (f: Map[A, B]) => f + (k -> (b(k)))),
      b.keySet.toList, a)

  def get_inputs(l: List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))]): List[List[Value.value]] =
    Lista.map[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value])))), List[Value.value]](((a: (Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))) =>
      {
        val (_, (_, (_, (i, _)))): (Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value])))) = a;
        i
      }),
      l)
  ...
  def is_updated[A](r: Nat.nat, t: Transition.transition_ext[A]): Boolean =
    Nat.less_eq_nat(Nat.Nata((1)),
      Nat.Nata((Lista.filter[(Nat.nat, AExp.aexp)](((a: (Nat.nat, AExp.aexp)) =>
        {
          val (ra, _): (Nat.nat, AExp.aexp) = a;
          Nat.equal_nata(ra, r)
        }),
  ...
  def get_outputs(l: List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))],
    n: Nat.nat): List[Value.value] =
    Lista.map[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value])))), Value.value](((a: (Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))) =>
      {
        val (_, (_, (_, (_, p)))): (Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value])))) = a;
        p(Code_Numeral.integer_of_nat(n).toInt)
      }),
      l)

  def get_updates(values: List[Value.value],
    train: List[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))]): List[(Nat.nat, AExp.aexp)] =
    {
      ...
      val maybe_updates: List[(Nat.nat, Option[AExp.aexp])] =
        Lista.map[Nat.nat, (Nat.nat, Option[AExp.aexp])](((r: Nat.nat) =>
          (r, Dirties.getUpdate(r, values, train))),
          updated_regs)
      val a: List[(Nat.nat, Option[AExp.aexp])] =
        Lista.filter[(Nat.nat, Option[AExp.aexp])](((a: (Nat.nat, Option[AExp.aexp])) =>
          {
            val (_, u): (Nat.nat, Option[AExp.aexp]) = a;
            !(Optiona.is_none[AExp.aexp](u))
          }),
          maybe_updates);
      Lista.map[(Nat.nat, Option[AExp.aexp]), (Nat.nat, AExp.aexp)](((aa: (Nat.nat, Option[AExp.aexp])) =>
        {
  ...
  def get_updates_opt(values: List[Value.value],
    train: List[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))]): List[(Nat.nat, Option[AExp.aexp])] =
    {
      val a: List[Nat.nat] =
        Lista.fold[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]])), List[Nat.nat]](Fun.comp[List[Nat.nat], (List[Nat.nat]) => List[Nat.nat], (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))](Lista.union[Nat.nat],
          Fun.comp[(Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]), List[Nat.nat], (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))](Fun.comp[Map[Nat.nat, Option[Value.value]], List[Nat.nat], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]])](((a: Map[Nat.nat, Option[Value.value]]) =>
      ...
      Lista.map[Nat.nat, (Nat.nat, Option[AExp.aexp])](((r: Nat.nat) =>
        {
          val targetValues: List[Option[Value.value]] =
            (Lista.map[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]])), Option[Value.value]](((aa: (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))) =>
              {
                val (_, (_, regs)): (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]])) = aa;
                regs(r)
              }),
              train)).distinct;
          (if (Lista.list_all[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))](((aa: (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))) =>
            {
              val (_, (anteriorRegs, posteriorRegs)): (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]])) = aa;
            ...
            Nat.Nata((1)))) && (Lista.list_all[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))](((aa: (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))) =>
              {
                val (_, (initialRegs, _)): (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]])) = aa;
  ...
  def group_update(values: List[Value.value],
    l: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]): Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])] =
    {
      val targeted: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))] = Lista.filter[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))) =>
        {
          val (regs, _): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) = a;
      ...
      val maybe_updates: List[(Nat.nat, Option[AExp.aexp])] =
        get_updates_opt(values,
          Lista.map[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))), (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))) =>
            {
              val (tRegs, (_, (oldRegs, (regs, (inputs, (_, _)))))): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) = a;
              (inputs,
                (finfun_add[Nat.nat, Option[Value.value]](oldRegs, regs), tRegs))
            }),
            targeted));
      (if (Lista.list_ex[(Nat.nat, Option[AExp.aexp])](((a: (Nat.nat, Option[AExp.aexp])) =>
        {
        ...
        maybe_updates))
        None
      else Some[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])]((Lista.fold[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))), List[Nat.nat]](Fun.comp[List[Nat.nat], (List[Nat.nat]) => List[Nat.nat], (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))](Lista.union[Nat.nat],
        ((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))) =>
          {
            val (_, (_, (_, (_, (_, (tid, _)))))): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) = a;
            tid
          })),
        l, Nil),
        Lista.map[(Nat.nat, Option[AExp.aexp]), (Nat.nat, AExp.aexp)](((a: (Nat.nat, Option[AExp.aexp])) =>
          {
  ...
  def get_functions(maxReg: Nat.nat, values: List[Value.value], n: Nat.nat,
    l: List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))]): List[Option[(AExp.aexp, Map[VName.vname, String])]] =
    Lista.map[Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])]](((p: Nat.nat) =>
      Dirties.getFunction(maxReg, values, get_inputs(l),
        get_outputs(l, p))),
      Lista.upt(Nat.zero_nat, n))

  def insert_outputs(t: Transition.transition_ext[Unit], op: Option[AExp.aexp],
    ox: Nat.nat): Transition.transition_ext[Unit] =
    (op match {
      case None => t
      case Some(a) =>
        Transition.transition_exta[Unit](Transition.Label[Unit](t),
  ...
  def everything_walk(uu: AExp.aexp, uv: Nat.nat, uw: Map[VName.vname, String],
    ...
    va: String, vb: Nat.nat, vc: Nat.nat): List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))] =
    (uu, uv, uw, x3, ux, uy, uz, va, vb, vc) match {
      ...
      case (f, fi, types, (label, (inputs, outputs)) :: t, oPTA, s, regs, ll,
        i_arity, o_arity) => {
        val (tid, (sa, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(oPTA,
          s, regs, label, inputs));
        (if ((ll ==
  ...
  def transfer_updates(x0: List[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    target: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, target) match {
  ...
  def groupwise_updates(values: List[Value.value],
    x1: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]]): List[Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])]] =
    (values, x1) match {
      case (values, Nil) => Nil
      case (values, g :: gs) =>
        (if (Lista.list_all[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))) =>
          {
            val (regs, _): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) = a;
            (regs.keySet.toList).isEmpty
          }),
  ...
  def get_exec_reg_values(uu: AExp.aexp,
    x1: List[(Nat.nat, (String, (List[Value.value], List[Value.value])))],
    uv: String, uw: Nat.nat,
    ux: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uy: Nat.nat, uz: Map[Nat.nat, Option[Value.value]]): List[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))] =
    (uu, x1, uv, uw, ux, uy, uz) match {
      case (uu, Nil, uv, uw, ux, uy, uz) => Nil
      case (f, (va, (l, (i, p))) :: t, label, i_arity, e, s, r) =>
        {
          val poss_steps: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
            {
              val (_, (_, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = a;
              Lista.equal_lista[Option[Value.value]](EFSM.apply_outputs(Transition.Outputs[Unit](ta),
                AExp.join_ir(i, r)),
                Lista.map[Value.value, Option[Value.value]](((aa: Value.value) =>
                  Some[Value.value](aa)),
          ...
          val (_, (sa, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](poss_steps)
          ...
          (if ((l == label) && (Nat.equal_nata(Nat.Nata(i.length), i_arity)))
            ...
            Lista.insert[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))]((i,
            (r, updated)),
  ...
  def get_log_reg_values(uu: AExp.aexp,
    x1: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    uv: String, uw: Nat.nat,
    ux: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): List[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))] =
    (uu, x1, uv, uw, ux) match {
      case (uu, Nil, uv, uw, ux) => Nil
      case (a, h :: t, l, ia, pta) =>
        Lista.union[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))].apply(get_exec_reg_values(a,
          h._2, l, ia, pta, Nat.zero_nat,
  ...
  def put_update_function_aux(uu: Option[AExp.aexp], uv: Nat.nat,
    ...
    x3: List[(Nat.nat, (String, (List[Value.value], List[Value.value])))],
    ux: String, uy: Nat.nat,
    uz: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    va: Nat.nat,
    vb: Map[Nat.nat, Option[Value.value]]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, ux, uy, uz, e, va, vb) match {
      ...
      case (op, ox, us, (vc, (l, (i, p))) :: t, label, i_arity, pta, target, s, r) => {
        val poss_steps: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
          {
            ...
            Lista.equal_lista[Option[Value.value]](EFSM.apply_outputs(Transition.Outputs[Unit](ta),
              AExp.join_ir(i, r)),
              Lista.map[Value.value, Option[Value.value]](((aa: Value.value) => Some[Value.value](aa)), p))
          }),
          Inference.i_possible_steps(pta, s, r, l, i))
        val (tid, (sa, _)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](poss_steps)
        ...
        (if ((l == label) && (Nat.equal_nata(Nat.Nata(i.length), i_arity))) {
          ...
          val newE: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_distinct(Inference.replace_transitions(target,
            List((tid, newT))));
  ...
  def put_update_functions(uu: Option[AExp.aexp], uv: Nat.nat,
    uw: List[(Nat.nat, AExp.aexp)],
    x3: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    ux: String, uy: Nat.nat,
    pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    target: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, ux, uy, pta, target) match {
      case (uu, uv, uw, Nil, ux, uy, pta, target) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](target)
      case (op, ox, us, h :: t, label, arity, pta, target) =>
        (put_update_function_aux(op, ox, us, h._2, label, arity, pta, target,
          Nat.zero_nat, Map().withDefaultValue(None)) match {
            case None => None
            case Some(e) =>
  ...
  def outputwise_updates(uu: List[Value.value], uv: Nat.nat,
    ...
    pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uw: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    ux: String, uy: Nat.nat): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, x2, pta, e, uw, ux, uy) match {
      case (uu, uv, Nil, pta, e, uw, ux, uy) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (values, ox, None :: t, pta, e, log, label, arity) =>
        outputwise_updates(values, Nat.plus_nat(ox, Nat.Nata((1))), t, pta, e, log,
          label, arity)
      case (values, ox, Some((a, types)) :: t, pta, e, log, label, arity) =>
        {
          val train: List[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))] = get_log_reg_values(a, log, label, arity, pta)
          ...
          (put_update_functions(Some[AExp.aexp](a), ox, update_functions, log,
            label, arity, pta, e) match {
              case None => None
              case Some(ea) =>
                outputwise_updates(values, Nat.plus_nat(ox, Nat.Nata((1))), t, pta,
                  ea, log, label, arity)
            })
        }
    }
  ...
  def everything_walk_log(f: AExp.aexp, fi: Nat.nat,
    ...
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: String, ia: Nat.nat, oa: Nat.nat): List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] =
    Lista.map[List[(String, (List[Value.value], List[Value.value]))], List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]](((t: List[(String, (List[Value.value], List[Value.value]))]) =>
      everything_walk(f, fi, types, t, e, Nat.zero_nat,
  ...
  def put_output_function_aux(uu: Nat.nat, uv: AExp.aexp,
    ...
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    vb: Nat.nat,
    vc: Map[Nat.nat, Option[Value.value]]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, ux, uy, uz, va, e, vb, vc) match {
      case (uu, uv, uw, Nil, ux, uy, uz, va, e, vb, vc) =>
        (if (FSet.fBex[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e,
          ((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
            {
              val (_, (_, t)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
              overwrites_update(Transition.Updates[Unit](t),
                Set.bot_set[Nat.nat])
            })))
          None
        else Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e))
      case (fi, f, types, (vd, (l, (i, p))) :: t, label, i_arity, o_arity, prevtid,
        ...
        val poss_steps: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
          ...
          Inference.i_possible_steps(e, s, r, l, i));
        (Dirties.randomMember[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](poss_steps) match {
          case None => None
          case Some((tid, (sa, ta))) =>
            (if ((l == label) && ((Nat.equal_nata(Nat.Nata(i.length),
              ...
              val updates: List[(Nat.nat, AExp.aexp)] =
                Lista.map[Nat.nat, (Nat.nat, AExp.aexp)](((ra: Nat.nat) =>
                  {
                ...
                case Some(prevtida) =>
                  {
                    ...
                    val newE: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.replace_transitions(e,
                      List((tid, newT), (prevtida, newPrevT)));
                    (if (FSet.fBex[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](newE,
                      ((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
                        {
                          val (_, (_, tb)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
  ...
  def put_output_function(uu: Nat.nat, uv: AExp.aexp,
    ...
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, ux, e) match {
      ...
      case (fi, f, types, h :: t, t1, e) =>
        (put_output_function_aux(fi, f, types, h._2, Transition.Label[Unit](t1),
          ...
          None, e, Nat.zero_nat,
          Map().withDefaultValue(None)) match {
            case None => None
            case Some(a) => put_output_function(fi, f, types, t, t1, a)
          })
    }

  def put_output_functions(x0: List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])],
    uu: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    ...
    (uu, uv, uw, x3, ux, uy, uz, va, e, vb, vc) match {
      ...
      case (fi, f, types, (vd, (l, (i, p))) :: t, label, i_arity, o_arity, prevtid,
        ...
        val poss_steps: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
          ...
          Inference.i_possible_steps(e, s, r, l, i))
        val (tid, (sa, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](poss_steps);
        (if ((l == label) && ((Nat.equal_nata(Nat.Nata(i.length),
          i_arity)) && (Nat.equal_nata(Nat.Nata(p.length), o_arity))))
          (prevtid match {
          case None => None
  ...
  def infer_output_functions(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    {
      val t1: Transition.transition_ext[Unit] = Inference.get_by_ids(newa, t1ID)
      val i_log: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])] = Lista.enumerate[List[(Nat.nat, (String, (List[Value.value], List[Value.value])))]](Nat.zero_nat,
        Lista.map[List[(String, (List[Value.value], List[Value.value]))], List[(Nat.nat, (String, (List[Value.value], List[Value.value])))]](((a: List[(String, (List[Value.value], List[Value.value]))]) =>
          Lista.enumerate[(String, (List[Value.value], List[Value.value]))](Nat.zero_nat, a)),
          log))
      ...
      val output_functions: List[Option[(AExp.aexp, Map[VName.vname, String])]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events);
      put_output_functions(Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nat, output_functions),
        i_log, t1, newa)
    }

  def put_output_functions_2(x0: List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])],
    uu: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    uv: Transition.transition_ext[Unit],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (x0, uu, uv, e) match {
  ...
  def infer_output_functions_2(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    s: Nat.nat,
    newa: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[(AExp.aexp, Map[VName.vname, String])]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events);
      put_output_functions_2(Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nat, output_functions),
        i_log, t1, newa)
    }

  def infer_output_update_functions(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    s: Nat.nat,
    newa: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[(AExp.aexp, Map[VName.vname, String])]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events)
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log);
      (put_output_functions(Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nat, output_functions),
        i_log, t1, pta) match {
          case None => None
          case Some(e) =>
            outputwise_updates(values, Nat.zero_nat, output_functions, e,
              transfer_updates(FSet.sorted_list_of_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e),
                newa),
...
object PTA_Generalisation {
  ...
  def get_updates(u: List[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])],
    t: List[Nat.nat]): List[(Nat.nat, AExp.aexp)] =
    Lista.maps[(List[Nat.nat], List[(Nat.nat, AExp.aexp)]), (Nat.nat, AExp.aexp)](((a: (List[Nat.nat], List[(Nat.nat, AExp.aexp)])) =>
      a._2),
      Lista.filter[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])](((a: (List[Nat.nat], List[(Nat.nat, AExp.aexp)])) =>
        {
          val (tids, _): (List[Nat.nat], List[(Nat.nat, AExp.aexp)]) = a;
  ...
  def add_groupwise_updates_trace(x0: List[(String, (List[Value.value], List[Value.value]))],
    uu: List[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uv: Nat.nat,
    ...
    (x0, uu, e, uv, uw) match {
      ...
      case ((l, (i, ux)) :: trace, funs, e, s, r) =>
        {
          val (id, (sa, t)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(e,
            s, r, l, i))
          val updated: Map[Nat.nat, Option[Value.value]] =
          ...
          val ea: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = replace_transition(e, id, tb);
          add_groupwise_updates_trace(trace, funs, ea, sa, updateda)
        }
    }

  def add_groupwise_updates(x0: List[List[(String, (List[Value.value], List[Value.value]))]],
    uu: List[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, uu, e) match {
      case (Nil, uu, e) => e
      case (h :: t, funs, e) =>
        add_groupwise_updates(t, funs,
          add_groupwise_updates_trace(h, funs, e, Nat.zero_nat,
            Map().withDefaultValue(None)))
    }

  def groupwise_put_updates(x0: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]],
    uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    uv: List[Value.value], uw: String, ux: Nat.nat,
    uy: Nat.nat,
    uz: (Nat.nat, (AExp.aexp, Map[VName.vname, String])),
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, uu, uv, uw, ux, uy, uz, e) match {
      case (Nil, uu, uv, uw, ux, uy, uz, e) => e
      case (gp :: gps, log, values, label, ia, oa, (o_inx, (op, types)), e) =>
        {
          val walked: List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] = Symbolic_Regression.everything_walk_log(op, o_inx, types, log, e,
            label, ia, oa)
          val targeted: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]] = Lista.map[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))], List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]](((a: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]) =>
            Lista.filter[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))](((aa: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))) =>
              {
                val (_, (_, (_, (_, (_, (id, tran)))))): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) = aa;
                gp contains (id, tran)
              }),
              a)),
            Lista.map[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))], List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]](((w: List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]) =>
              (Symbolic_Regression.target(Map().withDefaultValue(None),
                w.reverse)).reverse),
              walked))
          val group: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))] = Lista.fold[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))], List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))]](Lista.union[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))))],
            targeted, Nil)
          val group_updates: List[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])] =
            Lista.maps[Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])], (List[Nat.nat], List[(Nat.nat, AExp.aexp)])](((a: Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])]) =>
              (a match {
                case None => Nil
                case Some(thing) => List(thing)
              })),
              Symbolic_Regression.groupwise_updates(values, List(group)))
          val a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_distinct(add_groupwise_updates(log, group_updates, e));
          groupwise_put_updates(gps, log, values, label, ia, oa,
            (o_inx, (op, types)), a)
        }
    }
  ...
  def insert_into_group[A](x0: List[List[(List[Nat.nat], Transition.transition_ext[A])]],
    pair: (List[Nat.nat], Transition.transition_ext[A])): List[List[(List[Nat.nat], Transition.transition_ext[A])]] =
    (x0, pair) match {
      case (Nil, pair) => List(List(pair))
      case (h :: t, pair) =>
        (if (Lista.list_all[(List[Nat.nat], Transition.transition_ext[A])](((a: (List[Nat.nat], Transition.transition_ext[A])) =>
          {
            val (_, aa): (List[Nat.nat], Transition.transition_ext[A]) = a;
  ...
  def transition_groups(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] =
    Lista.fold[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), List[List[(List[Nat.nat], Transition.transition_ext[Unit])]]](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (tid, (_, transition)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
        ((acc: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]]) =>
          insert_into_group[Unit](acc, (tid, transition)))
      }),
      FSet.sorted_list_of_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e),
      Nil)

  def put_updates(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    uv: List[Value.value], uw: String, ux: Nat.nat, uy: Nat.nat,
    x5: List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, ux, uy, x5, e) match {
      case (uu, uv, uw, ux, uy, Nil, e) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (uz, va, vb, vc, vd, (ve, None) :: vf, vg) => None
      case (log, values, label, ia, oa, (o_inx, Some((op, types))) :: ops, e) =>
        {
          val groups: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] =
            transition_groups(e)
          val a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = groupwise_put_updates(groups, log, values, label, ia, oa,
            (o_inx, (op, types)), e);
          put_updates(log, values, label, ia, oa, ops, a)
        }
    }

  def put_outputs(x0: List[(Option[(AExp.aexp, Map[VName.vname, String])], AExp.aexp)]): List[AExp.aexp] =
    x0 match {
      case Nil => Nil
  ...
  def get_outputs(maxReg: Nat.nat, values: List[Value.value],
    ...
    outputs: List[List[Value.value]]): List[Option[(AExp.aexp, Map[VName.vname, String])]] =
    Lista.map[List[Value.value], Option[(AExp.aexp, Map[VName.vname, String])]](((a: List[Value.value]) =>
    ...
    gp: (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val i: List[List[Value.value]] =
        Lista.map[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])), List[Value.value]](((a: (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))) =>
          {
            val (_, (ins, _)): (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])) = a;
            ins
          }),
          gp._2)
      val r: List[Map[Nat.nat, Option[Value.value]]] =
        Lista.map[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])), Map[Nat.nat, Option[Value.value]]](((a: (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))) =>
          {
            val (regs, (_, _)): (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])) = a;
            regs
          }),
          gp._2)
      val p: List[List[Value.value]] =
        Lista.map[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])), List[Value.value]](((a: (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))) =>
          {
            val (_, (_, outs)): (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])) = a;
            outs
          }),
          gp._2)
      ...
      val changes: List[(List[Nat.nat], Transition.transition_ext[Unit])] =
        Lista.map[(List[Nat.nat], Transition.transition_ext[Unit]), (List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          {
            val (id, tran): (List[Nat.nat], Transition.transition_ext[Unit]) = a;
            (id, Transition.Outputs_update[Unit](((_: List[AExp.aexp]) =>
              put_outputs((outputs zip (Transition.Outputs[Unit](tran))))),
              tran))
          }),
          gp._1)
      val generalised_model: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Lista.fold[(List[Nat.nat], Transition.transition_ext[Unit]), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
        {
          val (id, t): (List[Nat.nat], Transition.transition_ext[Unit]) = a;
          ((acc: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
      ...
      (put_updates(log, values, Transition.Label[Unit](tran),
        ...
        Nat.Nata((Transition.Outputs[Unit](tran)).length),
  ...
  def groupwise_generalise_and_update(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x2: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (uu, e, x2) match {
      case (uu, e, Nil) => e
      case (log, e, gp :: t) =>
  ...
  def standardise_group(g: List[(List[Nat.nat], Transition.transition_ext[Unit])]): List[(List[Nat.nat], Transition.transition_ext[Unit])] =
    {
      val updates: List[(Nat.nat, AExp.aexp)] =
        (Lista.maps[(List[Nat.nat], Transition.transition_ext[Unit]), (Nat.nat, AExp.aexp)](Fun.comp[Transition.transition_ext[Unit], List[(Nat.nat, AExp.aexp)], (List[Nat.nat], Transition.transition_ext[Unit])](((a: Transition.transition_ext[Unit]) =>
      ...
      Lista.map[(List[Nat.nat], Transition.transition_ext[Unit]), (List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
        {
          val (id, t): (List[Nat.nat], Transition.transition_ext[Unit]) =
            a;
          (id, Transition.Updates_update[Unit](((_: List[(Nat.nat, AExp.aexp)]) =>
            updates),
            t))
        }),
        g)
  ...
  def standardise_groups(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      val groups: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] =
        transition_groups(e)
      val standardised_groups: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] = Lista.map[List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(List[Nat.nat], Transition.transition_ext[Unit])]](((a: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
        standardise_group(a)),
        groups);
      Inference.replace_transitions(e, Lista.fold[List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(List[Nat.nat], Transition.transition_ext[Unit])]](((a: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
        (b: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
          a ++ b),
        standardised_groups, Nil))
    }

  def assign_training_set(data: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])],
    tids: List[Nat.nat], label: String,
    inputs: List[Value.value],
    registers: Map[Nat.nat, Option[Value.value]],
    outputs: List[Value.value]): List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] =
    Lista.map[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))]), (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])](((gp: (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])) =>
      {
        val (transitions, trainingSet): (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))]) = gp;
        (if (Lista.list_ex[(List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          {
            val (tidsa, _): (List[Nat.nat], Transition.transition_ext[Unit]) = a;
  ...
  def trace_training_set(uu: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x1: List[(String, (List[Value.value], List[Value.value]))],
    uv: Nat.nat, uw: Map[Nat.nat, Option[Value.value]],
    ts: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])]): List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] =
    (uu, x1, uv, uw, ts) match {
      case (uu, Nil, uv, uw, ts) => ts
      case (e, (label, (inputs, outputs)) :: t, s, r, ts) =>
        {
          val (id, (sa, transition)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(e,
            s, r, label, inputs));
  ...
  def log_training_set(uu: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x1: List[List[(String, (List[Value.value], List[Value.value]))]],
    ts: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])]): List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] =
    (uu, x1, ts) match {
      case (uu, Nil, ts) => ts
      case (e, h :: t, ts) =>
        log_training_set(e, t,
          trace_training_set(e, h, Nat.zero_nat,
  ...
  def make_training_set(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: List[List[(String, (List[Value.value], List[Value.value]))]]): List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] =
    log_training_set(e, l,
      Lista.map[List[(List[Nat.nat], Transition.transition_ext[Unit])], (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])](((x: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
        (x, Nil)),
        transition_groups(e)))

  def incremental_normalised_pta(log: List[List[(String, (List[Value.value], List[Value.value]))]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      Inference.enumerate_log_values(log)
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log)
      val training_set: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] = make_training_set(pta, log);
      standardise_groups(groupwise_generalise_and_update(log, pta, training_set))
    }

  def derestrict_transition(t: Transition.transition_ext[Unit]): Transition.transition_ext[Unit] =
    {
      val relevant_vars: Set.set[AExp.aexp] =
        Set.image[VName.vname, AExp.aexp](((a: VName.vname) => AExp.V(a)),
          Lista.fold[(Nat.nat, AExp.aexp), Set.set[VName.vname]](((a: (Nat.nat, AExp.aexp)) =>
  ...
  def derestrict(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    m: (List[Nat.nat]) => (List[Nat.nat]) => Nat.nat => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) => Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log)
      val normalised: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = incremental_normalised_pta(log)
      val derestricted: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (id, (tf, tran)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
      ...
      (Inference.resolve_nondeterminism(Nil, nondeterministic_pairs, pta,
        ...
        ((a: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) =>
          Inference.satisfies(Set.seta[List[(String, (List[Value.value], List[Value.value]))]](log),
            a)),
        np) match {
          case None => pta
  ...
  def update_groups(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    uv: List[Value.value],
    x2: List[(Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (uu, uv, x2, e) match {
      case (uu, uv, Nil, e) => e
      case (log, values, (tran, types) :: lst, e) =>
        (put_updates(log, values, Transition.Label[Unit](tran),
          Transition.Arity[Unit](tran),
          Nat.Nata((Transition.Outputs[Unit](tran)).length), types, e) match {
  ...
  def generalise_outputs(values: List[Value.value],
    groups: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])]): List[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]] =
    Lista.map[(Nat.nat, (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])), List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]](((a: (Nat.nat, (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))]))) =>
      {
        val (maxReg, group): (Nat.nat, (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])) = a
        val i: List[List[Value.value]] =
          Lista.map[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])), List[Value.value]](((aa: (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))) =>
            {
              val (_, (ins, _)): (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])) = aa;
              ins
            }),
            group._2)
        val r: List[Map[Nat.nat, Option[Value.value]]] = Lista.map[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])), Map[Nat.nat, Option[Value.value]]](((aa: (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))) =>
          {
            val (regs, (_, _)): (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])) = aa;
            regs
          }),
          group._2)
        val p: List[List[Value.value]] =
          Lista.map[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])), List[Value.value]](((aa: (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))) =>
            {
              val (_, (_, outs)): (Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value])) = aa;
              outs
            }),
            group._2)
        val outputs: List[Option[(AExp.aexp, Map[VName.vname, String])]] = get_outputs(maxReg, values, i, r, p);
        Lista.map[(List[Nat.nat], Transition.transition_ext[Unit]), (List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))](((aa: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          {
            val (id, tran): (List[Nat.nat], Transition.transition_ext[Unit]) = aa;
      ...
      Lista.enumerate[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])](Nat.zero_nat, groups))

  def replace_groups(x0: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, e) match {
      case (Nil, e) => e
      case (h :: t, e) =>
        replace_groups(t, Lista.fold[(List[Nat.nat], Transition.transition_ext[Unit]), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          {
  ...
  def pta_generalise_outputs(log: List[List[(String, (List[Value.value], List[Value.value]))]]): (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))], List[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]]) =
    {
      val values: List[Value.value] = Inference.enumerate_log_values(log)
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log)
      val training_set: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] = make_training_set(pta, log)
      val generalised_outs: List[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]] = generalise_outputs(values, training_set);
      (replace_groups(Lista.map[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))], List[(List[Nat.nat], Transition.transition_ext[Unit])]](((a: List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]) =>
        Lista.map[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])), (List[Nat.nat], Transition.transition_ext[Unit])](((aa: (List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))) =>
          {
            val (tids, (tran, _)): (List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])) = aa;
            (tids, tran)
          }),
          a)),
        generalised_outs),
  ...
  def normalised_pta(log: List[List[(String, (List[Value.value], List[Value.value]))]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      val values: List[Value.value] = Inference.enumerate_log_values(log)
      val (output_funs, types): (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))], List[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]]) = pta_generalise_outputs(log)
      val group_details: List[(Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])] = Lista.map[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])](Fun.comp[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])), (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]), List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]](((a: (List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))) =>
        a._2),
        ((a: List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]) =>
          a.head)),
        types);
...
object SelectionStrategies {
  ...
  def origin_states(t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    {
      ...
      (if ((Nat.equal_nata(t1Orig,
        ...
        Code_Numeral.nat_of_integer(BigInt(1000)) else Nat.zero_nat)
    }

  def naive_score_eq(t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
  ...
  def naive_score_outputs(t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    {
      val t1: Transition.transition_ext[Unit] = Inference.get_by_ids(e, t1ID)
      val t2: Transition.transition_ext[Unit] = Inference.get_by_ids(e, t2ID);
      Nat.plus_nat(Nat.plus_nat(bool2nat(Transition.Label[Unit](t1) ==
  ...
  def naive_score_eq_bonus(t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    {
      val t1: Transition.transition_ext[Unit] = Inference.get_by_ids(e, t1ID)
      val t2: Transition.transition_ext[Unit] = Inference.get_by_ids(e, t2ID);
      Nat.plus_nat(bool2nat((Transition.Label[Unit](t1) ==
        Transition.Label[Unit](t2)) && ((Nat.equal_nata(Transition.Arity[Unit](t1),
          Transition.Arity[Unit](t2))) && (Nat.equal_nata(Nat.Nata((Transition.Outputs[Unit](t1)).length),
            Nat.Nata((Transition.Outputs[Unit](t2)).length))))),
  ...
  def naive_score_comprehensive(t1ID: List[Nat.nat], t2ID: List[Nat.nat],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    {
      ...
      (if ((Transition.Label[Unit](t1) ==
        ...
        Nat.Nata((Transition.Outputs[Unit](t2)).length)))
        Nat.plus_nat(Finite_Set.card[GExp.gexp](Set.inf_set[GExp.gexp](Set.seta[GExp.gexp](Transition.Guard[Unit](t1)),
        Set.seta[GExp.gexp](Transition.Guard[Unit](t2)))),
        Nat.Nata((Lista.filter[(AExp.aexp, AExp.aexp)](((a: (AExp.aexp, AExp.aexp)) =>
          {
...
object Distinguishing_Guards {
  ...
  def add_guard(t: Transition.transition_ext[Unit], g: GExp.gexp): Transition.transition_ext[Unit] =
    Transition.transition_exta[Unit](Transition.Label[Unit](t),
      Transition.Arity[Unit](t),
  ...
  def trace_collect_training_sets(x0: List[(String, (List[Value.value], List[Value.value]))],
    ...
    (x0, uPTA, s, registers, t1, t2, g1, g2) match {
      ...
      case ((label, (inputs, outputs)) :: t, uPTA, s, registers, t1, t2, g1, g2) =>
        {
          val (uids, (sa, tran)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(uPTA,
  ...
  def collect_training_sets(x0: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    (x0, uPTA, t1, t2, g1, g2) match {
      ...
      case (h :: t, uPTA, t1, t2, g1, g2) =>
        {
          val (g1a, g2a): (List[(List[Value.value], Map[Nat.nat, Option[Value.value]])], List[(List[Value.value], Map[Nat.nat, Option[Value.value]])]) = trace_collect_training_sets(h, uPTA, Nat.zero_nat,
  ...
  def put_updates(uids: List[Nat.nat], updates: List[(Nat.nat, AExp.aexp)],
    ...
    FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, (fromTo, tran)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
  ...
  def transfer_updates(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    Lista.fold[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (tids, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
        ({
          val (_, _): (Nat.nat, Nat.nat) = ab;
          ((tran: Transition.transition_ext[Unit]) =>
            ((ac: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
              put_updates(tids,
  ...
  def distinguish(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val t2: Transition.transition_ext[Unit] =
        Inference.get_by_ids(destMerge, t2ID)
      val uPTA: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = transfer_updates(destMerge, Inference.make_pta(log))
      val (g1, g2): (List[(List[Value.value], Map[Nat.nat, Option[Value.value]])], List[(List[Value.value], Map[Nat.nat, Option[Value.value]])]) = collect_training_sets(log, uPTA, t1ID, t2ID, Nil, Nil);
      (Dirties.findDistinguishingGuard(g1, g2) match {
        case None => None
        case Some((g1a, g2a)) =>
          {
            val newEFSM: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.replace_transitions(preDestMerge,
