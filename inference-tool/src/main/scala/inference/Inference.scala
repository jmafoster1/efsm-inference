...
object Lista {
  ...
  def equal_list[A: HOL.equal](xs: List[A], ys: List[A]): Boolean =
...
object GExp {
  ...
  def equal_gexpa(x0: gexp, x1: gexp): Boolean = (x0, x1) match {
    ...
    case (In(x51, x52), In(y51, y52)) =>
      (VName.equal_vname(x51, y51)) && (Lista.equal_list[Value.value](x52, y52))
  ...
  def fold_In(uu: VName.vname, x1: List[Value.value]): gexp = (uu, x1) match {
    ...
    case (v, l :: va :: vb) =>
      Lista.fold[Value.value, gexp](Fun.comp[gexp, gexp => gexp, Value.value](((vc: gexp) => (vaa: gexp) =>
  ...
  def gexp_same_structure(x0: gexp, x1: gexp): Boolean = (x0, x1) match {
    ...
    case (In(va, la), In(v, l)) =>
      (VName.equal_vname(va, v)) && (Lista.equal_list[Value.value](la, l))
        ...
        label) && ((Nat.equal_nata(aritya,
          arity)) && ((Lista.equal_list[GExp.gexp](guarda,
            guard)) && ((Lista.equal_list[AExp.aexp](outputsa,
              outputs)) && ((Lista.equal_list[(Nat.nat, AExp.aexp)](updatesa,
  ...
  def same_structure(t1: transition_ext[Unit], t2: transition_ext[Unit]): Boolean =
    (Label[Unit](t1) ==
      Label[Unit](t2)) && ((Nat.equal_nata(Arity[Unit](t1),
        Arity[Unit](t2))) && (Lista.list_all[(GExp.gexp, GExp.gexp)](((a: (GExp.gexp, GExp.gexp)) =>
          {
...
object Transition_Ordering {
  ...
  def less_transition_ext[A: Orderings.linorder](t1: Transition.transition_ext[A],
    ...
    (if (Transition.Label[A](t1) == Transition.Label[A](t2))
      ...
      (if (Lista.equal_list[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1),
...
object Least_Upper_Bound {
  ...
  def gob_aux(t1: Transition.transition_ext[Unit],
    ...
    (if ((Lista.equal_list[AExp.aexp](Transition.Outputs[Unit](t1),
      Transition.Outputs[Unit](t2))) && ((Lista.equal_list[(Nat.nat, AExp.aexp)](Transition.Updates[Unit](t1),
  ...
  def gob(t1ID: Nat.nat, t2ID: Nat.nat, s: Nat.nat,
    newa: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (gob_aux(t1, t2) match {
        case None => None
        case Some(gob_t) =>
          Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](Inference.replace(Inference.drop_transitions(newa,
  ...
  def is_lob[A, B](t1: Transition.transition_ext[A],
    ...
    (Transition.Label[A](t1) ==
      Transition.Label[B](t2)) && ((Nat.equal_nata(Transition.Arity[A](t1),
        Transition.Arity[B](t2))) && ((Lista.equal_list[AExp.aexp](Transition.Outputs[A](t1),
          Transition.Outputs[B](t2))) && ((Lista.equal_list[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1),
    ...
    Lista.list_ex[(Nat.nat, List[Value.value])](((a: (Nat.nat, List[Value.value])) =>
      {
        ...
        (Lista.equal_list[GExp.gexp](Lista.filter[GExp.gexp](((g: GExp.gexp) =>
          GExp.gexp_constrains(g, AExp.V(VName.I(i)))),
          Transition.Guard[B](t2)),
...
object Ignore_Inputs {
  ...
  def enumerate_outputs(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: String, a: Nat.nat): FSet.fset[List[AExp.aexp]] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), List[AExp.aexp]](((aa: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (_, ab): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = aa
        val (_, ac): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = ab;
        Transition.Outputs[Unit](ac)
      }),
      FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((b: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (_, (_, t)): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = b;
  ...
  def drop_inputs(t1ID: Nat.nat, t2ID: Nat.nat, s: Nat.nat,
    newa: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      val t1: Transition.transition_ext[Unit] = Inference.get_by_id(newa, t1ID);
      ...
      (if (FSet_Utils.fis_singleton[List[AExp.aexp]](enumerate_outputs(newa,
        ...
        Transition.Arity[Unit](t1))))
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (id, (route, t)): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
          (if (Nat.equal_nata(id, t1ID))
            (id, (route, drop_guards(t)))
          else (id, (route, t)))
        }),
        FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
            val (id, _): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
  ...
  def statewise_drop_inputs(t1ID: Nat.nat, t2ID: Nat.nat, s: Nat.nat,
    ...
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      val t1: Transition.transition_ext[Unit] = Inference.get_by_id(newa, t1ID);
      Inference.get_by_id(newa, t2ID);
      (if (FSet.fBall[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](Inference.outgoing_transitions(s, newa),
        ((a: (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))) =>
          {
            ...
            (if ((Transition.Label[Unit](t) ==
              Transition.Label[Unit](t1)) && (Nat.equal_nata(Transition.Arity[Unit](t),
                Transition.Arity[Unit](t1))))
              Lista.equal_list[AExp.aexp](Transition.Outputs[Unit](t),
              Transition.Outputs[Unit](t1))
            else true)
          })))
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](Inference.replace(Inference.drop_transitions(newa,
        FSet_Utils.fremove[Nat.nat](t1ID,
          FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat)), Nat.nat](Fun.comp[(Transition.transition_ext[Unit], Nat.nat), Nat.nat, (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](((a: (Transition.transition_ext[Unit], Nat.nat)) =>
            a._2),
            ((a: (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))) =>
              a._2)),
  ...
  def transitionwise_drop_inputs(t1ID: Nat.nat, t2ID: Nat.nat, s: Nat.nat,
    ...
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (if (Lista.equal_list[AExp.aexp](Transition.Outputs[Unit](t1),
        ...
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](Inference.replace(Inference.drop_transition(newa,
        t2ID),
        t1ID, drop_guards(t1)))
      else None)
    }
...
object Inference {
  ...
  def S(m: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[Nat.nat] =
    FSet.sup_fset[Nat.nat](FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), Nat.nat](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
      ...
      m),
      FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), Nat.nat](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
          val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) =
            aa;
  ...
  def tm(t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      a._2),
      t)

  def dest(uid: Nat.nat,
    t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    (((FSet.fthe_elem[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((x: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
  ...
  def infer: Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat) => (Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]) => ((FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    ((a: Nat.nat) =>
      (b: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        (c: Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat) =>
          (d: Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]) =>
            (e: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean) =>
              (f: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) =>
      ...
      case (e, s, d, (l, (i, p)) :: t) =>
        {
          ...
          (if (FSet_Utils.fis_singleton[(Nat.nat, Transition.transition_ext[Unit])](poss_steps)) {
            ...
            (if (Lista.equal_list[Option[Value.value]](EFSM.apply_outputs(Transition.Outputs[Unit](ta),
              AExp.join_ir(i, d)),
            ...
            ((a: (Nat.nat, Transition.transition_ext[Unit])) =>
              {
                ...
                (Lista.equal_list[Option[Value.value]](EFSM.apply_outputs(Transition.Outputs[Unit](ta),
                  AExp.join_ir(i, d)),
                  Lista.map[Value.value, Option[Value.value]](((aa: Value.value) =>
                    Some[Value.value](aa)),
                    p))) && (satisfies_trace_prim(e, sa,
                    EFSM.apply_updates(Transition.Updates[Unit](ta), AExp.join_ir(i, d), d),
                    t))
              })))
        }
    }
  ...
  def toiEFSM_aux(uu: Nat.nat,
    x1: List[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): List[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (uu, x1) match {
      case (uu, Nil) => Nil
      case (n, h :: t) => (n, h) :: toiEFSM_aux(Nat.plus_nata(n, Nat.Nata((1))), t)
    }

  def toiEFSM(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.fset_of_list[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](toiEFSM_aux(Nat.zero_nata,
      FSet.sorted_list_of_fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](e)))

  def learn(n: Nat.nat,
    pta: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    l: List[List[(String, (List[Value.value], List[Value.value]))]],
    r: Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat,
    m: Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    {
  ...
  def directly_subsumes(m1: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    m2: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    sa: Nat.nat, s: Nat.nat,
    t1: Transition.transition_ext[Unit],
    t2: Transition.transition_ext[Unit]): Boolean =
    Code_Generation.directly_subsumes_cases(m1, m2, sa, s, t1, t2)

  def drop_transition(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    t: Nat.nat): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, _): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
  ...
  def merge_transitions(oldEFSM: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    destMerge: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    t_1: Transition.transition_ext[Unit], u_1: Nat.nat,
    t_2: Transition.transition_ext[Unit], u_2: Nat.nat,
    modifier: Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (if (directly_subsumes(oldEFSM, destMerge, origin(u_1, oldEFSM),
      origin(u_1, destMerge), t_2, t_1))
      Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](drop_transition(destMerge,
      u_1))
  ...
  def make_distinct_aux(x0: List[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, e) match {
      case (Nil, e) => e
      case (h :: t, e) =>
        (if (FSet.fmember[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](h._2,
          FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
            a._2),
            e)))
          make_distinct_aux(t, e)
        else make_distinct_aux(t, FSet.finsert[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](h, e)))
    }

  def make_distinct(e: Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (e match {
      case None => None
      case Some(ea) =>
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](make_distinct_aux(FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](ea),
          FSet.bot_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]))
    })

  def deterministic(t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Boolean =
    FSet.equal_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](np(t),
      FSet.bot_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))])

  def merge_states_aux(x: Nat.nat, y: Nat.nat,
    t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
  ...
  def resolve_nondeterminism(uu: List[(Nat.nat, Nat.nat)],
    x1: List[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))],
    uv: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    newa: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uw: Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    ...
    (uu, x1, uv, newa, uw, check, np) match {
      case (uu, Nil, uv, newa, uw, check, np) =>
        (if ((deterministic(newa, np)) && (check(tm(newa))))
          Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](newa)
        else None)
      case (closed, (from, ((dest_1, dest_2), ((t_1, u_1), (t_2, u_2)))) :: ss,
        oldEFSM, newEFSM, m, check, np) => (if (closed contains (dest_1, dest_2)) None
      else {
        val destMerge: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = (if (Nat.equal_nata(dest_1, dest_2)) newEFSM
        ...
        (make_distinct(merge_transitions(oldEFSM, destMerge, t_1, u_1,
          ...
          case Some(newa) =>
            {
              val newScores: List[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))] = FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](np(newa));
              (if (Nat.less_nat(Nat.plus_nata(Nat.plus_nata(Nat.Nata(newScores.length),
                FSet.size_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](newa)),
                FSet.size_fset[Nat.nat](S(newa))),
                Nat.plus_nata(Nat.plus_nata(Nat.plus_nata(Nat.Nata(ss.length), Nat.Nata((1))),
                  FSet.size_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](newEFSM)),
                ...
                newa, m, check, np) match {
                  ...
                  case Some(a) =>
                    Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](a)
                })
              else None)
            }
        })
  ...
  def merge(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    (if (Nat.equal_nata(s_1, s_2)) None
      ...
      val ea: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = merge_states(s_1, s_2, e);
      resolve_nondeterminism(Nil, FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](np(ea)),
        e, ea, m, check, np)
    })

  def outgoing_transitions(n: Nat.nat,
    t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
        ({
  ...
  def k_outgoing(m: Nat.nat,
    i: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s: Nat.nat): FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))] =
    (if (Nat.equal_nata(m, Nat.zero_nata)) outgoing_transitions(s, i)
    else {
      val outgoing: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))] = outgoing_transitions(s, i)
      val others: FSet.fset[Nat.nat] =
        FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat)), Nat.nat](((a: (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))) =>
          a._1),
          outgoing);
      FSet.sup_fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](outgoing,
        FSet.ffUnion[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](FSet.fimage[Nat.nat, FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))]](((a: Nat.nat) =>
  ...
  def k_score(n: Nat.nat,
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    rank: Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat): FSet.fset[(Nat.nat, (Nat.nat, Nat.nat))] =
    {
        ...
        FSet.fimage[(Nat.nat, Nat.nat), (Nat.nat, (Nat.nat, Nat.nat))](((a: (Nat.nat, Nat.nat)) =>
          {
            ...
            val outgoing_s1: FSet.fset[Nat.nat] =
              FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat)), Nat.nat](Fun.comp[(Transition.transition_ext[Unit], Nat.nat), Nat.nat, (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](((aa: (Transition.transition_ext[Unit], Nat.nat)) =>
                aa._2),
            ...
            val scores: FSet.fset[Nat.nat] =
              FSet.fimage[(Nat.nat, Nat.nat), Nat.nat](((aa: (Nat.nat, Nat.nat)) =>
                {
                  val (x, y): (Nat.nat, Nat.nat) = aa;
                  ((rank(x))(y))(e)
                }),
                FSet_Utils.fprod[Nat.nat, Nat.nat](outgoing_s1, outgoing_s2));
  ...
  def max_int(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Int.int =
    Lattices_Big.Max[Int.int](Set.insert[Int.int](Int.zero_int,
      EFSM.enumerate_ints(tm(e))))

  def max_reg(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[Nat.nat] =
    {
      val maxes: FSet.fset[Option[Nat.nat]] =
        FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), Option[Nat.nat]](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
  ...
  def replace(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    tID: Nat.nat, t: Transition.transition_ext[Unit]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
  ...
  def add_transition(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    s: Nat.nat, label: String, inputs: List[Value.value],
    outputs: List[Value.value]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    FSet.finsert[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((s,
  ...
  def make_branch(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    uu: Nat.nat, uv: Map[Nat.nat, Option[Value.value]],
    x3: List[(String, (List[Value.value], List[Value.value]))]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    (e, uu, uv, x3) match {
      case (e, uu, uv, Nil) => e
      case (e, s, r, (label, (inputs, outputs)) :: t) =>
        (EFSM.step(e, s, r, label, inputs) match {
          ...
          case Some((_, (sa, (outputsa, updated)))) =>
            (if (Lista.equal_list[Option[Value.value]](outputsa,
              Lista.map[Value.value, Option[Value.value]](((a: Value.value) =>
                Some[Value.value](a)),
                outputs)))
  ...
  def make_pta(x0: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    (x0, e) match {
      case (h :: t, e) =>
  ...
  def get_by_id(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    u: Nat.nat): Transition.transition_ext[Unit] =
    ((FSet.fthe_elem[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, _): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
  ...
  def replaceAll(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    old: Transition.transition_ext[Unit],
    newa: Transition.transition_ext[Unit]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
  ...
  def satisfiable_list(l: List[GExp.gexp]): Boolean =
    Dirties.satisfiable(Lista.fold[GExp.gexp, GExp.gexp](((v: GExp.gexp) =>
  ...
  def max_reg_total(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    (max_reg(e) match {
      case None => Nat.zero_nata
      case Some(r) => r
    })
  ...
  def null_modifier(uu: Nat.nat, uv: Nat.nat, uw: Nat.nat,
    ux: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uy: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uz: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    None

  def total_max_reg(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    (FSet.fMax[Option[Nat.nat]](FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), Option[Nat.nat]](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (_, ab): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
        Transition.max_reg(ab)
  ...
  def inference_step(uu: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x1: List[(Nat.nat, (Nat.nat, Nat.nat))],
    uv: Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    uw: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean,
    ux: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
  ...
  def try_heuristics(x0: List[Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]],
    uu: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (x0, uu) match {
      case (Nil, uu) =>
        ((a: Nat.nat) => (b: Nat.nat) => (c: Nat.nat) =>
          (d: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
            (e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
              (f: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) =>
      ...
      case (h :: t, np) =>
        ((a: Nat.nat) => (b: Nat.nat) => (c: Nat.nat) =>
          (d: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
            (e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
              (npa: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) =>
                ((((((h(a))(b))(c))(d))(e))(npa) match {
                  case None =>
                    (try_heuristics(t, npa)).apply(a).apply(b).apply(c).apply(d).apply(e).apply(npa)
                  case Some(aa) =>
                    Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](aa)
                }))
    }

  def drop_transitions(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    t: FSet.fset[Nat.nat]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, _): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
  ...
  def i_possible_steps(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s: Nat.nat, r: Map[Nat.nat, Option[Value.value]],
    l: String, i: List[Value.value]): FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
        val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
  ...
  def nondeterministic(t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Boolean =
    !(deterministic(t, np))
  ...
  def add_transition_abstract(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    r: Map[String, Option[Nat.nat]], s: Nat.nat,
    label: String, inputs: List[Value.value],
    outputs: List[Value.value]): (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])], Map[String, Option[Nat.nat]]) =
    {
      ...
      (if (label.endsWith("*"))
        (FSet.finsert[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((s, s),
        ...
        e),
        ra)
      else (FSet.finsert[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](((s,
        Nat.plus_nata(maxS(e), Nat.Nata((1)))),
  ...
  def make_branch_abstract(x0: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])], Map[String, Option[Nat.nat]]),
    uu: Nat.nat, uv: Map[Nat.nat, Option[Value.value]],
    x3: List[(String, (List[Value.value], List[Value.value]))]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    (x0, uu, uv, x3) match {
  ...
  def make_pta_abstract(l: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]): FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])] =
    Lista.fold[List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]](((h: List[(String, (List[Value.value], List[Value.value]))]) =>
      (ea: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) =>
  ...
  def state_nondeterminism(origin: Nat.nat,
    nt: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))] =
    (if (Nat.less_nat(FSet.size_fset[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](nt),
      Code_Numeral.nat_of_integer(BigInt(2))))
      FSet.bot_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]
    else FSet.ffUnion[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat)), FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]](((x: (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))) =>
      {
        val (dest, t): (Nat.nat, (Transition.transition_ext[Unit], Nat.nat)) = x;
        FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat)), (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](((y: (Nat.nat, (Transition.transition_ext[Unit], Nat.nat))) =>
          {
            val (desta, ta): (Nat.nat, (Transition.transition_ext[Unit], Nat.nat)) = y;
            (origin, ((dest, desta), (t, ta)))
          }),
          FSet_Utils.fremove[(Nat.nat, (Transition.transition_ext[Unit], Nat.nat))](x, nt))
      }),
      nt)))

  def try_heuristics_check(uu: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean,
    x1: List[Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]]],
    uv: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, x1, uv) match {
      case (uu, Nil, uv) =>
        ((a: Nat.nat) => (b: Nat.nat) => (c: Nat.nat) =>
          (d: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
            ...
            (e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
              (npa: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) =>
                ((((((h(a))(b))(c))(d))(e))(npa) match {
                  ...
                  case Some(ea) =>
                    (if (check(tm(ea)))
                      Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](ea)
                    else (try_heuristics_check(check, t,
                      npa)).apply(a).apply(b).apply(c).apply(d).apply(e).apply(npa))
                }))
    }

  def nondeterministic_pairs(t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](((a: (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat)))) = a
        val (_, ab): ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))) = aa
        val (ac, b): ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat)) = ab;
        ({
      ...
      FSet.ffUnion[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](FSet.fimage[Nat.nat, FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]](((s: Nat.nat) =>
        state_nondeterminism(s,
          outgoing_transitions(s, t))),
        S(t))))

  def nondeterministic_pairs_labar(t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](((a: (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat)))) = a
        val (ab, b): ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))) = aa;
        ({
          val (_, _): (Nat.nat, Nat.nat) = ab;
          ((ac: ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))) =>
            {
              val (ad, ba): ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat)) = ac;
              ({
                    ...
                    (Transition.Label[Unit](ta) ==
                      Transition.Label[Unit](taa)) && ((Nat.equal_nata(Transition.Arity[Unit](ta),
                        Transition.Arity[Unit](taa))) && ((EFSM.choice(ta,
                          taa)) || (Lista.equal_list[AExp.aexp](Transition.Outputs[Unit](ta),
  ...
  def nondeterministic_pairs_labar_dest(t: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))] =
    FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](((a: (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))) =>
      {
        val (_, aa): (Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat)))) = a
        val (ab, b): ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))) = aa;
...
object Code_Generation {
  ...
  def choice_cases(t1: Transition.transition_ext[Unit],
    ...
    (if (Lista.list_ex[(GExp.gexp, GExp.gexp)](((a: (GExp.gexp, GExp.gexp)) =>
      ...
      false
    else (if (Lista.equal_list[GExp.gexp](Transition.Guard[Unit](t1),
      Transition.Guard[Unit](t2)))
      Dirties.satisfiable(Lista.foldr[GExp.gexp, GExp.gexp](((v: GExp.gexp) => (va: GExp.gexp) =>
      GExp.Nor(GExp.Nor(v, v), GExp.Nor(va, va))),
      Transition.Guard[Unit](t1), GExp.Bc(true)))
    else Dirties.satisfiable(Lista.foldr[GExp.gexp, GExp.gexp](((v: GExp.gexp) => (va: GExp.gexp) =>
      GExp.Nor(GExp.Nor(v, v), GExp.Nor(va, va))),
  ...
  def infer_with_log(stepNo: Nat.nat, k: Nat.nat,
    ...
    m: Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]],
    check: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean,
    np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
  ...
  def input_updates_register(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): (Nat.nat, String) =
    {
      val (_, (_, t)): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = FSet.fthe_elem[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](FSet.ffilter[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
        {
          val (_, (_, t)): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) =
            a;
  ...
  def always_different_outputs_direct_subsumption(m1: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    m2: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
  ...
  def directly_subsumes_cases(m1: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    m2: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    sa: Nat.nat, s: Nat.nat,
    t1: Transition.transition_ext[Unit],
    t2: Transition.transition_ext[Unit]): Boolean =
...
object Store_Reuse_Subsumption {
  ...
  def input_stored_in_reg(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[(Nat.nat, Nat.nat)] =
  ...
  def updates_subset(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Boolean =
  ...
  def initially_undefined_context_check(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    r: Nat.nat, s: Nat.nat): Boolean =
    (if ((Nat.equal_nata(s, Nat.zero_nata)) && (FSet.fBall[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e,
  ...
  def one_extra_update[A](t1: Transition.transition_ext[A],
    ...
    e2: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Boolean =
    (Transition.Label[A](t1) ==
      Transition.Label[Unit](t2)) && ((Nat.equal_nata(Transition.Arity[A](t1),
        Transition.Arity[Unit](t2))) && ((Lista.equal_list[GExp.gexp](Transition.Guard[A](t1),
          Transition.Guard[Unit](t2))) && ((Lista.equal_list[AExp.aexp](Transition.Outputs[A](t1),
            Transition.Outputs[Unit](t2))) && ((!((Transition.Updates[A](t1)).isEmpty)) && ((Lista.equal_list[(Nat.nat, AExp.aexp)](Lista.tl[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1)),
  ...
  def possibly_not_value(e_1: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e_2: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s_1: Nat.nat, s_2: Nat.nat,
  ...
  def generalise_output_direct_subsumption(ta: Transition.transition_ext[Unit],
    t: Transition.transition_ext[Unit],
    ea: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
  ...
  def drop_update_add_guard_direct_subsumption(a: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    b: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
...
object Store_Reuse {
  ...
  def i_step(tr: List[(String, List[Value.value])],
    ...
    i: List[Value.value]): Option[(Transition.transition_ext[Unit], (Nat.nat, (Nat.nat, Map[Nat.nat, Option[Value.value]])))] =
    {
      val poss_steps: FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))] = Inference.i_possible_steps(e, s, r, l, i)
      val possibilities: FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](((a: (Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))) =>
        {
          val (_, (sa, t)): (Nat.nat, (Nat.nat, Transition.transition_ext[Unit])) = a;
        ...
        poss_steps);
      (Dirties.randomMember[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](possibilities) match {
        case None => None
        case Some((u, (sa, t))) =>
          Some[(Transition.transition_ext[Unit], (Nat.nat, (Nat.nat, Map[Nat.nat, Option[Value.value]])))]((t,
  ...
  def generalise_transitions(x0: List[((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))))],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, e) match {
      case (Nil, e) => e
      case (h :: t, e) =>
        {
          val a: ((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) = h
          val (aa, b): ((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) = a;
          ({
            val (ab, ba): (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = aa;
            ({
              val (ac, bb): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = ab;
              ({
                val (orig1, _): (Transition.transition_ext[Unit], Nat.nat) = ac;
                ((_: (ioTag, Nat.nat)) =>
                  (ad: ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) =>
                    {
                      val (ae, bc): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = ad;
                      ({
                        val (orig2, _): (Transition.transition_ext[Unit], Nat.nat) = ae;
                        ((_: (ioTag, Nat.nat)) =>
                          (af: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) =>
                            {
                              val (ag, bd): (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = af;
                              ({
                                val (ah, be): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = ag;
                                ({
                                  val (gen1, _): (Transition.transition_ext[Unit], Nat.nat) = ah;
                                  ((_: (ioTag, Nat.nat)) =>
                                    (ai: ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) =>
                                      {
                                        val (aj, bf): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = ai;
                                        ({
                                          val (gen2, _): (Transition.transition_ext[Unit], Nat.nat) = aj;
                                          ((_: (ioTag, Nat.nat)) =>
  ...
  def strip_uids(x: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))): ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat))) =
    {
      val a: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = x
      val (aa, b): (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = a;
      ({
        val (ab, ba): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = aa;
        ({
          ...
          ((ac: (ioTag, Nat.nat)) =>
            {
              ...
              ((ad: ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) =>
                {
                  val (ae, bb): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = ad;
                  ({
  ...
  def modify(matches: List[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))],
    u1: Nat.nat, u2: Nat.nat,
    old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      val relevant: List[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))] = Lista.filter[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) =>
        {
          val (aa, b): (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = a;
          ({
            val (ab, ba): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = aa;
      ...
      val replacements: List[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))] = Lista.map[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) =>
        {
          val (aa, b): (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = a;
          ({
            val (ab, ba): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = aa;
        ...
        relevant)
      val comparisons: List[((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))))] = (relevant zip replacements)
      val stripped_replacements: List[((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat)))] = Lista.map[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), ((Transition.transition_ext[Unit], (ioTag, Nat.nat)), (Transition.transition_ext[Unit], (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) =>
        strip_uids(a)),
        replacements)
      val to_replace: List[((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))))] = Lista.filter[((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))))](((a: ((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))))) =>
        {
          val (_, s): ((((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) = a;
      ...
      else Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](generalise_transitions(to_replace,
        old)))
    }
  ...
  def modify_2(matches: List[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))],
    u1: Nat.nat, u2: Nat.nat,
    old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      val relevant: List[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))] = Lista.filter[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) =>
  ...
  def walk_up_to(n: Nat.nat,
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s: Nat.nat, r: Map[Nat.nat, Option[Value.value]],
    x4: List[(String, (List[Value.value], List[Value.value]))]): (Transition.transition_ext[Unit], Nat.nat) =
    (n, e, s, r, x4) match {
      case (n, e, s, r, h :: t) =>
        {
          val (Some((transition, (sa, (uid, updated))))): Option[(Transition.transition_ext[Unit], (Nat.nat, (Nat.nat, Map[Nat.nat, Option[Value.value]])))] = i_step(exec2trace[String, List[Value.value], List[Value.value]](t), e,
            s, r, h._1, (h._2)._1);
  ...
  def find_intertrace_matches_aux(intras: FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    t: List[(String, (List[Value.value], List[Value.value]))]): FSet.fset[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))] =
    FSet.fimage[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat))), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](((a: ((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))) =>
      {
        val (aa, b): ((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat))) = a;
        ({
  ...
  def find_intertrace_matches(l: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): List[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))] =
    Lista.filter[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](((a: (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))) =>
      {
        val (aa, b): (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) = a;
        ({
          val (e1, (_, _)): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = aa;
          ((ab: ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat))) =>
            {
              val (e2, (_, _)): ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)) = ab;
              !(Product_Type.equal_proda[Transition.transition_ext[Unit], Nat.nat](e1, e2))
            })
        })(b)
      }),
      Lista.maps[(List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))]), (((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](((a: (List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))])) =>
        {
          val (t, m): (List[(String, (List[Value.value], List[Value.value]))], FSet.fset[((Nat.nat, (ioTag, Nat.nat)), (Nat.nat, (ioTag, Nat.nat)))]) = a;
          FSet.sorted_list_of_fset[(((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)), ((Transition.transition_ext[Unit], Nat.nat), (ioTag, Nat.nat)))](find_intertrace_matches_aux(m, e, t))
        }),
  ...
  def heuristic_1(l: List[List[(String, (List[Value.value], List[Value.value]))]]): Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    ((t1: Nat.nat) => (t2: Nat.nat) => (_: Nat.nat) =>
      (newa: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        (old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
          (np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) =>
            (modify(find_intertrace_matches(l, old), t1, t2, newa) match {
              case None => None
              case Some(newEFSM) =>
                Inference.resolve_nondeterminism(Nil,
                  FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](np(newEFSM)),
                  old, newEFSM,
                  ((a: Nat.nat) => (b: Nat.nat) => (c: Nat.nat) =>
                    (d: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                      (e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
  ...
  def heuristic_2(l: List[List[(String, (List[Value.value], List[Value.value]))]]): Nat.nat => Nat.nat => Nat.nat => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => ((FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) => Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    ((t1: Nat.nat) => (t2: Nat.nat) => (_: Nat.nat) =>
      (newa: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        (old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
          (np: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]) =>
            (modify_2(find_intertrace_matches(l, old), t1, t2, newa) match {
              ...
              case Some(newEFSM) =>
                Inference.resolve_nondeterminism(Nil,
                  FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](Inference.nondeterministic_pairs(newEFSM)),
                  old, newEFSM,
                  ((a: Nat.nat) => (b: Nat.nat) => (c: Nat.nat) =>
                    (d: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                      (e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
      ...
      (Transition.Label[Unit](t) ==
        "equals") && ((Nat.equal_nata(Transition.Arity[Unit](t),
          Code_Numeral.nat_of_integer(BigInt(2)))) && ((Value.equal_valuea((ep(Code_Numeral.integer_of_nat(Nat.zero_nata).toInt))._2,
            (ep(Code_Numeral.integer_of_nat(Nat.Nata((1))).toInt))._2)) && ((Lista.equal_list[Nat.nat](Lista.map[(Nat.nat, Value.value), Nat.nat](((a: (Nat.nat, Value.value)) => a._1), ep),
              List(Nat.zero_nata,
                Nat.Nata((1))))) && (Lista.equal_list[AExp.aexp](Transition.Outputs[Unit](t),
...
object EFSM_Dot {
  ...
  def iefsm2dot(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): String =
    "digraph EFSM{" + "\u000A" + "  graph [rankdir=" + "\"" + "LR" + "\"" +
      ", fontname=" +
      "\"" +
      "Latin Modern Math" +
      ...
      (Lista.map[Nat.nat, String](((s: Nat.nat) =>
        ...
        "\u000A" +
        "\u000A" +
        (Lista.map[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), String](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
            val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
            val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
            ({
          ...
          FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e))).mkString("\u000A") +
          "\u000A" +
          "}"
...
object Same_Register {
  ...
  def replace_with(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    r1: Nat.nat, r2: Nat.nat): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (u, (tf, t)): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
    ...
    uu: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (if (Transition.same_structure(t1, t2))
        ...
        case (Some(VName.R(r1)), Some(VName.R(r2))) =>
          Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](replace_with(newa,
            r1, r2))
      })
      else None)
    }
...
object Increment_Reset {
  ...
  def struct_replace_all(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    old: Transition.transition_ext[Unit],
    newa: Transition.transition_ext[Unit]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
      ...
      (if ((guardMatch[Unit, Unit](t1, t2)) && (outputMatch[Unit, Unit](t1, t2))) {
        ...
        val newT2: Transition.transition_ext[Unit] =
          Transition.transition_exta[Unit](Transition.Label[Unit](t2),
            ...
            ())
        val initialised: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
          {
            val (uid, aa): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
            val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
            ({
          ...
          newa)
        val newEFSM: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = struct_replace_all(struct_replace_all(initialised, t2, newT2), t1,
          newT1);
        Inference.resolve_nondeterminism(Nil,
          FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))](np(newEFSM)),
          old, newEFSM,
...
object SelectionStrategies {
  ...
  def naive_score(t1ID: Nat.nat, t2ID: Nat.nat,
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    {
  ...
  def naive_score_outputs(t1ID: Nat.nat, t2ID: Nat.nat,
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Nat.nat =
    {
      ...
      Nat.plus_nata(Nat.plus_nata(bool2nat(Transition.Label[Unit](x) ==
        ...
        bool2nat(Lista.equal_list[AExp.aexp](Transition.Outputs[Unit](x),
...
object Symbolic_Regression {
  ...
  def get_functions(maxReg: Nat.nat, values: List[Int.int], n: Nat.nat,
    l: List[(Nat.nat, (Nat.nat, (String, (List[Value.value], List[Value.value]))))]): List[Option[AExp.aexp]] =
    Lista.map[Nat.nat, Option[AExp.aexp]](((p: Nat.nat) =>
      Dirties.getFunction(maxReg, values,
        get_inputs(l), get_outputs(l, p))),
      Lista.upt(Nat.zero_nata, n))

  def make_distinct(e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    Inference.make_distinct_aux(FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](e),
      FSet.bot_fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))])
  ...
  def enumerate_value_ints(vs: List[Value.value]): List[Int.int] =
    Lista.map_filter[Value.value, Int.int](((x: Value.value) =>
      (if ((x match {
  ...
  def enumerate_exec_ints(vs: List[(String, (List[Value.value], List[Value.value]))]): List[Int.int] =
    Lista.fold[(String, (List[Value.value], List[Value.value])), List[Int.int]](((a: (String, (List[Value.value], List[Value.value]))) =>
      {
  ...
  def enumerate_log_ints(l: List[List[(String, (List[Value.value], List[Value.value]))]]): List[Int.int] =
    Lista.fold[List[(String, (List[Value.value], List[Value.value]))], List[Int.int]](((e: List[(String, (List[Value.value], List[Value.value]))]) =>
      ((a: List[Int.int]) =>
  ...
  def get_exec_reg_values(uu: AExp.aexp,
    ...
    (uu, x1, uv, uw, ux, uy, uz) match {
      ...
      case (f, (va, (l, (i, p))) :: t, label, i_arity, e, s, r) =>
        {
          val poss_steps: FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](((a: (Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))) =>
            {
              val (_, (_, ta)): (Nat.nat, (Nat.nat, Transition.transition_ext[Unit])) = a;
              Lista.equal_list[Option[Value.value]](EFSM.apply_outputs(Transition.Outputs[Unit](ta),
                AExp.join_ir(i, r)),
                Lista.map[Value.value, Option[Value.value]](((aa: Value.value) =>
                  Some[Value.value](aa)),
          ...
          val (_, (sa, ta)): (Nat.nat, (Nat.nat, Transition.transition_ext[Unit])) =
            FSet.fthe_elem[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](poss_steps)
  ...
  def get_log_reg_values(uu: AExp.aexp,
    ...
    uv: String, uw: Nat.nat,
    ux: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): List[(List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))] =
    (uu, x1, uv, uw, ux) match {
  ...
  def replace_transitions(x0: List[(Nat.nat, Transition.transition_ext[Unit])],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, e) match {
      case (Nil, e) => e
      case ((ti, t) :: rest, e) =>
        replace_transitions(rest,
          FSet.fimage[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
            {
              val (id, (od, ta)): (Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
              (if (Nat.equal_nata(id, ti)) (id, (od, t)) else (id, (od, ta)))
            }),
            e))
    }
  ...
  def put_update_function_aux(uu: Option[AExp.aexp], uv: Nat.nat,
    ...
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uz: Nat.nat,
    va: Map[Nat.nat, Option[Value.value]]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, ux, uy, e, uz, va) match {
      case (uu, uv, uw, Nil, ux, uy, e, uz, va) =>
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (op, ox, us, (vb, (l, (i, p))) :: t, label, i_arity, e, s, r) =>
        {
          val poss_steps: FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](((a: (Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))) =>
            {
              val (_, (_, ta)): (Nat.nat, (Nat.nat, Transition.transition_ext[Unit])) = a;
            ...
            Inference.i_possible_steps(e, s, r, l, i))
            PrettyPrinter.iEFSM2dot(e, 6)
            println(f"Transitions for ${l}(${PrettyPrinter.inputsToString(i)})/${PrettyPrinter.litOutputsToString(p)} with registers ${r}")
            for ((id, (dest, t)) <- FSet.sorted_list_of_fset(Inference.i_possible_steps(e, s, r, l, i))) {
              println("  "+PrettyPrinter.transitionToString(t) + " :: " + PrettyPrinter.optOutputsToString(EFSM.apply_outputs(Transition.Outputs[Unit](t), AExp.join_ir(i, r))))
            }
          val (tid, (sa, ta)): (Nat.nat, (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](poss_steps);
          (if ((l == label) && (Nat.equal_nata(Nat.Nata(i.length), i_arity))) {
            val newT: Transition.transition_ext[Unit] =
              insert_outputs(insert_updates(ta, us), op, ox)
            val newE: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = replace_transitions(List((tid, newT)), e);
            put_update_function_aux(op, ox, us, t, label, i_arity,
              make_distinct(newE), sa,
              EFSM.apply_updates(Transition.Updates[Unit](ta),
                AExp.join_ir(i, r), r))
          } else put_update_function_aux(op, ox, us, t, label, i_arity, e, sa,
            EFSM.apply_updates(Transition.Updates[Unit](ta),
              AExp.join_ir(i, r), r)))
        }
    }
  ...
  def put_update_functions(uu: Option[AExp.aexp], uv: Nat.nat,
    ...
    ux: String, uy: Nat.nat,
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, ux, uy, e) match {
      case (uu, uv, uw, Nil, ux, uy, e) =>
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (op, ox, us, h :: t, label, arity, e) =>
        (put_update_function_aux(op, ox, us, h._2, label, arity, e, Nat.zero_nata,
          Map().withDefaultValue(None)) match {
            case None => None
            case Some(a) => put_update_functions(op, ox, us, t, label, arity, a)
          })
    }

  def outputwise_updates(uu: List[Int.int], uv: Nat.nat,
    x2: List[Option[AExp.aexp]],
    pta: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uw: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    ux: String, uy: Nat.nat): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, x2, pta, e, uw, ux, uy) match {
      ...
      case (values, ox, None :: t, pta, e, log, label, arity) =>
        outputwise_updates(values, Nat.plus_nata(ox, Nat.Nata((1))), t, pta, e, log,
          label, arity)
      case (values, ox, Some(a) :: t, pta, e, log, label, arity) =>
        {
  ...
  def put_output_function_aux(uu: Nat.nat, uv: AExp.aexp,
    x2: List[(Nat.nat, (String, (List[Value.value], List[Value.value])))],
    uw: String, ux: Nat.nat, uy: Nat.nat,
    uz: Option[Nat.nat],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    va: Nat.nat,
    vb: Map[Nat.nat, Option[Value.value]]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, x2, uw, ux, uy, uz, e, va, vb) match {
      case (uu, uv, Nil, uw, ux, uy, uz, e, va, vb) =>
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (fi, f, (vc, (l, (i, p))) :: t, label, i_arity, o_arity, prevtid, e, s,
        r) => {
        val poss_steps: FSet.fset[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](((a: (Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))) =>
          {
            val (_, (_, ta)): (Nat.nat, (Nat.nat, Transition.transition_ext[Unit])) = a;
          ...
          Inference.i_possible_steps(e, s, r, l, i));
        (Dirties.randomMember[(Nat.nat, (Nat.nat, Transition.transition_ext[Unit]))](poss_steps) match {
          case None => None
          case Some((tid, (sa, ta))) =>
                ...
                case Some(prevtida) =>
                  {
                    val prevT: Transition.transition_ext[Unit] =
                      Inference.get_by_id(e, prevtida)
                    ...
                    val newE: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = replace_transitions(List((tid, newT),
                      (prevtida, newPrevT)),
                      e);
                    put_output_function_aux(fi, f, t, label, i_arity,
                      o_arity, Some[Nat.nat](tid), newE, sa,
                      EFSM.apply_updates(Transition.Updates[Unit](ta), AExp.join_ir(i, r),
                        r))
                  }
              })
            } else put_output_function_aux(fi, f, t, label, i_arity, o_arity,
              Some[Nat.nat](tid), e, sa,
              EFSM.apply_updates(Transition.Updates[Unit](ta), AExp.join_ir(i, r), r)))
        })
      }
    }
  ...
  def put_output_function(uu: Nat.nat, uv: AExp.aexp,
    x2: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    ...
    (uu, uv, x2, uw, e) match {
      case (uu, uv, Nil, uw, e) =>
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (fi, f, h :: t, t1, e) =>
        (put_output_function_aux(fi, f, h._2, Transition.Label[Unit](t1),
          Transition.Arity[Unit](t1),
  ...
  def put_output_functions(x0: List[(Nat.nat, Option[AExp.aexp])],
    ...
    (x0, uu, uv, e) match {
      ...
      case ((fi, Some(f)) :: rest, log, t, e) =>
        (put_output_function(fi, f, log, t, e) match {
          case None => None
              ...
              case Some(prevtida) =>
                {
                  val necessaryRegs: List[Nat.nat] =
                    (Dirties.getRegs(i, f,
                      p(Code_Numeral.integer_of_nat(fi).toInt))).keySet.toList;
                  (if (!(Nat.equal_nata(Nat.Nata(necessaryRegs.length),
                    ...
                    val newT: Transition.transition_ext[Unit] =
                      Transition.transition_exta[Unit](Transition.Label[Unit](ta),
                        ...
                        ((Lista.hd[Nat.nat](necessaryRegs), f) ::
                          Transition.Updates[Unit](ta)).distinct,
                        ())
                    val satisfyingRegs: Map[Nat.nat, Option[Value.value]] = Dirties.getRegs(i, f,
                      p(Code_Numeral.integer_of_nat(fi).toInt))
                    val updates: List[(Nat.nat, AExp.aexp)] =
                      Lista.map[Nat.nat, (Nat.nat, AExp.aexp)](((ra: Nat.nat) =>
                        {
                    ...
                    val newE: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = replace_transitions(List((tid, newT),
                      (prevtida, newPrevT)),
                      e);
                    put_output_function_2_aux(fi, f, t, label,
                      i_arity, o_arity, Some[Nat.nat](tid), newE, sa,
                      EFSM.apply_updates(Transition.Updates[Unit](ta),
                        AExp.join_ir(i, r), r))
                  })
                }
            })
            else put_output_function_2_aux(fi, f, t, label, i_arity,
              o_arity, Some[Nat.nat](tid), e, sa,
              EFSM.apply_updates(Transition.Updates[Unit](ta), AExp.join_ir(i, r),
                r)))
        })
      }
  ...
  def put_output_function_2(uu: Nat.nat, uv: AExp.aexp,
    ...
    (uu, uv, x2, uw, e) match {
      case (uu, uv, Nil, uw, e) =>
        Some[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (fi, f, h :: t, t1, e) =>
        (put_output_function_2_aux(fi, f, h._2, Transition.Label[Unit](t1),
          Transition.Arity[Unit](t1),
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          None, e, Nat.zero_nata,
          Map().withDefaultValue(None)) match {
            case None => None
            case Some(a) => put_output_function_2(fi, f, t, t1, a)
          })
    }

  def infer_output_functions(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    t1ID: Nat.nat, t2ID: Nat.nat, s: Nat.nat,
    newa: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    old: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[AExp.aexp]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events);
      put_output_functions(Lista.enumerate[Option[AExp.aexp]](Nat.zero_nata,
        output_functions),
        i_log, t1, newa)
    }

  def put_output_functions_2(x0: List[(Nat.nat, Option[AExp.aexp])],
    uu: List[(Nat.nat, List[(Nat.nat, (String, (List[Value.value], List[Value.value])))])],
    uv: Transition.transition_ext[Unit],
    e: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (x0, uu, uv, e) match {
      ...
      case ((uw, None) :: ux, uy, uz, va) => None
      case ((fi, Some(f)) :: rest, log, t, e) =>
        (put_output_function_2(fi, f, log, t, e) match {
          case None => None
    ...
    uu: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[AExp.aexp]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events);
      put_output_functions_2(Lista.enumerate[Option[AExp.aexp]](Nat.zero_nata,
        output_functions),
        i_log, t1, newa)
    }
    ...
    uu: (FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], Nat.nat), (Transition.transition_ext[Unit], Nat.nat))))]): Option[FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[AExp.aexp]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events)
      val pta: FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.toiEFSM(Inference.make_pta(log,
        FSet.bot_fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]));
      (put_output_functions(Lista.enumerate[Option[AExp.aexp]](Nat.zero_nata,
        output_functions),
        i_log, t1, pta) match {
          case None => None
          case Some(e) =>
            outputwise_updates(values, Nat.zero_nata, output_functions, e, newa,
