...
object Orderings {
  ...
  object ord {
    ...
    implicit def `Option_Lexorder.ord_option`[A: HOL.equal: linorder]: ord[Option[A]] = new ord[Option[A]] {
  ...
  object preorder {
    ...
    implicit def `Option_Lexorder.preorder_option`[A: HOL.equal: linorder]: preorder[Option[A]] = new preorder[Option[A]] {
      val `Orderings.less_eq` = (a: Option[A], b: Option[A]) =>
        Option_Lexorder.less_eq_option[A](a, b)
      val `Orderings.less` = (a: Option[A], b: Option[A]) =>
        Option_Lexorder.less_option[A](a, b)
  ...
  object order {
    ...
    implicit def `Option_Lexorder.order_option`[A: HOL.equal: linorder]: order[Option[A]] =
      new order[Option[A]] {
        val `Orderings.less_eq` = (a: Option[A], b: Option[A]) =>
          Option_Lexorder.less_eq_option[A](a, b)
        val `Orderings.less` = (a: Option[A], b: Option[A]) =>
  ...
  object linorder {
    ...
    implicit def `Option_Lexorder.linorder_option`[A: HOL.equal: linorder]: linorder[Option[A]] = new linorder[Option[A]] {
      val `Orderings.less_eq` = (a: Option[A], b: Option[A]) =>
        Option_Lexorder.less_eq_option[A](a, b)
      val `Orderings.less` = (a: Option[A], b: Option[A]) =>
        Option_Lexorder.less_option[A](a, b)
            ...
            case Some(newa) =>
              {
                ...
                (if (Nat.less_nat(Nat.plus_nata(Nat.plus_nata(Nat.Nata(newScores.length),
                  FSet.size_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](newa)),
...
object Distinguishing_Guards {
  ...
  def distinguish(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val uPTA: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = transfer_updates(destMerge, Inference.make_pta(log, FSet.bot_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]))
      ...
      if (Symbolic_Regression.numH == 80) {
        PrettyPrinter.iEFSM2dot(uPTA, "uPTA" + numD)
          println("g1:")
          for (kv <- g1)
            println("  "+kv)
          println("g2:")
...
object Symbolic_Regression {
  ...
  def lift_output_functions(oPTA: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    merged: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    label: String, arity: Nat.nat): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    Lista.fold[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
        val (tid, (_, t)): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a;
        ((acc: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
          {
            val oldT: Transition.transition_ext[Unit] =
              Inference.get_by_id(merged, tid.head);
            (if ((Transition.Label[Unit](oldT) ==
      ...
      FSet.sorted_list_of_fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](oPTA),
      merged)
  ...
  def add_groupwise_updates(x0: List[Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])]],
    ...
    (x0, e) match {
      case (Nil, e) => e
      case (None :: t, e) => add_groupwise_updates(t, e)
      case (Some((tids, u)) :: t, e) =>
        {
          ...
          val replacements: List[(List[Nat.nat], Transition.transition_ext[Unit])] =
            ((Lista.map[Nat.nat, List[Nat.nat]](((id: Nat.nat) => List(id)),
              tids)) zip newTransitions);
          add_groupwise_updates(t, Inference.replace_transitions(e, replacements))
        }
    }
  ...
  def put_updates(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    uv: List[Value.value], uw: Transition.transition_ext[Unit],
    ux: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x4: List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])],
    ...
    (uu, uv, uw, ux, x4, e) match {
      case (uu, uv, uw, ux, Nil, e) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (uy, uz, va, vb, (vc, None) :: vd, ve) => None
      case (log, values, t1, lit, (o_inx, Some((op, types))) :: ops, newa) =>
        {
          val walked: List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]] = everything_walk_log(op, o_inx, types, log, lit,
            Transition.Label[Unit](t1),
            Transition.Arity[Unit](t1),
          ...
          val lifted: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = lift_output_functions(lit, newa, Transition.Label[Unit](t1),
            Transition.Arity[Unit](t1))
          val a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_distinct(add_groupwise_updates(group_updates, lifted));
          put_updates(log, values, t1, lit, ops, a)
        }
    }
  ...
  def apply_updates_redundancy(x0: List[(Nat.nat, AExp.aexp)],
    uu: VName.vname => Option[Value.value],
    newa: Map[Nat.nat, Option[Value.value]],
    redundant: List[(Nat.nat, AExp.aexp)]): (Map[Nat.nat, Option[Value.value]], List[(Nat.nat, AExp.aexp)]) =
    (x0, uu, newa, redundant) match {
      case (Nil, uu, newa, redundant) => (newa, redundant)
      case (h :: t, old, newa, redundant) =>
        (if (Optiona.equal_optiona[Value.value](old(VName.R(h._1)),
          AExp.aval(h._2, old)))
          apply_updates_redundancy(t, old,
          newa + ((h._1) -> (AExp.aval(h._2, old))),
          h :: redundant)
        else apply_updates_redundancy(t, old,
          newa + ((h._1) -> (AExp.aval(h._2, old))),
          redundant))
    }
  ...
  def remove_redundant_updates(x0: List[(String, (List[Value.value], List[Value.value]))],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: Nat.nat,
    uv: Map[Nat.nat, Option[Value.value]]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (x0, e, uu, uv) match {
      case (Nil, e, uu, uv) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case ((label, (inputs, outputs)) :: t, e, s, r) =>
        {
          val poss_steps: FSet.fset[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))] = FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
            {
              val (_, (_, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = a;
            ...
            Inference.i_possible_steps(e, s, r, label, inputs));
          (if (!(FSet_Utils.fis_singleton[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](poss_steps)))
            None
          else {
            val (tid, (sa, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](FSet.ffilter[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](((a: (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))) =>
              {
                val (_, (_, ta)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = a;
                Lista.equal_lista[Option[Value.value]](EFSM.apply_outputs(Transition.Outputs[Unit](ta),
                  AExp.join_ir(inputs, r)),
              ...
              Inference.i_possible_steps(e, s, r, label, inputs)))
            val (updated, redundant): (Map[Nat.nat, Option[Value.value]], List[(Nat.nat, AExp.aexp)]) = apply_updates_redundancy(Transition.Updates[Unit](ta),
              AExp.join_ir(inputs, r), r, Nil);
            (if ((FSet.equal_fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](Inference.outgoing_transitions(sa, e),
              FSet.bot_fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))])) || (Transition.Label[Unit](ta) ==
                "vend")) {
              val newT: Transition.transition_ext[Unit] =
                Transition.transition_exta[Unit](Transition.Label[Unit](ta),
                  Transition.Arity[Unit](ta), Transition.Guard[Unit](ta),
                  Transition.Outputs[Unit](ta), Nil, ());
              remove_redundant_updates(t,
                Inference.replace_transition(e, tid, newT), sa, updated)
            } else (if (Nat.equal_nata(sa, s))
              remove_redundant_updates(t, e, sa, updated)
            else {
              val newT: Transition.transition_ext[Unit] =
                Transition.transition_exta[Unit](Transition.Label[Unit](ta),
                  Transition.Arity[Unit](ta),
                  Transition.Guard[Unit](ta),
                  Transition.Outputs[Unit](ta),
                  Lista.filter[(Nat.nat, AExp.aexp)](((u: (Nat.nat, AExp.aexp)) => !(redundant contains u)),
                    Transition.Updates[Unit](ta)),
                  ());
              remove_redundant_updates(t,
                Inference.replace_transition(e, tid, newT), sa, updated)
  ...
  def remove_redundant_updates_log(x0: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (x0, e) match {
      case (Nil, e) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      case (h :: t, e) =>
        (remove_redundant_updates(h, e, Nat.zero_nata, Map().withDefaultValue(None)) match {
          case None => None
          case Some(a) => remove_redundant_updates_log(t, a)
        })
    }
      ...
      np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
      {
        ...
        (if (!(Nat.equal_nata(Nat.Nata((Transition.Outputs[Unit](t1)).length),
          ...
          case Some(lit) =>
            {
              println(numH + "lit")
              PrettyPrinter.iEFSM2dot(lit, numH)
              put_updates(log, values, t1, lit, Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nata, output_functions), newa) match {
                ...
                case Some(put) => {
                    ...
                    remove_redundant_updates_log(log, put) match {
                      case None => {
                        println(numH + "Failed to remove")
                        None
                      }
                      case Some(newb) => {
                        println(numH + "removed")
                        PrettyPrinter.iEFSM2dot(newb, numH + "removed")
                        Inference.resolve_nondeterminism(Nil,
                          FSet.sorted_list_of_fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))](np(newb)),
                          old, newb,
                          ((a: List[Nat.nat]) => (b: List[Nat.nat]) => (c: Nat.nat) =>
                            (d: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                              (e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                                (f: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
                                  (g: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]) =>
                                    Distinguishing_Guards.distinguish(log, a, b, c, d, e, f,
                                      g)),
                          ((_: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) =>
                            true),
                          np) match {
                            case None => {
                              println(numH + "Failed to resolve")
                              None
                            }
                            case Some(resolved) => {
                              println(numH + "resolved")
                              PrettyPrinter.iEFSM2dot(resolved, numH + "resolved")
                              Some(resolved)
                            }
                          }
                      }
