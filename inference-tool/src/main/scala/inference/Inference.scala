...
= a;
  ...
  e))
     ...
     FSet.finsert[(List[Nat.nat],
                  ...
                  FSet.finsert[(List[Nat.nat],
                                 ((Nat.nat, Nat.nat),
                                   Transition.transition_ext[Unit]))]((uids2,
                                ((origin, dest), newa)),
...
def directly_subsumes_cases(m1: FSet.fset[(List[Nat.nat],
    ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
                             m2: FSet.fset[(List[Nat.nat],
     ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
                             sa: Nat.nat, s: Nat.nat,
...
def one_extra_update[A](t1: Transition.transition_ext[A],
 ...
 Transition.transition_ext[Unit])]):
  ...
  (Transition.Label[A](t1) ==
   ...
   AExp.aexp)](Lista.tl[(Nat.nat, AExp.aexp)](Transition.Updates[A](t1)),
                Transition.Updates[Unit](t2))) && (Lista.list_ex[Nat.nat](((r:
                                      Nat.nat)
                                     =>
                                    (Nat.equal_nata((Lista.hd[(Nat.nat,
                        AExp.aexp)](Transition.Updates[A](t1)))._1,
...
def possibly_not_value(e_1: FSet.fset[(List[Nat.nat],
((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
                        e_2: FSet.fset[(List[Nat.nat],
 ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
                        s_1: Nat.nat, s_2: Nat.nat,
...
(String, (List[Value.value], List[Value.value])))],
    ...
    ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
                             uz: Nat.nat,
                             va: Map[Nat.nat, Option[Value.value]]):
      Option[FSet.fset[(List[Nat.nat],
                         ((Nat.nat, Nat.nat),
                           Transition.transition_ext[Unit]))]]
  =
      ...
      (if ((l == label) && (Nat.equal_nata(Nat.Nata(i.length), i_arity)))
        {
          ...
          val newE: FSet.fset[(List[Nat.nat],
                                ((Nat.nat, Nat.nat),
                                  Transition.transition_ext[Unit]))]
            = Inference.replace_transitions(e, List((tid, newT)));
