...
object AExp {
  ...
  def is_lit(x0: aexp): Boolean = x0 match {
    case L(uu) => true
    case V(v) => false
...
object Inference {
  ...
  def paths_of_length(m: Nat.nat,
    ...
    (if (Nat.equal_nata(m, Nat.zero_nata))
      ...
      val outgoing: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))] = outgoing_transitions(uv, uu)
      val a: FSet.fset[List[List[Nat.nat]]] =
        FSet.ffUnion[List[List[Nat.nat]]](FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), FSet.fset[List[List[Nat.nat]]]](((a: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
          {
            val (d, (_, id)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = a;
  ...
  def k_score(k: Nat.nat,
    ...
    strat: (List[Nat.nat]) => (List[Nat.nat]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat): FSet.fset[score_ext[Unit]] =
    {
      ...
      val paths: FSet.fset[(Nat.nat, (Nat.nat, (FSet.fset[List[List[Nat.nat]]], FSet.fset[List[List[Nat.nat]]])))] = FSet.fimage[(Nat.nat, Nat.nat), (Nat.nat, (Nat.nat, (FSet.fset[List[List[Nat.nat]]], FSet.fset[List[List[Nat.nat]]])))](((a: (Nat.nat, Nat.nat)) =>
        {
      ...
      val a: FSet.fset[score_ext[Unit]] =
        FSet.fimage[(Nat.nat, (Nat.nat, (FSet.fset[List[List[Nat.nat]]], FSet.fset[List[List[Nat.nat]]]))), score_ext[Unit]](((a: (Nat.nat, (Nat.nat, (FSet.fset[List[List[Nat.nat]]], FSet.fset[List[List[Nat.nat]]])))) =>
          {
            val (s1, (s2, (p1, p2))): (Nat.nat, (Nat.nat, (FSet.fset[List[List[Nat.nat]]], FSet.fset[List[List[Nat.nat]]]))) = a;
  ...
  def add_transition(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    FSet.finsert[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]((List(Nat.plus_nata(max_uid_total(e),
      Nat.Nata((1)))),
  ...
  def add_transition_abstract(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    ...
    outputs: List[Value.value]): (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))], Map[String, Option[Nat.nat]]) =
    {
      ...
      val (g, (u1, ra)): (List[GExp.gexp], (List[(Nat.nat, AExp.aexp)], Map[String, Option[Nat.nat]])) = make_guard_abstract(inputs, Nat.zero_nata, maxR, r, Nil, Nil)
      ...
      (if (label.endsWith("*"))
        ...
        e),
        ra)
      else (FSet.finsert[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]((List(Nat.plus_nata(max_uid_total(e),
        Nat.Nata((1)))),
        ((s, Nat.plus_nata(EFSM.maxS(tm(e)), Nat.Nata((1)))),
          Transition.transition_exta[Unit](label,
            Nat.Nata(inputs.length), g, p, u1, ()))),
  ...
  def outgoing_transitions_from(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    s: Nat.nat): FSet.fset[Transition.transition_ext[Unit]] =
    FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), Transition.transition_ext[Unit]](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
      {
...
object Code_Generation {
  ...
  def guardMatch_code(uu: List[GExp.gexp], uv: List[GExp.gexp]): Boolean =
    (uu, uv) match {
      case (List(GExp.Eq(AExp.V(VName.I(ia)), AExp.L(Value.Numa(na)))),
        List(GExp.Eq(AExp.V(VName.I(i)), AExp.L(Value.Numa(n))))) => (Nat.equal_nata(ia, Nat.zero_nata)) && (Nat.equal_nata(i, Nat.zero_nata))
      case (Nil, uv) => false
  ...
  def mismatched_updates(t1: Transition.transition_ext[Unit],
    ...
    Lista.list_ex[Nat.nat](((r: Nat.nat) =>
      ...
      Lista.map[(Nat.nat, AExp.aexp), Nat.nat](((a: (Nat.nat, AExp.aexp)) =>
        a._1),
        Transition.Updates[Unit](t1)))
...
object Store_Reuse_Subsumption {
  ...
  def initially_undefined_context_check(e: FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])],
    ...
    (if ((Nat.equal_nata(s, Nat.zero_nata)) && (FSet.fBall[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])](e,
      ((a: ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) =>
        {
...
object Store_Reuse {
  ...
  def io_index(eventNo: Nat.nat, inputs: List[Value.value],
    ...
    FSet.sup_fset[(Nat.nat, (ioTag, Nat.nat))](index(inputs, eventNo, In(), Nat.zero_nata),
...
object Same_Register {
  ...
  def a_replace_with(x0: AExp.aexp, uu: Nat.nat, uv: Nat.nat): AExp.aexp =
    (x0, uu, uv) match {
      ...
      case (AExp.Minus(a1, a2), r1, r2) =>
        AExp.Minus(a_replace_with(a1, r1, r2), a_replace_with(a2, r1, r2))
      case (AExp.Times(a1, a2), r1, r2) =>
        AExp.Times(a_replace_with(a1, r1, r2), a_replace_with(a2, r1, r2))
    }
  ...
  def g_replace_with(x0: GExp.gexp, uu: Nat.nat, uv: Nat.nat): GExp.gexp =
    (x0, uu, uv) match {
      ...
      case (GExp.In(v, s), r1, r2) => GExp.In(v, s)
    }
...
object Weak_Subsumption {
  ...
  def weak_subsumption(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (if ((Transition.Label[Unit](t1) ==
        Transition.Label[Unit](t2)) && ((Nat.equal_nata(Transition.Arity[Unit](t1),
          Transition.Arity[Unit](t2))) && ((Lista.equal_lista[GExp.gexp](Transition.Guard[Unit](t1),
            Transition.Guard[Unit](t2))) && ((Lista.equal_lista[AExp.aexp](Transition.Outputs[Unit](t1),
              Transition.Outputs[Unit](t2))) && (!(Nat.equal_nata(Nat.Nata((Transition.Updates[Unit](t1)).length),
                Nat.Nata((Transition.Updates[Unit](t2)).length)))))))) {
        val newEFSM: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.replace_all(newa, List(t1ID, t2ID),
          maxBy[Transition.transition_ext[Unit], Nat.nat](Fun.comp[List[(Nat.nat, AExp.aexp)], Nat.nat, Transition.transition_ext[Unit]](((a: List[(Nat.nat, AExp.aexp)]) =>
            Nat.Nata(a.length)),
...
object Symbolic_Regression {
  ...
  def everything_walk(uu: AExp.aexp, uv: Nat.nat, uw: Map[VName.vname, String],
    ...
    va: List[List[Nat.nat]]): List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))] =
    ...
    (uu, uv, uw, x3, ux, uy, pta, target) match {
      ...
      case (op, ox, us, h :: t, label, arity, pta, target) =>
        (put_update_function_aux(op, ox, us, h._2, label, arity, pta, target,
          Nat.zero_nata, Map().withDefaultValue(None)) match {
            case None => None
            case Some(e) =>
  ...
  def everything_walk_log(f: AExp.aexp, fi: Nat.nat,
    ...
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    gp: List[List[Nat.nat]]): List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] =
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[(AExp.aexp, Map[VName.vname, String])]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events);
      put_output_functions(Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nata, output_functions),
        i_log, t1, newa)
    }
    ...
    uv: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      val output_functions: List[Option[(AExp.aexp, Map[VName.vname, String])]] =
        get_functions(max_reg, values,
          Nat.Nata((Transition.Outputs[Unit](t1)).length),
          relevant_events);
      put_output_functions_2(Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nata, output_functions),
        i_log, t1, newa)
    }
...
object PTA_Generalisation {
  ...
  def same_structure_opt(x0: Option[Transition.transition_ext[Unit]],
    x1: Option[Transition.transition_ext[Unit]]): Boolean =
    (x0, x1) match {
      case (None, None) => true
  ...
  def assign_group(x0: List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))],
    count: Option[Transition.transition_ext[Unit]] => Nat.nat,
    prev: Option[Transition.transition_ext[Unit]],
    x3: (List[Nat.nat], Transition.transition_ext[Unit])): List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))] =
    (x0, count, prev, x3) match {
      ...
      case ((preva, (c, gp)) :: t, count, prev, (tid, tr)) =>
        (if ((same_structure_opt(prev,
          preva)) && ((Lista.list_all[(List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
            {
              val (_, aa): (List[Nat.nat], Transition.transition_ext[Unit]) = a;
              Transition.same_structure(tr, aa)
            }),
            gp)) && (Nat.equal_nata(count(prev), c))))
          (preva,
          (c, Lista.insert[(List[Nat.nat], Transition.transition_ext[Unit])]((tid, tr), gp))) ::
          t
        else (preva, (c, gp)) :: assign_group(t, count, prev, (tid, tr)))
    }

  def trace_group_transitions(uu: Option[Transition.transition_ext[Unit]] => Nat.nat,
    uv: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x2: List[(String, (List[Value.value], List[Value.value]))],
    ...
    g: List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))]): List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))] =
  ...
  def log_group_transitions(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: List[List[(String, (List[Value.value], List[Value.value]))]]): List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))] =
    Lista.fold[List[(String, (List[Value.value], List[Value.value]))], List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))]](((t: List[(String, (List[Value.value], List[Value.value]))]) =>
      ((a: List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))]) =>
        trace_group_transitions(((_: Option[Transition.transition_ext[Unit]]) =>
          Nat.zero_nata),
          e, t, Nat.zero_nata, Map().withDefaultValue(None), None, None,
          a))),
      l, Nil)

  def transition_groups(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: List[List[(String, (List[Value.value], List[Value.value]))]]): List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] =
    {
      val a: List[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))] = log_group_transitions(e, l);
      Lista.map[(Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])])), List[(List[Nat.nat], Transition.transition_ext[Unit])]](Fun.comp[(Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]), List[(List[Nat.nat], Transition.transition_ext[Unit])], (Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))](((aa: (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])])) =>
        aa._2),
        ((aa: (Option[Transition.transition_ext[Unit]], (Nat.nat, List[(List[Nat.nat], Transition.transition_ext[Unit])]))) =>
          aa._2)),
        a)
    }
  ...
  def put_updates(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    uv: List[Value.value], uw: List[List[Nat.nat]],
    x3: List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    (uu, uv, uw, x3, e) match {
      case (uu, uv, uw, Nil, e) =>
        Some[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](e)
      ...
      case (log, values, current, (o_inx, Some((op, types))) :: ops, e) =>
        {
          ...
          val a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = groupwise_put_updates(groups, log, values, current,
            (o_inx, (op, types)), e);
          put_updates(log, values, current, ops, a)
        }
    }

  def put_outputs(xs: List[(Option[(AExp.aexp, Map[VName.vname, String])], AExp.aexp)]): List[AExp.aexp] =
    Lista.foldr[(Option[(AExp.aexp, Map[VName.vname, String])], AExp.aexp), List[AExp.aexp]](((x: (Option[(AExp.aexp, Map[VName.vname, String])], AExp.aexp)) =>
      (acc: List[AExp.aexp]) =>
        {
          val (a, p): (Option[(AExp.aexp, Map[VName.vname, String])], AExp.aexp) = x;
          (a match {
            case None => p :: acc
  ...
  def generalise_and_update(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    gp: (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      (put_updates(log, values,
        Lista.map[(List[Nat.nat], Transition.transition_ext[Unit]), List[Nat.nat]](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          a._1),
          gp._1),
        Lista.enumerate[Option[(AExp.aexp, Map[VName.vname, String])]](Nat.zero_nata, outputs),
  ...
  def standardise_group_updates(g: List[(List[Nat.nat], Transition.transition_ext[Unit])]): List[(List[Nat.nat], Transition.transition_ext[Unit])] =
    {
      val updates: List[(Nat.nat, AExp.aexp)] =
  ...
  def standardise_outputs(p1: List[AExp.aexp], p2: List[AExp.aexp]): List[AExp.aexp] =
    Lista.map[(AExp.aexp, AExp.aexp), AExp.aexp](((a: (AExp.aexp, AExp.aexp)) =>
      {
  ...
  def standardise_group_outputs(g: List[(List[Nat.nat], Transition.transition_ext[Unit])]): List[(List[Nat.nat], Transition.transition_ext[Unit])] =
    {
      val outputs: List[AExp.aexp] =
        (g match {
          case Nil => Nil
          case h :: t =>
            Lista.fold[(List[Nat.nat], Transition.transition_ext[Unit]), List[AExp.aexp]](Fun.comp[List[AExp.aexp], (List[AExp.aexp]) => List[AExp.aexp], (List[Nat.nat], Transition.transition_ext[Unit])](((a: List[AExp.aexp]) =>
              (b: List[AExp.aexp]) => standardise_outputs(a, b)),
              Fun.comp[Transition.transition_ext[Unit], List[AExp.aexp], (List[Nat.nat], Transition.transition_ext[Unit])](((a: Transition.transition_ext[Unit]) =>
  ...
  def standardise_groups_aux(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    x2: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]],
    uv: (List[(List[Nat.nat], Transition.transition_ext[Unit])]) => List[(List[Nat.nat], Transition.transition_ext[Unit])]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (e, uu, x2, uv) match {
      case (e, uu, Nil, uv) => e
      case (e, l, h :: t, s) =>
        {
          val standardised: List[(List[Nat.nat], Transition.transition_ext[Unit])] =
            s(h)
          val ea: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.replace_transitions(e, standardised);
          (if (Inference.satisfies(Set.seta[List[(String, (List[Value.value], List[Value.value]))]](l),
            Inference.tm(ea)))
            standardise_groups_aux(ea, l, t, s)
          else standardise_groups_aux(e, l, t, s))
        }
    }

  def insert_into_group(x0: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]],
    pair: (List[Nat.nat], Transition.transition_ext[Unit])): List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] =
    (x0, pair) match {
      case (Nil, pair) => List(List(pair))
      case (h :: t, pair) =>
        (if (Lista.list_all[(List[Nat.nat], Transition.transition_ext[Unit])](((a: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          {
            val (_, aa): (List[Nat.nat], Transition.transition_ext[Unit]) = a;
  ...
  def group_by_structure(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): List[List[(List[Nat.nat], Transition.transition_ext[Unit])]] =
  ...
  def standardise_groups(e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: List[List[(String, (List[Value.value], List[Value.value]))]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    standardise_groups_aux(e, l, group_by_structure(e),
      Fun.comp[List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(List[Nat.nat], Transition.transition_ext[Unit])]](((a: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
        standardise_group_outputs(a)),
        ((a: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
  ...
  def incremental_normalised_pta(log: List[List[(String, (List[Value.value], List[Value.value]))]],
  ...
  def find_initialisation_of_trace(uu: Nat.nat,
    ...
    uv: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uw: Nat.nat,
    ux: Map[Nat.nat, Option[Value.value]]): Option[(List[Nat.nat], Transition.transition_ext[Unit])] =
    (uu, x1, uv, uw, ux) match {
      case (uu, Nil, uv, uw, ux) => None
      case (ra, (l, (i, uy)) :: es, e, s, r) =>
        {
          val (tids, (sa, t)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(e,
            s, r, l, i));
          (if (Lista.list_ex[(Nat.nat, AExp.aexp)](((a: (Nat.nat, AExp.aexp)) =>
            {
              val (rr, u): (Nat.nat, AExp.aexp) = a;
              (Nat.equal_nata(rr, ra)) && (AExp.is_lit(u))
            }),
            Transition.Updates[Unit](t)))
  ...
  def find_initialisation_of(uu: Nat.nat,
    uv: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    x2: List[List[(String, (List[Value.value], List[Value.value]))]]): Option[(List[Nat.nat], Transition.transition_ext[Unit])] =
    (uu, uv, x2) match {
      case (uu, uv, Nil) => None
      case (r, e, h :: t) =>
        (find_initialisation_of_trace(r, h, e, Nat.zero_nata,
          Map().withDefaultValue(None)) match {
            ...
            case Some(a) => Some[(List[Nat.nat], Transition.transition_ext[Unit])](a)
          })
    }
  ...
  def delay_initialisation_of(r: Nat.nat,
    l: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    tids: List[List[Nat.nat]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (find_initialisation_of(r, e, l) match {
      case None => e
      case Some((i_tids, t)) =>
        {
          val origins: List[Nat.nat] =
            Lista.map[List[Nat.nat], Nat.nat](((id: List[Nat.nat]) => Inference.origin(id, e)),
              tids)
          val init_val: AExp.aexp =
            ((Lista.filter[(Nat.nat, AExp.aexp)](((a: (Nat.nat, AExp.aexp)) =>
              {
                val (ra, _): (Nat.nat, AExp.aexp) = a;
                Nat.equal_nata(r, ra)
          ...
          FSet.fimage[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])), (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))](((a: (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))) =>
            {
              val (id, aa): (List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit])) = a
              val (ab, b): ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]) = aa;
              ({
                val (origin, dest): (Nat.nat, Nat.nat) = ab;
                ((tr: Transition.transition_ext[Unit]) =>
                  (if (origins contains dest)
                    (id, ((origin, dest),
                    Transition.Updates_update[Unit](((_: List[(Nat.nat, AExp.aexp)]) =>
                      Lista.insert[(Nat.nat, AExp.aexp)]((r, init_val), Transition.Updates[Unit](tr))),
                      tr)))
                  else (if (Lista.equal_lista[Nat.nat](id,
                    i_tids))
                    (id,
                    ((origin, dest),
                      Transition.Updates_update[Unit](((_: List[(Nat.nat, AExp.aexp)]) =>
                        Lista.filter[(Nat.nat, AExp.aexp)](((ac: (Nat.nat, AExp.aexp)) =>
                          {
                            val (ra, _): (Nat.nat, AExp.aexp) = ac;
                            !(Nat.equal_nata(r, ra))
                          }),
  ...
  def find_first_use_of_trace(uu: Nat.nat,
    ...
    uv: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    uw: Nat.nat,
    ux: Map[Nat.nat, Option[Value.value]]): Option[List[Nat.nat]] =
    (uu, x1, uv, uw, ux) match {
      case (uu, Nil, uv, uw, ux) => None
      case (rr, (l, (i, uy)) :: es, e, s, r) =>
        {
          val (id, (sa, t)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(e,
            s, r, l, i));
          (if (Lista.list_ex[AExp.aexp](((p: AExp.aexp) =>
            AExp.aexp_constrains(p,
              AExp.V(VName.R(rr)))),
            Transition.Outputs[Unit](t)))
  ...
  def find_first_uses_of(r: Nat.nat,
    l: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): List[List[Nat.nat]] =
    Lista.maps[Option[List[Nat.nat]], List[Nat.nat]](((a: Option[List[Nat.nat]]) =>
      (a match {
        case None => Nil
        case Some(x) => List(x)
      })),
      Lista.map[List[(String, (List[Value.value], List[Value.value]))], Option[List[Nat.nat]]](((t: List[(String, (List[Value.value], List[Value.value]))]) =>
  ...
  def derestrict(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    {
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log)
      val normalised: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = incremental_normalised_pta(log, pta)
      val delayed: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Lista.fold[Nat.nat, FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((r: Nat.nat) =>
        (acc: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
  ...
  def update_groups(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    uv: List[Value.value],
    x2: List[(List[List[Nat.nat]], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (uu, uv, x2, e) match {
      case (uu, uv, Nil, e) => e
  ...
  def generalise_outputs(values: List[Value.value],
    ...
    Lista.map[(Nat.nat, (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])), List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]](((a: (Nat.nat, (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))]))) =>
      ...
      Lista.enumerate[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])](Nat.zero_nata, groups))

  def replace_groups(xs: List[List[(List[Nat.nat], Transition.transition_ext[Unit])]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    Lista.fold[List[(List[Nat.nat], Transition.transition_ext[Unit])], FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((a: List[(List[Nat.nat], Transition.transition_ext[Unit])]) =>
      (b: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) =>
        Lista.fold[(List[Nat.nat], Transition.transition_ext[Unit]), FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]](((aa: (List[Nat.nat], Transition.transition_ext[Unit])) =>
          {
  ...
  def normalised_pta(log: List[List[(String, (List[Value.value], List[Value.value]))]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      ...
      val group_details: List[(List[List[Nat.nat]], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])] = Lista.map[List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))], (List[List[Nat.nat]], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])](((l: List[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))]) =>
        Lista.fold[(List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])), (List[List[Nat.nat]], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])](((a: (List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]))) =>
          {
            val (id, (_, typesa)): (List[Nat.nat], (Transition.transition_ext[Unit], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])) = a;
            ((aa: (List[List[Nat.nat]], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])])) =>
              {
                val (tids, _): (List[List[Nat.nat]], List[(Nat.nat, Option[(AExp.aexp, Map[VName.vname, String])])]) = aa;
                (id :: tids, typesa)
              })
          }),
          l, (Nil, Nil))),
  ...
  def collect_training_sets(x0: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    (x0, uPTA, t1, t2, g1, g2) match {
      ...
      case (h :: t, uPTA, t1, t2, g1, g2) =>
        {
          val (g1a, g2a): (List[(List[Value.value], Map[Nat.nat, Option[Value.value]])], List[(List[Value.value], Map[Nat.nat, Option[Value.value]])]) = trace_collect_training_sets(h, uPTA, Nat.zero_nata,
