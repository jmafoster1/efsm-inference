...
object Inference {
  ...
  def k_score(n: Nat.nat,
    ...
    rank: (List[Nat.nat]) => (List[Nat.nat]) => (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => Nat.nat): FSet.fset[(Nat.nat, (Nat.nat, Nat.nat))] =
    {
      ...
      val a: FSet.fset[(Nat.nat, (Nat.nat, Nat.nat))] =
        FSet.fimage[(Nat.nat, Nat.nat), (Nat.nat, (Nat.nat, Nat.nat))](((a: (Nat.nat, Nat.nat)) =>
          {
            val (s1, s2): (Nat.nat, Nat.nat) = a
            val outgoing_s1: FSet.fset[List[Nat.nat]] = FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), List[Nat.nat]](Fun.comp[(Transition.transition_ext[Unit], List[Nat.nat]), List[Nat.nat], (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](((aa: (Transition.transition_ext[Unit], List[Nat.nat])) =>
              aa._2),
              ((aa: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
                aa._2)),
              k_outgoing(n, e, s1))
            val outgoing_s2: FSet.fset[List[Nat.nat]] = FSet.fimage[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), List[Nat.nat]](Fun.comp[(Transition.transition_ext[Unit], List[Nat.nat]), List[Nat.nat], (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](((aa: (Transition.transition_ext[Unit], List[Nat.nat])) =>
              aa._2),
              ((aa: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
                aa._2)),
              k_outgoing(n, e, s2))
          ...
          pairs_to_score);
      FSet.ffilter[(Nat.nat, (Nat.nat, Nat.nat))](((aa: (Nat.nat, (Nat.nat, Nat.nat))) =>
        {
          val (score, _): (Nat.nat, (Nat.nat, Nat.nat)) = aa;
  ...
  def make_pta_aux(x0: List[List[(String, (List[Value.value], List[Value.value]))]],
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (x0, e) match {
      case (Nil, e) => e
      case (h :: t, e) =>
        make_pta_aux(t, make_branch(e, Nat.zero_nata, Map().withDefaultValue(None),
          h))
    }
...
object Code_Generation {
  ...
  def infer_with_log(stepNo: Nat.nat, k: Nat.nat,
    ...
    check: (FSet.fset[((Nat.nat, Nat.nat), Transition.transition_ext[Unit])]) => Boolean,
    np: (FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]) => FSet.fset[(Nat.nat, ((Nat.nat, Nat.nat), ((Transition.transition_ext[Unit], List[Nat.nat]), (Transition.transition_ext[Unit], List[Nat.nat]))))]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    (Inference.inference_step(e, (FSet.sorted_list_of_fset[(Nat.nat, (Nat.nat, Nat.nat))](Inference.k_score(k, e, r))).reverse,
      m, check, np) match {
        case None => e
        case Some(newa) =>
          {
...
object Symbolic_Regression {
  ...
  def group_update(values: List[Value.value],
    l: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]): Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])] =
    {
      ...
      (if (Lista.list_ex[(Nat.nat, Option[AExp.aexp])](((a: (Nat.nat, Option[AExp.aexp])) =>
        ...
        if (PTA_Generalisation.currentGroup == "closingDoor")
          println("    " + result)
        Some[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])](result)
      })
    }
  ...
  def groupwise_updates(
    ...
    (values, x1) match {
      ...
      case (values, g :: gs) => {
        if (PTA_Generalisation.currentGroup == "closingDoor")
          println(Transition.Label(g(0)._2._2._2._2._2))
...
object PTA_Generalisation {
      ...
      case ((l, (i, ux)) :: trace, funs, e, s, r) =>
        {
          val (id, (sa, t)): (List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit])) = FSet.fthe_elem[(List[Nat.nat], (Nat.nat, Transition.transition_ext[Unit]))](Inference.i_possible_steps(e,
            s, r, l, i))
          if (PTA_Generalisation.currentGroup == "closingDoor" && id == Nat.Nata(38))
            println("Replacing 38")

          val updated: Map[Nat.nat, Option[Value.value]] = EFSM.apply_updates(Transition.Updates[Unit](t), AExp.join_ir(i, r), r)
          ...
          val necessaryUpdates: List[(Nat.nat, AExp.aexp)] =
            Lista.filter[(Nat.nat, AExp.aexp)](((a: (Nat.nat, AExp.aexp)) =>
              ...
              newUpdates)
          val tb: Transition.transition_ext[Unit] = insert_updates(t, necessaryUpdates)
      ...
      case (log, values, label, ia, oa, (o_inx, Some((op, types))) :: ops, lit) =>
        {
          ...
          if (currentGroup == "closingDoor")
            for (group <- groups) {
              for (event <- group)
                println("  " + PrettyPrinter.targetInfoToString(event))
              println()
            }
  ...
  def generalise_and_update(log: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    gp: (List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])): Option[FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))]] =
    {
      ...
      currentGroup = Transition.Label(tran)
      ...
      // for (change <- changes)
      //   println("  " + change._1 + PrettyPrinter.transitionToString(change._2))

      val updated = (put_updates(log, values, Transition.Label[Unit](tran),
  ...
  def incremental_normalised_pta(log: List[List[(String, (List[Value.value], List[Value.value]))]]): FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] =
    {
      ...
      val pta: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_pta(log)
      val a: List[(List[(List[Nat.nat], Transition.transition_ext[Unit])], List[(Map[Nat.nat, Option[Value.value]], (List[Value.value], List[Value.value]))])] = make_training_set(pta, log);
      groupwise_generalise_and_update(log, pta, a)
    }
