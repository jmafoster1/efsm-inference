  ...
  def k_score_aux(m: Nat.nat,
    ...
    (if (Nat.equal_nata(m, Nat.zero_nat)) {
      ...
      val pairs: FSet.fset[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))] = FSet.ffilter[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))](((a: ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))) =>
        {
          ...
          Product_Lexorder.less_prod[Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])](aa, b)
        }),
        FSet_Utils.fprod[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))](outgoing_1, outgoing_2))
      val scores: FSet.fset[(Nat.nat, (Nat.nat, Nat.nat))] =
        FSet.fimage[((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))), (Nat.nat, (Nat.nat, Nat.nat))](((a: ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])))) =>
          {
            val (aa, b): ((Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])), (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) = a;
            ({
              val (d1, (_, x)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = aa;
              ((ab: (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))) =>
                {
                  val (d2, (_, y)): (Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat])) = ab;
                  (d1, (d2, ((strat(x))(y))(e)))
                })
            })(b)
          }),
      ...
      Lista.fold[(Nat.nat, (Nat.nat, Nat.nat)), Nat.nat](((a: (Nat.nat, (Nat.nat, Nat.nat))) =>
        {
          val (_, (_, s)): (Nat.nat, (Nat.nat, Nat.nat)) =
            a;
          ((acc: Nat.nat) => Nat.plus_nat(acc, s))
        }),
        FSet.sorted_list_of_fset[(Nat.nat, (Nat.nat, Nat.nat))](scores),
        Nat.zero_nat)
    } else {
      val outgoing_1: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))] = outgoing_transitions(s1, e)
      val outgoing_2: FSet.fset[(Nat.nat, (Transition.transition_ext[Unit], List[Nat.nat]))] = outgoing_transitions(s2, e)
      ...
      Lista.fold[(Nat.nat, (Nat.nat, Nat.nat)), Nat.nat](((a: (Nat.nat, (Nat.nat, Nat.nat))) =>
        {
          val (s1a, (s2a, _)): (Nat.nat, (Nat.nat, Nat.nat)) = a;
          ((acc: Nat.nat) =>
            Nat.plus_nat(acc,
              k_score_aux(Nat.minus_nat(m, Nat.Nata((1))), e, s1a, s2a, strat)))
        }),
        FSet.sorted_list_of_fset[(Nat.nat, (Nat.nat, Nat.nat))](scores),
        Nat.zero_nat)
    })
        ...
        FSet.fimage[(Nat.nat, Nat.nat), score_ext[Unit]](((a: (Nat.nat, Nat.nat)) =>
          {
            ...
            score_exta[Unit](k_score_aux(k, e, s1, s2, strat), s2, s2, ())
          }),
          pairs_to_score);
...
object Symbolic_Regression {
  ...
  def target(uu: Map[Nat.nat, Option[Value.value]],
    x1: List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]): List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))] =
    (uu, x1) match {
      case (uu, Nil) => Nil
      case (tRegs, (s, (regs, (inputs, (tid, ta)))) :: t) =>
        {
  ...
  def group_update(values: List[Value.value],
    l: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]): Option[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])] =
    {
      val targeted: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))] = Lista.filter[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) =>
        {
      ...
      val maybe_updates: List[(Nat.nat, Option[AExp.aexp])] =
        get_updates_opt(values,
          Lista.map[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))), (List[Value.value], (Map[Nat.nat, Option[Value.value]], Map[Nat.nat, Option[Value.value]]))](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) =>
            {
              val (tRegs, (_, (regs, (inputs, (_, _))))): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))) = a;
              (inputs, (regs, tRegs))
            }),
            targeted));
      (if (Lista.list_ex[(Nat.nat, Option[AExp.aexp])](((a: (Nat.nat, Option[AExp.aexp])) =>
        ...
        maybe_updates))
        None
      else Some[(List[Nat.nat], List[(Nat.nat, AExp.aexp)])]((Lista.fold[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))), List[Nat.nat]](Fun.comp[List[Nat.nat], (List[Nat.nat]) => List[Nat.nat], (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))](Lista.union[Nat.nat],
        ((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) =>
          {
            val (_, (_, (_, (_, (tid, _))))): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))) = a;
            tid
          })),
        l, Nil),
  ...
  def everything_walk(uu: AExp.aexp, uv: Nat.nat, uw: Map[VName.vname, String],
    ...
    va: String, vb: Nat.nat, vc: Nat.nat): List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))] =
  ...
  def structural_insert(x: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))),
    xa1: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]]): List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] =
    (x, xa1) match {
      case (x, Nil) => List(List(x))
      case (x, h :: t) =>
        {
          val (_, (_, (_, (_, (_, ta))))): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))) = x;
          (if (Lista.list_ex[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) =>
            {
              val (_, aa): (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))) = a
              val (_, ab): (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))) = aa
              val (_, ac): (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))) = ab
              val (_, ad): (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])) = ac
              val (_, ae): (List[Nat.nat], Transition.transition_ext[Unit]) = ad;
              Transition.same_structure(ta, ae)
            }),
            h))
            Lista.insert[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))](x, h) ::
            t
  ...
  def group_by_structure(info: List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))],
    groups: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]]): List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] =
    Lista.fold[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))), List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]]](((a: (Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))) =>
      (b: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]]) =>
        structural_insert(a, b)),
      info, Nil)
  ...
  def everything_walk_log(f: AExp.aexp, fi: Nat.nat,
    ...
    e: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))],
    l: String, ia: Nat.nat, oa: Nat.nat): List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]] =
    Lista.map[List[(String, (List[Value.value], List[Value.value]))], List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]](((t: List[(String, (List[Value.value], List[Value.value]))]) =>
...
object PTA_Generalisation {
  ...
  def put_updates(uu: List[List[(String, (List[Value.value], List[Value.value]))]],
    ...
    (uu, uv, uw, ux, uy, x5, e) match {
      ...
      case (log, values, label, ia, oa, (o_inx, Some((op, types))) :: ops, lit) =>
        {
          val walked: List[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]] = Symbolic_Regression.everything_walk_log(op, o_inx, types, log, lit,
            label, ia, oa)
          val targeted: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] = Lista.map[List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))], List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]](((w: List[(Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit]))))]) =>
            (Symbolic_Regression.target(Map().withDefaultValue(None),
              w.reverse)).reverse),
            walked)
          val groups: List[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]] = Symbolic_Regression.group_by_structure(Lista.fold[List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))], List[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))]](Lista.union[(Map[Nat.nat, Option[Value.value]], (Nat.nat, (Map[Nat.nat, Option[Value.value]], (List[Value.value], (List[Nat.nat], Transition.transition_ext[Unit])))))],
            targeted, Nil),
            Nil)
          ...
          val a: FSet.fset[(List[Nat.nat], ((Nat.nat, Nat.nat), Transition.transition_ext[Unit]))] = Inference.make_distinct(add_groupwise_updates(log, group_updates,
            lit));
