...
definition drinks_after :: iEFSM where
  "drinks_after = {|(0, (0, 1), select_update), (2, (1, 1), coin), (3, (1, 1), vend_fail), (4, (1, 3), vend_success)|}"
...
lemma possible_steps_merge_1_2_update_select: "length b = 1 \<Longrightarrow> possible_steps (tm merge_1_2_update) 0 r ''select'' b = {|(1, select_update)|}"
proof-
...
lemma drinks_before_1_invalid: "\<not> (aa = ''coin'' \<and> b = [Num 50]) \<Longrightarrow> nondeterministic_step (tm drinks_before) 1 r aa b = None"
proof-
...
lemma possible_steps_drinks_before_coin: "length b = 1 \<Longrightarrow> possible_steps (tm drinks_before) 2 r ''coin'' b = {|(2, coin)|}"
proof-
  assume premise: "length b = 1"
  show ?thesis
    apply (simp add: possible_steps_def ffilter_def fimage_def fset_both_sides Abs_fset_inverse)
...
lemma possible_steps_merge_1_2_update_coin: "length b = 1 \<Longrightarrow> (1, coin) |\<in>| possible_steps (tm merge_1_2_update) 1 r2 ''coin'' b"
proof-
  assume premise: "length b = 1"
  show ?thesis
...
lemma nondeterministic_step_drinks_before_invalid_step_2: " \<not> (aa = ''coin'' \<and> length b = 1) \<Longrightarrow>
       \<not> (aa = ''vend'' \<and> b = []) \<Longrightarrow> nondeterministic_step (tm drinks_before) 2 r1 aa b = None"
proof-
...
lemma impossible_steps_drinks_before_vend: "\<nexists>n. r (R 2) = Some (Num n) \<Longrightarrow> nondeterministic_step (tm drinks_before) 2 r ''vend'' i = None"
proof-
  assume premise: "\<nexists>n. r (R 2) = Some (Num n)"
  have possible_steps: "possible_steps (tm drinks_before) 2 r ''vend'' i = {||}"
    apply (simp add: possible_steps_def ffilter_def fset_both_sides Abs_fset_inverse)
    apply (simp add: Set.filter_def tm_def drinks_before_def)
    apply safe
    using premise
...
lemma drinks_before_vend_fail: "r (R 2) = Some (Num x1) \<Longrightarrow> x1 < 100 \<Longrightarrow> possible_steps (tm drinks_before) 2 r ''vend'' [] = {|(2, vend_fail)|}"
    apply (simp add: possible_steps_def ffilter_def fimage_def fset_both_sides Abs_fset_inverse)
    apply (simp add: tm_def drinks_before_def Set.filter_def)
    apply safe
          apply (simp_all add: transitions)
...
lemma merge_1_2_update_vend_fail: "r (R 2) = Some (Num x1) \<Longrightarrow> x1 < 100 \<Longrightarrow> possible_steps (tm merge_1_2_update) 1 r ''vend'' [] = {|(1, vend_fail)|}"
  apply (simp add: possible_steps_def ffilter_def fimage_def fset_both_sides Abs_fset_inverse)
...
lemma drinks_before_vend_success: "r (R 2) = Some (Num x1) \<Longrightarrow> x1 \<ge> 100 \<Longrightarrow> possible_steps (tm drinks_before) 2 r ''vend'' [] = {|(3, vend_success)|}"
    apply (simp add: possible_steps_def ffilter_def fimage_def fset_both_sides Abs_fset_inverse)
    apply (simp add: tm_def drinks_before_def Set.filter_def)
    apply safe
          apply (simp_all add: transitions)
...
lemma merge_1_2_update_vend_success: "r (R 2) = Some (Num x1) \<Longrightarrow> x1 \<ge> 100 \<Longrightarrow> possible_steps (tm merge_1_2_update) 1 r ''vend'' [] = {|(3, vend_success)|}"
  apply (simp add: possible_steps_def ffilter_def fimage_def fset_both_sides Abs_fset_inverse)
  apply (simp add: tm_def merge_1_2_update_def Set.filter_def)
    apply safe
          apply (simp_all add: transitions)
...
proof-
  ...
  have merge_1_2_update_possible_steps_coin_50: "possible_steps (tm merge_1_2_update) 1 <R 1 := d, R 2 := Num 0> ''coin'' [Num 50] = {|(1, coin50), (1, coin)|}"
    apply (simp add: possible_steps_def ffilter_def fimage_def fset_both_sides Abs_fset_inverse)
...
lemma drinks_before_1_step_invalid: "(aa, ba) \<noteq> (''coin'', [Num 50]) \<Longrightarrow> step (tm drinks_before) 1 r aa ba = None"
proof-
...
lemma merge_transitions: "merge_transitions drinks_before merged_1_2 (leaves 2 drinks_before) (leaves 1 drinks_before) 1 1 1 coin 2 coin50 1 null_generator
           (\<lambda>a b c d e. Some (merge_1_2_update, update_mapping, update_before)) True = Some merge_1_2_update"
proof-
...
proof-
  ...
  have minus_2: "{(1, coin, 2), (1, vend_fail, 3), (3, vend_success, 4)} - {(3, vend_success, 4)} = {(1, coin, 2), (1, vend_fail, 3)}"
    apply (simp add: transitions)
    by auto
  have state_nondeterminism: "state_nondeterminism 1 {|(1, coin, 2), (1, vend_fail, 3), (3, vend_success, 4)|} = {|
      (1, (1, 3), (vend_fail, 3), vend_success, 4),
      (1, (1, 1), (vend_fail, 3), coin, 2),
      (1, (1, 3), (coin, 2), vend_success, 4),
      (1, (1, 1), (coin, 2), vend_fail, 3)
...
proof-
  ...
  qed
  have nondeterministic_pairs_merge_1_2_update: "nondeterministic_pairs merge_1_2_update = {|(1, (1, 1), (coin, 2), coin50, 1)|}"
  proof-
    have minus_1: "{|(1, coin50, 1), (1, coin, 2), (1, vend_fail, 3), (3, vend_success, 4)|} |-| {|(1, coin, 2)|} = {|(1, coin50, 1), (1, vend_fail, 3), (3, vend_success, 4)|}"
      apply (simp add: transitions)
      by auto
    ...
    have minus_3: "{|(1, coin50, 1), (1, coin, 2), (1, vend_fail, 3), (3, vend_success, 4)|} |-| {|(3, vend_success, 4)|} = {|(1, coin50, 1), (1, coin, 2), (1, vend_fail, 3)|}"
      apply (simp add: transitions)
      by auto
    have state_nondeterminism_1: "state_nondeterminism 1 {|(1, coin50, 1), (1, coin, 2), (1, vend_fail, 3), (3, vend_success, 4)|} = {|(1, (1, 3), (coin50, 1), vend_success, 4), (1, (1, 3), (coin, 2), vend_success, 4), (1, (1, 3), (vend_fail, 3), vend_success, 4),
      (1, (1, 1), (vend_fail, 3), coin50, 1), (1, (1, 1), (vend_fail, 3), coin, 2), (1, (1, 3), (vend_fail, 3), vend_success, 4),
      (1, (1, 1), (coin, 2), coin50, 1), (1, (1, 1), (coin, 2), vend_fail, 3), (1, (1, 3), (coin, 2), vend_success, 4), (1, (1, 1), (coin50, 1), coin, 2),
      (1, (1, 1), (coin50, 1), vend_fail, 3), (1, (1, 3), (coin50, 1), vend_success, 4)|}"
      by (simp add: state_nondeterminism_def minus_1 minus_2 minus_3)
    show ?thesis
      ...
      by (simp_all add: transitions less_transition_ext_def less_eq_transition_ext_def)
  qed
  ...
  proof-
    ...
    show ?thesis
      by (simp add: leaves_def ffilter)
  qed
  have easy_merge: "easy_merge drinks_before merge_1_2_update 2 1 1 1 1 coin 2 coin50 1 null_generator = Some drinks_after"
  proof-
    have ffilter: "ffilter (\<lambda>x. snd x \<noteq> ((1, 1), coin50) \<and> snd x \<noteq> ((1, 1), coin)) merge_1_2_update = {|(0, (0, 1), select_update), (3, (1, 1), vend_fail), (4, (1, 3), vend_success)|}"
      apply (simp add: ffilter_def fset_both_sides Abs_fset_inverse Set.filter_def merge_1_2_update_def)
      apply safe
    ...
    show ?thesis
      ...
      apply (simp add: replace_transition_def ffilter drinks_after_def)
      by auto
  qed
  have merge_coins: "merge_transitions drinks_before merge_1_2_update 2 1 1 1 1 coin 2 coin50 1 null_generator
  ...
  show ?thesis
    ...
    apply (simp add: nondeterminism_def nondeterministic_pairs_merged_1_2 arrives_2_merged_1_2
           arrives_1_merged_1_2 merge_states_reflexive)
    apply (simp add: merge_transitions nondeterminism_def nondeterministic_pairs_drinks_after)
    apply (simp add: nondeterministic_pairs_merge_1_2_update arrives_2_merge_1_2_update arrives_1_merge_1_2_update merge_states_reflexive)
    by (simp add: leaves_2_drinks_before leaves_1_drinks_before merge_coins nondeterministic_pairs_drinks_after nondeterminism_def)
qed

lemma scoring_2: "sorted_list_of_fset (score drinks_after naive_score) = [(0, 0, 1), (0, 0, 3), (0, 1, 3)]"
proof-
