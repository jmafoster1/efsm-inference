...
code_printing
  ...
  (* We need this for rounding errors *)
  (* TODO: See if we can do it entirely with Rats *)
  constant "HOL.equal :: real \<Rightarrow> real \<Rightarrow> bool" \<rightharpoonup> (Scala) "Dirties.doubleEquals" |
...
fun guardMatch_code :: "vname gexp list \<Rightarrow> vname gexp list \<Rightarrow> bool" where
  "guardMatch_code [(gexp.Eq (V (vname.I i)) (L (value.Int n)))] [(gexp.Eq (V (vname.I i')) (L (value.Int n')))] = (i = 0 \<and> i' = 0)" |
...
fun outputMatch_code :: "output_function list \<Rightarrow> output_function list \<Rightarrow> bool" where
  "outputMatch_code [L (value.Int n)] [L (value.Int n')] = True" |
...
export_code
  ...
  derestrict
in Scala
file "/home/michael/Documents/efsm-inference/inference-tool/src/main/scala/inference/Inference.scala"
