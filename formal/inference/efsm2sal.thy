...
fun aexp2sal :: "(vname, value) aexp \<Rightarrow> String.literal" where
...
fun gexp2sal :: "(vname, value) gexp \<Rightarrow> String.literal" where
...
fun guards2sal :: "(vname, value) gexp list \<Rightarrow> String.literal" where
  "guards2sal [] = STR ''TRUE''" |
  "guards2sal G = join (map gexp2sal G) STR '' AND ''"

fun aexp2sal_num :: "(vname, value) aexp \<Rightarrow> nat \<Rightarrow> String.literal" where
...
fun gexp2sal_num :: "(vname, value) gexp \<Rightarrow> nat \<Rightarrow> String.literal" where
...
fun guards2sal_num :: "(vname, value) gexp list \<Rightarrow> nat \<Rightarrow> String.literal" where
